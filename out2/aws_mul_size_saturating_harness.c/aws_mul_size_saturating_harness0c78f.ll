; ModuleID = '../out2/aws_mul_size_saturating_harness.c/aws_mul_size_saturating_harness0c78f.bc.txt'
...
define internal fastcc void @aws_mul_size_saturating_harness() unnamed_addr #0 {
...
define internal fastcc void @aws_mul_u64_saturating(i64 %0, i64 %1) unnamed_addr #2 {
  tail call void @seahorn.fn.enter() #10
  ret void
}
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_u32_saturating(i32 %0, i32 %1) unnamed_addr #2 {
  tail call void @seahorn.fn.enter() #10
  ret void
}
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_mul_size_saturating_harness()
  %1 = tail call i64 @verifier.nondet.1()
  %2 = tail call i64 @verifier.nondet.1()
  tail call fastcc void @aws_mul_u64_saturating(i64 %1, i64 %2)
  %3 = tail call i32 @verifier.nondet.2()
  %4 = tail call i32 @verifier.nondet.2()
  tail call fastcc void @aws_mul_u32_saturating(i32 %3, i32 %4)
