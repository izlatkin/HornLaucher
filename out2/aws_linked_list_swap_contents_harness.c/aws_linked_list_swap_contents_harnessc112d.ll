; ModuleID = '../out2/aws_linked_list_swap_contents_harness.c/aws_linked_list_swap_contents_harnessc112d.bc.txt'
...
define internal fastcc void @aws_linked_list_swap_contents_harness() unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #12
  %1 = alloca %struct.aws_linked_list, align 8
  %2 = alloca %struct.aws_linked_list, align 8
  %3 = bitcast %struct.aws_linked_list* %1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %3) #12
  %4 = bitcast %struct.aws_linked_list* %2 to i8*
  ...
  call void @ensure_linked_list_is_allocated(%struct.aws_linked_list* nonnull %2, i32 20) #12
  call void @seahorn.fn.enter() #12, !noalias !5
  %5 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 0, i32 0
  %6 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %5, align 8, !tbaa !9, !alias.scope !15, !noalias !16
  %7 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1, i32 1
  %8 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %7, align 4, !tbaa !17, !alias.scope !15, !noalias !16
  call void @seahorn.fn.enter() #12, !noalias !5
  %9 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %2, i32 0, i32 0, i32 0
  %10 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %9, align 8, !tbaa !9, !alias.scope !16, !noalias !15
  %11 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %2, i32 0, i32 1
  %12 = icmp eq %struct.aws_linked_list_node* %10, %11
  br i1 %12, label %13, label %18

13:                                               ; preds = %0
  call void @seahorn.fn.enter() #12
  %14 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1
  store %struct.aws_linked_list_node* %14, %struct.aws_linked_list_node** %5, align 8, !tbaa !9, !alias.scope !15, !noalias !16
  %15 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 0, i32 1
  store %struct.aws_linked_list_node* null, %struct.aws_linked_list_node** %15, align 4, !tbaa !18, !alias.scope !15, !noalias !16
  %16 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 0
  store %struct.aws_linked_list_node* %16, %struct.aws_linked_list_node** %7, align 4, !tbaa !17, !alias.scope !15, !noalias !16
  %17 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1, i32 0
  store %struct.aws_linked_list_node* null, %struct.aws_linked_list_node** %17, align 8, !tbaa !19, !alias.scope !15, !noalias !16
  br label %25

18:                                               ; preds = %0
  store %struct.aws_linked_list_node* %10, %struct.aws_linked_list_node** %5, align 8, !tbaa !9, !alias.scope !15, !noalias !16
  %19 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 0
  %20 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %10, i32 0, i32 1
  store %struct.aws_linked_list_node* %19, %struct.aws_linked_list_node** %20, align 4, !tbaa !20
  %21 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %2, i32 0, i32 1, i32 1
  %22 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %21, align 4, !tbaa !17, !alias.scope !16, !noalias !15
  store %struct.aws_linked_list_node* %22, %struct.aws_linked_list_node** %7, align 4, !tbaa !17, !alias.scope !15, !noalias !16
  %23 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1
  %24 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %22, i32 0, i32 0
  store %struct.aws_linked_list_node* %23, %struct.aws_linked_list_node** %24, align 4, !tbaa !21
  br label %25

25:                                               ; preds = %18, %13
  %26 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1
  %27 = icmp eq %struct.aws_linked_list_node* %6, %26
  br i1 %27, label %28, label %31

28:                                               ; preds = %25
  call void @seahorn.fn.enter() #12
  store %struct.aws_linked_list_node* %11, %struct.aws_linked_list_node** %9, align 8, !tbaa !9, !alias.scope !16, !noalias !15
  %29 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %2, i32 0, i32 0, i32 1
  store %struct.aws_linked_list_node* null, %struct.aws_linked_list_node** %29, align 4, !tbaa !18, !alias.scope !16, !noalias !15
  %30 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %2, i32 0, i32 1, i32 0
  store %struct.aws_linked_list_node* null, %struct.aws_linked_list_node** %30, align 8, !tbaa !19, !alias.scope !16, !noalias !15
  br label %aws_linked_list_swap_contents.exit

31:                                               ; preds = %25
  store %struct.aws_linked_list_node* %6, %struct.aws_linked_list_node** %9, align 8, !tbaa !9, !alias.scope !16, !noalias !15
  %32 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %2, i32 0, i32 0
  %33 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %6, i32 0, i32 1
  store %struct.aws_linked_list_node* %32, %struct.aws_linked_list_node** %33, align 4, !tbaa !20
  %34 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %8, i32 0, i32 0
  store %struct.aws_linked_list_node* %11, %struct.aws_linked_list_node** %34, align 4, !tbaa !21
  br label %aws_linked_list_swap_contents.exit

aws_linked_list_swap_contents.exit:               ; preds = %28, %31
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
...
define internal fastcc void @aws_linked_list_swap_contents(%struct.aws_linked_list* noalias %0, %struct.aws_linked_list* noalias %1) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  %3 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 0, i32 0
  %4 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %3, align 4, !tbaa !9
  %5 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1, i32 1
  %6 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %5, align 4, !tbaa !17
  tail call void @seahorn.fn.enter() #12
  %7 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 0, i32 0
  %8 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %7, align 4, !tbaa !9
  %9 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1
  %10 = icmp eq %struct.aws_linked_list_node* %8, %9
  br i1 %10, label %11, label %16

11:                                               ; preds = %2
  tail call void @seahorn.fn.enter() #12
  %12 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1
  store %struct.aws_linked_list_node* %12, %struct.aws_linked_list_node** %3, align 4, !tbaa !9
  %13 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 0, i32 1
  store %struct.aws_linked_list_node* null, %struct.aws_linked_list_node** %13, align 4, !tbaa !18
  %14 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 0
  store %struct.aws_linked_list_node* %14, %struct.aws_linked_list_node** %5, align 4, !tbaa !17
  %15 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1, i32 0
  store %struct.aws_linked_list_node* null, %struct.aws_linked_list_node** %15, align 4, !tbaa !19
  br label %23

16:                                               ; preds = %2
  store %struct.aws_linked_list_node* %8, %struct.aws_linked_list_node** %3, align 4, !tbaa !9
  %17 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 0
  %18 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %8, i32 0, i32 1
  store %struct.aws_linked_list_node* %17, %struct.aws_linked_list_node** %18, align 4, !tbaa !20
  %19 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1, i32 1
  %20 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %19, align 4, !tbaa !17
  store %struct.aws_linked_list_node* %20, %struct.aws_linked_list_node** %5, align 4, !tbaa !17
  %21 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1
  %22 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %20, i32 0, i32 0
  store %struct.aws_linked_list_node* %21, %struct.aws_linked_list_node** %22, align 4, !tbaa !21
  br label %23

23:                                               ; preds = %16, %11
  %24 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1
  %25 = icmp eq %struct.aws_linked_list_node* %4, %24
  br i1 %25, label %26, label %30

26:                                               ; preds = %23
  tail call void @seahorn.fn.enter() #12
  store %struct.aws_linked_list_node* %9, %struct.aws_linked_list_node** %7, align 4, !tbaa !9
  %27 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 0, i32 1
  store %struct.aws_linked_list_node* null, %struct.aws_linked_list_node** %27, align 4, !tbaa !18
  %28 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 0
  %29 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1, i32 0
  store %struct.aws_linked_list_node* null, %struct.aws_linked_list_node** %29, align 4, !tbaa !19
  br label %34

30:                                               ; preds = %23
  store %struct.aws_linked_list_node* %4, %struct.aws_linked_list_node** %7, align 4, !tbaa !9
  %31 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 0
  %32 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %4, i32 0, i32 1
  store %struct.aws_linked_list_node* %31, %struct.aws_linked_list_node** %32, align 4, !tbaa !20
  %33 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %6, i32 0, i32 0
  store %struct.aws_linked_list_node* %9, %struct.aws_linked_list_node** %33, align 4, !tbaa !21
  br label %34

34:                                               ; preds = %30, %26
  %.sink = phi %struct.aws_linked_list_node* [ %28, %26 ], [ %6, %30 ]
  %35 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1, i32 1
  store %struct.aws_linked_list_node* %.sink, %struct.aws_linked_list_node** %35, align 4
  ret void
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_is_valid(%struct.aws_linked_list* nocapture readnone %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  ret void
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc zeroext i1 @aws_linked_list_empty(%struct.aws_linked_list* readonly %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  %2 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 0, i32 0
  %3 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %2, align 4, !tbaa !9
  %4 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1
  %5 = icmp eq %struct.aws_linked_list_node* %3, %4
  ret i1 %5
}
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_init(%struct.aws_linked_list* %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  %2 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1
  %3 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 0, i32 0
  store %struct.aws_linked_list_node* %2, %struct.aws_linked_list_node** %3, align 4, !tbaa !9
  %4 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 0, i32 1
  store %struct.aws_linked_list_node* null, %struct.aws_linked_list_node** %4, align 4, !tbaa !18
  ...
  store %struct.aws_linked_list_node* %5, %struct.aws_linked_list_node** %6, align 4, !tbaa !17
  %7 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1, i32 0
  store %struct.aws_linked_list_node* null, %struct.aws_linked_list_node** %7, align 4, !tbaa !19
  ret void
}
...
5:                                                ; preds = %2
  ...
  %7 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %6, align 4, !tbaa !28
...
7:                                                ; preds = %4
  ...
  %9 = load i8* (%struct.aws_allocator*, i8*, i32, i32)*, i8* (%struct.aws_allocator*, i8*, i32, i32)** %8, align 4, !tbaa !29
...
16:                                               ; preds = %11, %7
  ...
  %18 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !28
...
60:                                               ; preds = %45
  ...
  tail call void @seahorn.fn.enter() #12
  %65 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !28
...
define internal fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %0) unnamed_addr #1 {
  ...
  %4 = load i8* (%struct.aws_allocator*, i8*, i32, i32)*, i8* (%struct.aws_allocator*, i8*, i32, i32)** %3, align 4, !tbaa !29
  ...
  store i32 0, i32* %7, align 4, !tbaa !30
...
7:                                                ; preds = %2
  ...
  %10 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %9, align 4, !tbaa !28
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_swap_contents_harness()
  %1 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  %2 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_swap_contents(%struct.aws_linked_list* %1, %struct.aws_linked_list* %2)
  %3 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_is_valid(%struct.aws_linked_list* %3)
  %4 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  %5 = tail call fastcc i1 @aws_linked_list_empty(%struct.aws_linked_list* %4)
  %6 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_init(%struct.aws_linked_list* %6)
  %7 = tail call %struct.aws_allocator* @verifier.nondet.2()
  tail call fastcc void @aws_allocator_is_valid(%struct.aws_allocator* %7)
  ...
  %10 = tail call i8* @s_default_malloc(%struct.aws_allocator* %8, i32 %9)
  %11 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %12 = tail call i8* @verifier.nondet.4()
  tail call void @s_default_free(%struct.aws_allocator* %11, i8* %12)
  %13 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %14 = tail call i8* @verifier.nondet.4()
  %15 = tail call i32 @verifier.nondet.3()
  %16 = tail call i32 @verifier.nondet.3()
  %17 = tail call i8* @s_default_realloc(%struct.aws_allocator* %13, i8* %14, i32 %15, i32 %16)
  %18 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %19 = tail call i32 @verifier.nondet.3()
  %20 = tail call i32 @verifier.nondet.3()
  %21 = tail call i8* @s_default_calloc(%struct.aws_allocator* %18, i32 %19, i32 %20)
  %22 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %23 = tail call i32 @verifier.nondet.3()
  %24 = tail call fastcc i8* @aws_mem_acquire(%struct.aws_allocator* %22, i32 %23)
  %25 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error(i32 %25)
  %26 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %27 = tail call i32 @verifier.nondet.3()
  %28 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_mem_calloc(%struct.aws_allocator* %26, i32 %27, i32 %28)
  %29 = tail call i32 @verifier.nondet.3()
  %30 = tail call i32 @verifier.nondet.3()
  %31 = tail call i32* @verifier.nondet.5()
  tail call fastcc void @aws_mul_size_checked(i32 %29, i32 %30, i32* %31)
  %32 = tail call i32 @verifier.nondet.3()
  %33 = tail call i32 @verifier.nondet.3()
  %34 = tail call i32* @verifier.nondet.5()
  tail call fastcc void @aws_mul_u32_checked(i32 %32, i32 %33, i32* %34)
  %35 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %36 = tail call i32 @verifier.nondet.3()
  %37 = tail call i8* (%struct.aws_allocator*, i32, ...) @aws_mem_acquire_many(%struct.aws_allocator* %35, i32 %36)
  %38 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %39 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_mem_release(%struct.aws_allocator* %38, i8* %39)
  %40 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %41 = tail call i8** @verifier.nondet.6()
  %42 = tail call i32 @verifier.nondet.3()
  %43 = tail call i32 @verifier.nondet.3()
  %44 = tail call fastcc i32 @aws_mem_realloc(%struct.aws_allocator* %40, i8** %41, i32 %42, i32 %43)
  %45 = tail call %struct.aws_allocator* @verifier.nondet.2()
  tail call fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %45)
  ...
  %50 = tail call i8* @s_cf_allocator_reallocate(i8* %46, i32 %47, i32 %48, i8* %49)
  %51 = tail call i8* @verifier.nondet.4()
  %52 = tail call %struct.__CFString* @s_cf_allocator_copy_description(i8* %51)
  %53 = tail call i32 @verifier.nondet.3()
  %54 = tail call i32 @verifier.nondet.3()
  %55 = tail call i8* @verifier.nondet.4()
  %56 = tail call i8* @s_cf_allocator_allocate(i32 %53, i32 %54, i8* %55)
  %57 = tail call i8* @verifier.nondet.4()
  %58 = tail call i8* @verifier.nondet.4()
  tail call void @s_cf_allocator_deallocate(i8* %57, i8* %58)
  %59 = tail call i32 @verifier.nondet.3()
  %60 = tail call i32 @verifier.nondet.3()
  %61 = tail call i8* @verifier.nondet.4()
  %62 = tail call i32 @s_cf_allocator_preferred_size(i32 %59, i32 %60, i8* %61)
  %63 = tail call %struct.__CFAllocator* @verifier.nondet.7()
  tail call fastcc void @aws_wrapped_cf_allocator_destroy(%struct.__CFAllocator* %63)
  tail call fastcc void @aws_last_error()
  %64 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_str(i32 %64)
  %65 = tail call i32 @verifier.nondet.3()
  %66 = tail call fastcc %struct.aws_error_info* @get_error_by_code(i32 %65)
  %67 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_name(i32 %67)
  %68 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_lib_name(i32 %68)
  %69 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_debug_str(i32 %69)
  %70 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error_private(i32 %70)
  tail call fastcc void @aws_reset_error()
  %71 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_restore_error(i32 %71)
  %72 = tail call void (i32, i8*)* @verifier.nondet.8()
  %73 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %72, i8* %73)
  %74 = tail call void (i32, i8*)* @verifier.nondet.8()
  %75 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %74, i8* %75)
  %76 = tail call %struct.aws_error_info_list* @verifier.nondet.9()
  tail call fastcc void @aws_register_error_info(%struct.aws_error_info_list* %76)
  %77 = tail call %struct.aws_error_info_list* @verifier.nondet.9()
  tail call fastcc void @aws_unregister_error_info(%struct.aws_error_info_list* %77)
  %78 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_translate_and_raise_io_error(i32 %78)
  %79 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.20(i32 %79)
  ret i32 42
}
...
!5 = !{!6, !8}
!6 = distinct !{!6, !7, !"aws_linked_list_swap_contents: argument 0"}
!7 = distinct !{!7, !"aws_linked_list_swap_contents"}
!8 = distinct !{!8, !7, !"aws_linked_list_swap_contents: argument 1"}
!9 = !{!10, !12, i64 0}
!10 = !{!"aws_linked_list", !11, i64 0, !11, i64 8}
!11 = !{!"aws_linked_list_node", !12, i64 0, !12, i64 4}
...
!22 = !{!12, !12, i64 0}
!23 = !{!24, !12, i64 0}
!24 = !{!"aws_allocator", !12, i64 0, !12, i64 4, !12, i64 8, !12, i64 12, !12, i64 16}
!25 = !{!24, !12, i64 12}
!26 = !{!27, !27, i64 0}
!27 = !{!"int", !13, i64 0}
!28 = !{!24, !12, i64 4}
!29 = !{!24, !12, i64 8}
!30 = !{!31, !32, i64 0}
!31 = !{!"", !32, i64 0, !12, i64 4, !12, i64 8, !12, i64 12, !12, i64 16, !12, i64 20, !12, i64 24, !12, i64 28, !12, i64 32}
!32 = !{!"long", !13, i64 0}
!33 = !{!31, !12, i64 4}
!34 = !{!31, !12, i64 8}
!35 = !{!31, !12, i64 12}
...
!40 = !{!31, !12, i64 32}
!41 = !{!42, !43, i64 4}
!42 = !{!"aws_error_info_list", !12, i64 0, !43, i64 4}
!43 = !{!"short", !13, i64 0}
!44 = !{!42, !12, i64 0}
!45 = !{!46, !27, i64 0}
!46 = !{!"aws_error_info", !27, i64 0, !12, i64 4, !12, i64 8, !12, i64 12, !12, i64 16}
