; ModuleID = '../out2/aws_linked_list_remove_harness.c/aws_linked_list_remove_harness7cf4e.bc.txt'
...
define internal fastcc void @aws_linked_list_remove_harness() unnamed_addr #1 {
...
define internal fastcc void @aws_linked_list_remove(%struct.aws_linked_list_node* %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #12
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_remove_harness()
  %1 = tail call %struct.aws_linked_list_node* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_remove(%struct.aws_linked_list_node* %1)
  %2 = tail call %struct.aws_linked_list_node* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* %2)
  ...
  tail call fastcc void @aws_linked_list_node_reset(%struct.aws_linked_list_node* %4)
