; ModuleID = '../out2/aws_array_list_get_at_harness.c/aws_array_list_get_at_harness6bfff.bc.txt'
...
@.str.1.4 = private unnamed_addr constant [37 x i8] c"/tmp/aws-c-common/source/allocator.c\00", align 1
@.str.2.5 = private unnamed_addr constant [37 x i8] c"allocator->mem_acquire != ((void*)0)\00", align 1
@.str.3.6 = private unnamed_addr constant [10 x i8] c"size != 0\00", align 1
...
@.str.5.32 = private unnamed_addr constant [28 x i8] c"!list->length || list->data\00", align 1
@.str.6.33 = private unnamed_addr constant [52 x i8] c"/tmp/aws-c-common/include/aws/common/array_list.inl\00", align 1
...
@.str.34 = private unnamed_addr constant [11 x i8] c"libnuma.so\00", align 1
@.str.1.35 = private unnamed_addr constant [13 x i8] c"libnuma.so.1\00", align 1
@.str.2.36 = private unnamed_addr constant [13 x i8] c"libnuma.so.2\00", align 1
@.str.3.37 = private unnamed_addr constant [26 x i8] c"static: libnuma.so loaded\00", align 1
@.str.4.38 = private unnamed_addr constant [14 x i8] c"set_mempolicy\00", align 1
@.str.5.39 = private unnamed_addr constant [31 x i8] c"static: set_mempolicy() loaded\00", align 1
@.str.6.40 = private unnamed_addr constant [39 x i8] c"static: set_mempolicy() failed to load\00", align 1
@.str.7.41 = private unnamed_addr constant [15 x i8] c"numa_available\00", align 1
@.str.8.42 = private unnamed_addr constant [32 x i8] c"static: numa_available() loaded\00", align 1
@.str.9.43 = private unnamed_addr constant [40 x i8] c"static: numa_available() failed to load\00", align 1
@.str.10.44 = private unnamed_addr constant [26 x i8] c"numa_num_configured_nodes\00", align 1
...
@.str.34.46 = private unnamed_addr constant [18 x i8] c"AWS_ERROR_UNKNOWN\00", align 1
...
define internal fastcc void @aws_array_list_get_at_harness() unnamed_addr #1 {
  ...
  %6 = call zeroext i1 @aws_array_list_is_bounded(%struct.aws_array_list* nonnull %2, i32 0, i32 2) #13
...
aws_array_list_is_valid.exit:                     ; preds = %18, %.thread.i
  ...
  %25 = bitcast %struct.aws_array_list* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %25) #13
  ...
  %26 = bitcast %struct.store_byte_from_buffer* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %26) #13
  call void @save_byte_from_array(i8* %17, i32 %13, %struct.store_byte_from_buffer* nonnull %4) #13
  call void @seahorn.fn.enter() #13, !noalias !17
  %27 = load i32, i32* %7, align 8, !tbaa !8, !alias.scope !17
  %28 = load i32, i32* %9, align 4, !tbaa !14, !alias.scope !17
  call void @seahorn.fn.enter() #13
  call void @seahorn.fn.enter() #13
  %29 = mul i32 %28, %27
  %30 = load i32, i32* %12, align 4, !tbaa !15, !alias.scope !17
  %31 = icmp uge i32 %30, %29
  %32 = icmp eq i32 %30, 0
  %33 = load i8*, i8** %16, align 8, !tbaa !16, !alias.scope !17
  br i1 %32, label %34, label %36

34:                                               ; preds = %aws_array_list_is_valid.exit
  %35 = icmp eq i8* %33, null
  br i1 %35, label %.thread.i3, label %aws_array_list_is_valid.exit5

36:                                               ; preds = %aws_array_list_is_valid.exit
  %37 = icmp ne i8* %33, null
  br label %.thread.i3

.thread.i3:                                       ; preds = %36, %34
  %38 = phi i1 [ %37, %36 ], [ true, %34 ]
  %or.cond3.i1 = and i1 %31, %38
  %39 = icmp ne i32 %28, 0
  %spec.select.i2 = and i1 %39, %or.cond3.i1
  br label %aws_array_list_is_valid.exit5

aws_array_list_is_valid.exit5:                    ; preds = %34, %.thread.i3
  %40 = phi i1 [ %spec.select.i2, %.thread.i3 ], [ false, %34 ]
  call void @verifier.assume(i1 %40)
  call void @verifier.assume(i1 true)
  call void @seahorn.fn.enter() #13, !noalias !20
  call void @seahorn.fn.enter() #13, !noalias !23
  %41 = icmp ne i32 %27, 0
  %42 = icmp eq i8* %33, null
  %or.cond = and i1 %41, %42
  br i1 %or.cond, label %43, label %aws_array_list_length.exit.i

43:                                               ; preds = %aws_array_list_is_valid.exit5
  call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.32, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.33, i32 0, i32 0), i32 312) #14, !noalias !23
  unreachable

aws_array_list_length.exit.i:                     ; preds = %aws_array_list_is_valid.exit5
  %44 = icmp ugt i32 %27, %1
  br i1 %44, label %aws_array_list_get_at.exit, label %45

45:                                               ; preds = %aws_array_list_length.exit.i
  call void @seahorn.fn.enter() #13, !noalias !20
  call void @seahorn.fn.enter() #13, !noalias !20
  %46 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26, !noalias !20
  %47 = icmp eq void (i32, i8*)* %46, null
  br i1 %47, label %50, label %48

48:                                               ; preds = %45
  %49 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26, !noalias !20
  call void %46(i32 10, i8* %49) #13, !noalias !20
  br label %aws_array_list_get_at.exit

50:                                               ; preds = %45
  %51 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26, !noalias !20
  %52 = icmp eq void (i32, i8*)* %51, null
  br i1 %52, label %aws_array_list_get_at.exit, label %53

53:                                               ; preds = %50
  %54 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26, !noalias !20
  call void %51(i32 10, i8* %54) #13, !noalias !20
  br label %aws_array_list_get_at.exit

aws_array_list_get_at.exit:                       ; preds = %aws_array_list_length.exit.i, %48, %50, %53
  ...
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %25) #13
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_array_list_get_at(%struct.aws_array_list* noalias nocapture readonly %0, i8* %1, i32 %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #13
  tail call void @seahorn.fn.enter() #13, !noalias !30
  %4 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 2
  %5 = load i32, i32* %4, align 4, !tbaa !8, !alias.scope !30
  %6 = icmp eq i32 %5, 0
...
7:                                                ; preds = %3
  ...
  %9 = load i8*, i8** %8, align 4, !tbaa !16, !alias.scope !30
  %10 = icmp eq i8* %9, null
  br i1 %10, label %11, label %aws_array_list_length.exit

11:                                               ; preds = %7
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.32, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.33, i32 0, i32 0), i32 312) #14, !noalias !30
  unreachable
...
13:                                               ; preds = %aws_array_list_length.exit
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 1 %1, i8* align 1 %19, i32 %17, i1 false) #13
...
aws_raise_error.exit:                             ; preds = %28, %25, %23, %13
  ret void
}
...
9:                                                ; preds = %5
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.32, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.33, i32 0, i32 0), i32 312) #14
  unreachable
...
declare i8* @__memcpy_chk(i8*, i8*, i32, i32) local_unnamed_addr #5
...
4:                                                ; preds = %2
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 115) #14
  unreachable

5:                                                ; preds = %2
  %6 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 0
  %7 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %6, align 4, !tbaa !35
  %8 = icmp eq i8* (%struct.aws_allocator*, i32)* %7, null
  br i1 %8, label %9, label %10

9:                                                ; preds = %5
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.2.5, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 116) #14
  unreachable
...
12:                                               ; preds = %10
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3.6, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 118) #14
  unreachable

13:                                               ; preds = %10
  %14 = tail call i8* %7(%struct.aws_allocator* nonnull %0, i32 %1) #13
  %15 = icmp eq i8* %14, null
  br i1 %15, label %16, label %aws_raise_error.7.exit
...
aws_raise_error.7.exit:                           ; preds = %24, %21, %19, %13
  ret i8* %14
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_raise_error.7(i32 %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #13
  tail call void @seahorn.fn.enter() #13
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %3 = icmp eq void (i32, i8*)* %2, null
...
5:                                                ; preds = %3
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 128) #14
  unreachable

6:                                                ; preds = %3
  %7 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 3
  %8 = load i8* (%struct.aws_allocator*, i32, i32)*, i8* (%struct.aws_allocator*, i32, i32)** %7, align 4, !tbaa !37
...
10:                                               ; preds = %6
  ...
  %12 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %11, align 4, !tbaa !35
  %13 = icmp eq i8* (%struct.aws_allocator*, i32)* %12, null
  br i1 %13, label %14, label %15

14:                                               ; preds = %10
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 129) #14
  unreachable
...
18:                                               ; preds = %15
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 131) #14
  unreachable
...
21:                                               ; preds = %19
  ...
  br i1 %23, label %24, label %aws_raise_error.7.exit
...
29:                                               ; preds = %24
  ...
  br i1 %31, label %aws_raise_error.7.exit, label %32
...
34:                                               ; preds = %19
  ...
  %36 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %35, align 4, !tbaa !35
...
44:                                               ; preds = %39
  ...
  br i1 %46, label %aws_raise_error.7.exit, label %47
...
aws_raise_error.7.exit:                           ; preds = %47, %44, %42, %32, %29, %27, %49, %21
  ret void
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_size_checked.8(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #13
  tail call void @seahorn.fn.enter() #13
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !33
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_u32_checked.9(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #13
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !33
  ret void
...
4:                                                ; preds = %2
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 215) #14
  unreachable

5:                                                ; preds = %2
  %6 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 1
  %7 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %6, align 4, !tbaa !38
  %8 = icmp eq void (%struct.aws_allocator*, i8*)* %7, null
  br i1 %8, label %9, label %10

9:                                                ; preds = %5
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 216) #14
  unreachable
...
6:                                                ; preds = %4
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 224) #14
  unreachable

7:                                                ; preds = %4
  %8 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 2
  %9 = load i8* (%struct.aws_allocator*, i8*, i32, i32)*, i8* (%struct.aws_allocator*, i8*, i32, i32)** %8, align 4, !tbaa !39
...
11:                                               ; preds = %7
  ...
  %13 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %12, align 4, !tbaa !35
  %14 = icmp eq i8* (%struct.aws_allocator*, i32)* %13, null
  br i1 %14, label %15, label %16

15:                                               ; preds = %11
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 225) #14
  unreachable

16:                                               ; preds = %11, %7
  %17 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 1
  %18 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !38
  %19 = icmp eq void (%struct.aws_allocator*, i8*)* %18, null
  br i1 %19, label %20, label %21

20:                                               ; preds = %16
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.4, i32 0, i32 0), i32 226) #14
  unreachable
...
37:                                               ; preds = %32
  ...
  br i1 %39, label %aws_raise_error.7.exit, label %40
...
43:                                               ; preds = %27
  %44 = icmp ugt i32 %3, %2
  br i1 %44, label %45, label %aws_raise_error.7.exit

45:                                               ; preds = %43
  %46 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 0
  %47 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %46, align 4, !tbaa !35
...
55:                                               ; preds = %50
  ...
  br i1 %57, label %aws_raise_error.7.exit, label %58
...
60:                                               ; preds = %45
  ...
  tail call void @seahorn.fn.enter() #13
  %65 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !38
...
aws_raise_error.7.exit:                           ; preds = %58, %55, %53, %40, %37, %35, %aws_mem_release.exit7, %43, %42, %aws_mem_release.exit
...
define internal fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %0) unnamed_addr #1 {
  ...
  %4 = load i8* (%struct.aws_allocator*, i8*, i32, i32)*, i8* (%struct.aws_allocator*, i8*, i32, i32)** %3, align 4, !tbaa !39
  ...
  br i1 %18, label %19, label %aws_raise_error.7.exit
...
24:                                               ; preds = %19
  ...
  %26 = icmp eq void (i32, i8*)* %25, null
  br i1 %26, label %aws_raise_error.7.exit, label %27
...
aws_raise_error.7.exit:                           ; preds = %27, %24, %22, %1
...
7:                                                ; preds = %2
  ...
  %10 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %9, align 4, !tbaa !38
...
14:                                               ; preds = %9
  ...
  %16 = load %struct.aws_error_info*, %struct.aws_error_info** %15, align 4, !tbaa !53
...
4:                                                ; preds = %1
  ...
  %6 = load %struct.aws_error_info*, %struct.aws_error_info** %5, align 4, !tbaa !53
...
8:                                                ; preds = %3
  %9 = load i32, i32* %4, align 4, !tbaa !56
...
define internal fastcc void @aws_array_list_shrink_to_fit(%struct.aws_array_list* noalias nocapture %0) unnamed_addr #1 {
  ...
  %3 = load %struct.aws_allocator*, %struct.aws_allocator** %2, align 4, !tbaa !57
...
19:                                               ; preds = %16
  ...
  %23 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %22, align 4, !tbaa !38
...
28:                                               ; preds = %14
  ...
  %30 = load %struct.aws_allocator*, %struct.aws_allocator** %29, align 4, !tbaa !57
...
39:                                               ; preds = %35
  ...
  %41 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %40, align 4, !tbaa !38
...
22:                                               ; preds = %14
  ...
  %24 = load %struct.aws_allocator*, %struct.aws_allocator** %23, align 4, !tbaa !57
...
57:                                               ; preds = %53
  ...
  %59 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %58, align 4, !tbaa !38
...
17:                                               ; preds = %13
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.32, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.33, i32 0, i32 0), i32 312) #14, !noalias !64
  unreachable
...
define internal fastcc void @aws_array_list_get_at_ptr(%struct.aws_array_list* noalias nocapture readonly %0, i8** nocapture %1, i32 %2) unnamed_addr #4 {
  ...
  %6 = icmp eq i32 %5, 0
  br i1 %6, label %aws_array_list_length.31.exit, label %7

7:                                                ; preds = %3
  %8 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 4
  %9 = load i8*, i8** %8, align 4, !tbaa !16, !alias.scope !73
  %10 = icmp eq i8* %9, null
  br i1 %10, label %11, label %aws_array_list_length.31.exit

11:                                               ; preds = %7
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.32, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.33, i32 0, i32 0), i32 312) #14, !noalias !73
  unreachable

aws_array_list_length.31.exit:                    ; preds = %3, %7
  %12 = icmp ugt i32 %5, %2
  br i1 %12, label %13, label %20

13:                                               ; preds = %aws_array_list_length.31.exit
  %14 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 4
  %15 = load i8*, i8** %14, align 4, !tbaa !16
  %16 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 3
  %17 = load i32, i32* %16, align 4, !tbaa !14
...
20:                                               ; preds = %aws_array_list_length.31.exit
  tail call void @seahorn.fn.enter() #13
  tail call void @seahorn.fn.enter() #13
  %21 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %22 = icmp eq void (i32, i8*)* %21, null
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_array_list_length.31(%struct.aws_array_list* noalias nocapture readonly %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #13
  %2 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 2
  %3 = load i32, i32* %2, align 4, !tbaa !8
  %4 = icmp eq i32 %3, 0
...
1:                                                ; preds = %0
  ...
  tail call void @seahorn.fn.enter() #13
  %2 = load %struct.aws_error_info*, %struct.aws_error_info** getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 0), align 8, !tbaa !53
...
5:                                                ; preds = %1
  %6 = load i16, i16* getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 1), align 4, !tbaa !50
  %7 = icmp eq i16 %6, 0
  br i1 %7, label %8, label %9
...
aws_register_error_info.exit:                     ; preds = %9
  ...
  %18 = tail call i8* @dlopen(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.34, i32 0, i32 0), i32 4) #13
  store i8* %18, i8** @g_libnuma_handle, align 4, !tbaa !26
  %19 = icmp eq i8* %18, null
  br i1 %19, label %20, label %.thread1

20:                                               ; preds = %aws_register_error_info.exit
  %21 = tail call i8* @dlopen(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1.35, i32 0, i32 0), i32 4) #13
...
25:                                               ; preds = %20
  %26 = tail call i8* @dlopen(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2.36, i32 0, i32 0), i32 4) #13
...
39:                                               ; preds = %31
  ...
  %43 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %42(%struct.aws_logger* nonnull %32, i32 4, i32 0, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3.37, i32 0, i32 0)) #13
  br label %44

44:                                               ; preds = %.thread1, %39, %31, %30
  %45 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !26
  %46 = tail call i8* @dlsym(i8* %45, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4.38, i32 0, i32 0)) #13
...
58:                                               ; preds = %51
  ...
  %62 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %61(%struct.aws_logger* nonnull %48, i32 4, i32 0, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.5.39, i32 0, i32 0)) #13
  br label %76
...
71:                                               ; preds = %64
  ...
  %75 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %74(%struct.aws_logger* nonnull %48, i32 4, i32 0, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.6.40, i32 0, i32 0)) #13
  br label %76

76:                                               ; preds = %71, %64, %63, %58, %51, %50
  %77 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !26
  %78 = tail call i8* @dlsym(i8* %77, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.7.41, i32 0, i32 0)) #13
...
90:                                               ; preds = %83
  ...
  %94 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %93(%struct.aws_logger* nonnull %80, i32 4, i32 0, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.8.42, i32 0, i32 0)) #13
  br label %108
...
103:                                              ; preds = %96
  ...
  %107 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %106(%struct.aws_logger* nonnull %80, i32 4, i32 0, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.9.43, i32 0, i32 0)) #13
  br label %108

108:                                              ; preds = %103, %96, %95, %90, %83, %82
  %109 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !26
  %110 = tail call i8* @dlsym(i8* %109, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.10.44, i32 0, i32 0)) #13
...
1:                                                ; preds = %0
  ...
  tail call void @seahorn.fn.enter() #13
  %3 = load %struct.aws_error_info*, %struct.aws_error_info** getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 0), align 8, !tbaa !53
...
6:                                                ; preds = %1
  %7 = load i16, i16* getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 1), align 4, !tbaa !50
  %8 = icmp eq i16 %7, 0
  br i1 %8, label %9, label %10
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_array_list_get_at_harness()
  ...
  tail call fastcc void @aws_array_list_get_at(%struct.aws_array_list* %3, i8* %4, i32 %5)
  ...
  tail call fastcc void @aws_raise_error(i32 %8)
  %9 = tail call i32 @verifier.nondet.3()
  %10 = tail call i32 @verifier.nondet.3()
  %11 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked(i32 %9, i32 %10, i32* %11)
  %12 = tail call i32 @verifier.nondet.3()
  %13 = tail call i32 @verifier.nondet.3()
  %14 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked(i32 %12, i32 %13, i32* %14)
  %15 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_allocator_is_valid(%struct.aws_allocator* %15)
  ...
  %18 = tail call i8* @s_default_malloc(%struct.aws_allocator* %16, i32 %17)
  %19 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %20 = tail call i8* @verifier.nondet.2()
  tail call void @s_default_free(%struct.aws_allocator* %19, i8* %20)
  %21 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %22 = tail call i8* @verifier.nondet.2()
  %23 = tail call i32 @verifier.nondet.3()
  %24 = tail call i32 @verifier.nondet.3()
  %25 = tail call i8* @s_default_realloc(%struct.aws_allocator* %21, i8* %22, i32 %23, i32 %24)
  %26 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %27 = tail call i32 @verifier.nondet.3()
  %28 = tail call i32 @verifier.nondet.3()
  %29 = tail call i8* @s_default_calloc(%struct.aws_allocator* %26, i32 %27, i32 %28)
  %30 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %31 = tail call i32 @verifier.nondet.3()
  %32 = tail call fastcc i8* @aws_mem_acquire(%struct.aws_allocator* %30, i32 %31)
  %33 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.7(i32 %33)
  %34 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %35 = tail call i32 @verifier.nondet.3()
  %36 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_mem_calloc(%struct.aws_allocator* %34, i32 %35, i32 %36)
  %37 = tail call i32 @verifier.nondet.3()
  %38 = tail call i32 @verifier.nondet.3()
  %39 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked.8(i32 %37, i32 %38, i32* %39)
  %40 = tail call i32 @verifier.nondet.3()
  %41 = tail call i32 @verifier.nondet.3()
  %42 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked.9(i32 %40, i32 %41, i32* %42)
  %43 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %44 = tail call i32 @verifier.nondet.3()
  %45 = tail call i8* (%struct.aws_allocator*, i32, ...) @aws_mem_acquire_many(%struct.aws_allocator* %43, i32 %44)
  %46 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %47 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_mem_release(%struct.aws_allocator* %46, i8* %47)
  %48 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %49 = tail call i8** @verifier.nondet.6()
  %50 = tail call i32 @verifier.nondet.3()
  %51 = tail call i32 @verifier.nondet.3()
  %52 = tail call fastcc i32 @aws_mem_realloc(%struct.aws_allocator* %48, i8** %49, i32 %50, i32 %51)
  %53 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %53)
  %54 = tail call i8* @verifier.nondet.2()
  %55 = tail call i32 @verifier.nondet.3()
  %56 = tail call i32 @verifier.nondet.3()
  %57 = tail call i8* @verifier.nondet.2()
  %58 = tail call i8* @s_cf_allocator_reallocate(i8* %54, i32 %55, i32 %56, i8* %57)
  %59 = tail call i8* @verifier.nondet.2()
  %60 = tail call %struct.__CFString* @s_cf_allocator_copy_description(i8* %59)
  %61 = tail call i32 @verifier.nondet.3()
  %62 = tail call i32 @verifier.nondet.3()
  %63 = tail call i8* @verifier.nondet.2()
  %64 = tail call i8* @s_cf_allocator_allocate(i32 %61, i32 %62, i8* %63)
  %65 = tail call i8* @verifier.nondet.2()
  %66 = tail call i8* @verifier.nondet.2()
  tail call void @s_cf_allocator_deallocate(i8* %65, i8* %66)
  %67 = tail call i32 @verifier.nondet.3()
  %68 = tail call i32 @verifier.nondet.3()
  %69 = tail call i8* @verifier.nondet.2()
  %70 = tail call i32 @s_cf_allocator_preferred_size(i32 %67, i32 %68, i8* %69)
  %71 = tail call %struct.__CFAllocator* @verifier.nondet.7()
  tail call fastcc void @aws_wrapped_cf_allocator_destroy(%struct.__CFAllocator* %71)
  tail call fastcc void @aws_last_error()
  %72 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_str(i32 %72)
  %73 = tail call i32 @verifier.nondet.3()
  %74 = tail call fastcc %struct.aws_error_info* @get_error_by_code(i32 %73)
  %75 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_name(i32 %75)
  %76 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_lib_name(i32 %76)
  %77 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_debug_str(i32 %77)
  %78 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error_private(i32 %78)
  tail call fastcc void @aws_reset_error()
  %79 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_restore_error(i32 %79)
  %80 = tail call void (i32, i8*)* @verifier.nondet.8()
  %81 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %80, i8* %81)
  %82 = tail call void (i32, i8*)* @verifier.nondet.8()
  %83 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %82, i8* %83)
  %84 = tail call %struct.aws_error_info_list* @verifier.nondet.9()
  tail call fastcc void @aws_register_error_info(%struct.aws_error_info_list* %84)
  %85 = tail call %struct.aws_error_info_list* @verifier.nondet.9()
  tail call fastcc void @aws_unregister_error_info(%struct.aws_error_info_list* %85)
  %86 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_translate_and_raise_io_error(i32 %86)
  %87 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.20(i32 %87)
  %88 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %89 = tail call i32 @verifier.nondet.3()
  %90 = tail call i32* @verifier.nondet.4()
  %91 = tail call fastcc i32 @aws_array_list_calc_necessary_size(%struct.aws_array_list* %88, i32 %89, i32* %90)
  %92 = tail call i32 @verifier.nondet.3()
  %93 = tail call i32 @verifier.nondet.3()
  %94 = tail call i32* @verifier.nondet.4()
  %95 = tail call fastcc i32 @aws_add_size_checked(i32 %92, i32 %93, i32* %94)
  %96 = tail call i32 @verifier.nondet.3()
  %97 = tail call i32 @verifier.nondet.3()
  %98 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked.21(i32 %96, i32 %97, i32* %98)
  %99 = tail call i32 @verifier.nondet.3()
  %100 = tail call i32 @verifier.nondet.3()
  %101 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked.22(i32 %99, i32 %100, i32* %101)
  %102 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.23(i32 %102)
  %103 = tail call i32 @verifier.nondet.3()
  %104 = tail call i32 @verifier.nondet.3()
  %105 = tail call i32* @verifier.nondet.4()
  %106 = tail call fastcc i32 @aws_add_u32_checked(i32 %103, i32 %104, i32* %105)
  %107 = tail call %struct.aws_array_list* @verifier.nondet.1()
  tail call fastcc void @aws_array_list_shrink_to_fit(%struct.aws_array_list* %107)
  %108 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %109 = tail call %struct.aws_array_list* @verifier.nondet.1()
  tail call fastcc void @aws_array_list_copy(%struct.aws_array_list* %108, %struct.aws_array_list* %109)
  %110 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %111 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_ensure_capacity(%struct.aws_array_list* %110, i32 %111)
  ...
  tail call fastcc void @aws_array_list_swap(%struct.aws_array_list* %112, i32 %113, i32 %114)
  %115 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %116 = tail call i8** @verifier.nondet.6()
  %117 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_get_at_ptr(%struct.aws_array_list* %115, i8** %116, i32 %117)
  %118 = tail call i8* @verifier.nondet.2()
  %119 = tail call i8* @verifier.nondet.2()
  %120 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_mem_swap(i8* %118, i8* %119, i32 %120)
  %121 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %122 = tail call fastcc i32 @aws_array_list_length.31(%struct.aws_array_list* %121)
  %123 = tail call i8* @verifier.nondet.2()
  %124 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_secure_zero(i8* %123, i32 %124)
  %125 = tail call %struct.aws_allocator* @verifier.nondet.5()
...
attributes #5 = { nofree nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!20 = !{!21}
!21 = distinct !{!21, !22, !"aws_array_list_get_at: argument 0"}
!22 = distinct !{!22, !"aws_array_list_get_at"}
!23 = !{!24, !21}
...
!34 = !{!"int", !11, i64 0}
!35 = !{!36, !10, i64 0}
!36 = !{!"aws_allocator", !10, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16}
!37 = !{!36, !10, i64 12}
!38 = !{!36, !10, i64 4}
!39 = !{!36, !10, i64 8}
!40 = !{!41, !13, i64 0}
!41 = !{!"", !13, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16, !10, i64 20, !10, i64 24, !10, i64 28, !10, i64 32}
!42 = !{!41, !10, i64 4}
!43 = !{!41, !10, i64 8}
!44 = !{!41, !10, i64 12}
!45 = !{!41, !10, i64 16}
...
!49 = !{!41, !10, i64 32}
!50 = !{!51, !52, i64 4}
!51 = !{!"aws_error_info_list", !10, i64 0, !52, i64 4}
!52 = !{!"short", !11, i64 0}
!53 = !{!51, !10, i64 0}
!54 = !{!55, !34, i64 0}
!55 = !{!"aws_error_info", !34, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16}
!56 = !{!13, !13, i64 0}
!57 = !{!9, !10, i64 0}
!58 = !{!59}
...
!64 = !{!65, !62}
!65 = distinct !{!65, !66, !"aws_array_list_length.31: argument 0"}
!66 = distinct !{!66, !"aws_array_list_length.31"}
!67 = !{!68}
!68 = distinct !{!68, !69, !"aws_array_list_get_at_ptr: argument 0"}
!69 = distinct !{!69, !"aws_array_list_get_at_ptr"}
!70 = !{!71, !68}
!71 = distinct !{!71, !72, !"aws_array_list_length.31: argument 0"}
!72 = distinct !{!72, !"aws_array_list_length.31"}
!73 = !{!74}
!74 = distinct !{!74, !75, !"aws_array_list_length.31: argument 0"}
!75 = distinct !{!75, !"aws_array_list_length.31"}
!76 = distinct !{!76, !77}
