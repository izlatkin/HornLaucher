; ModuleID = '../out2/aws_linked_list_pop_front_harness.c/aws_linked_list_pop_front_harness46938.bc.txt'
...
define internal fastcc void @aws_linked_list_pop_front_harness() unnamed_addr #1 {
  ...
  %5 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1
  %6 = icmp ne %struct.aws_linked_list_node* %4, %5
  call void @verifier.assume(i1 %6)
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
  %7 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %4, i32 0, i32 0
  %8 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %7, align 4, !tbaa !11
  %9 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %4, i32 0, i32 1
  %10 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %9, align 4, !tbaa !12
  %11 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %10, i32 0, i32 0
  store %struct.aws_linked_list_node* %8, %struct.aws_linked_list_node** %11, align 4, !tbaa !11
  %12 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %7, align 4, !tbaa !11
  %13 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %12, i32 0, i32 1
  store %struct.aws_linked_list_node* %10, %struct.aws_linked_list_node** %13, align 4, !tbaa !12
  call void @seahorn.fn.enter() #12
  %14 = bitcast %struct.aws_linked_list_node* %4 to i64*
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_pop_front(%struct.aws_linked_list* nocapture readonly %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %2 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 0, i32 0
  %3 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %2, align 4, !tbaa !5
  tail call void @seahorn.fn.enter() #12
  %4 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %3, i32 0, i32 0
  %5 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %4, align 4, !tbaa !11
  %6 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %3, i32 0, i32 1
  %7 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %6, align 4, !tbaa !12
  %8 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %7, i32 0, i32 0
  store %struct.aws_linked_list_node* %5, %struct.aws_linked_list_node** %8, align 4, !tbaa !11
  %9 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %4, align 4, !tbaa !11
  %10 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %9, i32 0, i32 1
  store %struct.aws_linked_list_node* %7, %struct.aws_linked_list_node** %10, align 4, !tbaa !12
  tail call void @seahorn.fn.enter() #12
  %11 = bitcast %struct.aws_linked_list_node* %3 to i64*
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc %struct.aws_linked_list_node* @aws_linked_list_front(%struct.aws_linked_list* nocapture readonly %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  %2 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 0, i32 0
  %3 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %2, align 4, !tbaa !5
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_remove(%struct.aws_linked_list_node* %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  %2 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %0, i32 0, i32 0
  %3 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %2, align 4, !tbaa !11
  %4 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %0, i32 0, i32 1
  %5 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %4, align 4, !tbaa !12
  %6 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %5, i32 0, i32 0
  store %struct.aws_linked_list_node* %3, %struct.aws_linked_list_node** %6, align 4, !tbaa !11
  %7 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %2, align 4, !tbaa !11
  %8 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %7, i32 0, i32 1
  store %struct.aws_linked_list_node* %5, %struct.aws_linked_list_node** %8, align 4, !tbaa !12
  tail call void @seahorn.fn.enter() #12
  %9 = bitcast %struct.aws_linked_list_node* %0 to i64*
  store i64 0, i64* %9, align 1
  ret void
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_node_reset(%struct.aws_linked_list_node* %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
...
5:                                                ; preds = %2
  ...
  %7 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %6, align 4, !tbaa !14
...
16:                                               ; preds = %13
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %17 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %18 = icmp eq void (i32, i8*)* %17, null
  br i1 %18, label %21, label %19

19:                                               ; preds = %16
  %20 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %17(i32 1, i8* %20) #12
  br label %aws_raise_error.exit

21:                                               ; preds = %16
  %22 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %23 = icmp eq void (i32, i8*)* %22, null
  br i1 %23, label %aws_raise_error.exit, label %24

24:                                               ; preds = %21
  %25 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
define internal fastcc void @aws_raise_error(i32 %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %3 = icmp eq void (i32, i8*)* %2, null
  br i1 %3, label %6, label %4

4:                                                ; preds = %1
  %5 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %2(i32 %0, i8* %5) #12
  br label %aws_raise_error_private.exit

6:                                                ; preds = %1
  %7 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %8 = icmp eq void (i32, i8*)* %7, null
  br i1 %8, label %aws_raise_error_private.exit, label %9

9:                                                ; preds = %6
  %10 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
6:                                                ; preds = %3
  ...
  %8 = load i8* (%struct.aws_allocator*, i32, i32)*, i8* (%struct.aws_allocator*, i32, i32)** %7, align 4, !tbaa !16
...
10:                                               ; preds = %6
  ...
  %12 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %11, align 4, !tbaa !14
...
24:                                               ; preds = %21
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %25 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %26 = icmp eq void (i32, i8*)* %25, null
  br i1 %26, label %29, label %27

27:                                               ; preds = %24
  %28 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %25(i32 1, i8* %28) #12
  br label %aws_raise_error.exit

29:                                               ; preds = %24
  %30 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %31 = icmp eq void (i32, i8*)* %30, null
  br i1 %31, label %aws_raise_error.exit, label %32

32:                                               ; preds = %29
  %33 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
  tail call void %30(i32 1, i8* %33) #12
  br label %aws_raise_error.exit

34:                                               ; preds = %19
  %35 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 0
  %36 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %35, align 4, !tbaa !14
...
39:                                               ; preds = %34
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %40 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %41 = icmp eq void (i32, i8*)* %40, null
  br i1 %41, label %44, label %42

42:                                               ; preds = %39
  %43 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %40(i32 1, i8* %43) #12
  br label %aws_raise_error.exit

44:                                               ; preds = %39
  %45 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %46 = icmp eq void (i32, i8*)* %45, null
  br i1 %46, label %aws_raise_error.exit, label %47

47:                                               ; preds = %44
  %48 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
5:                                                ; preds = %2
  ...
  %7 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %6, align 4, !tbaa !19
...
11:                                               ; preds = %7
  ...
  %13 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %12, align 4, !tbaa !14
...
16:                                               ; preds = %11, %7
  ...
  %18 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !19
...
23:                                               ; preds = %21
  %24 = load i8*, i8** %1, align 4, !tbaa !13
  tail call void @seahorn.fn.enter() #12
...
aws_mem_release.exit:                             ; preds = %23, %26
  store i8* null, i8** %1, align 4, !tbaa !13
  br label %aws_raise_error.exit
...
28:                                               ; preds = %27
  %29 = load i8*, i8** %1, align 4, !tbaa !13
...
32:                                               ; preds = %28
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %33 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %34 = icmp eq void (i32, i8*)* %33, null
  br i1 %34, label %37, label %35

35:                                               ; preds = %32
  %36 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %33(i32 1, i8* %36) #12
  br label %aws_raise_error.exit

37:                                               ; preds = %32
  %38 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %39 = icmp eq void (i32, i8*)* %38, null
  br i1 %39, label %aws_raise_error.exit, label %40

40:                                               ; preds = %37
  %41 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
  tail call void %38(i32 1, i8* %41) #12
  br label %aws_raise_error.exit

42:                                               ; preds = %28
  store i8* %30, i8** %1, align 4, !tbaa !13
  br label %aws_raise_error.exit
...
45:                                               ; preds = %43
  ...
  %47 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %46, align 4, !tbaa !14
...
50:                                               ; preds = %45
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %51 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %52 = icmp eq void (i32, i8*)* %51, null
  br i1 %52, label %55, label %53

53:                                               ; preds = %50
  %54 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %51(i32 1, i8* %54) #12
  br label %aws_raise_error.exit

55:                                               ; preds = %50
  %56 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %57 = icmp eq void (i32, i8*)* %56, null
  br i1 %57, label %aws_raise_error.exit, label %58

58:                                               ; preds = %55
  %59 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
  tail call void %56(i32 1, i8* %59) #12
  br label %aws_raise_error.exit

60:                                               ; preds = %45
  %61 = load i8*, i8** %1, align 4, !tbaa !13
  ...
  %64 = load i8*, i8** %1, align 4, !tbaa !13
  tail call void @seahorn.fn.enter() #12
  %65 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !19
...
aws_mem_release.exit7:                            ; preds = %68, %70
  store i8* %48, i8** %1, align 4, !tbaa !13
  br label %aws_raise_error.exit
...
19:                                               ; preds = %1
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
  %20 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %21 = icmp eq void (i32, i8*)* %20, null
  br i1 %21, label %24, label %22

22:                                               ; preds = %19
  %23 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  call void %20(i32 1, i8* %23) #12
  br label %aws_raise_error.exit

24:                                               ; preds = %19
  %25 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %26 = icmp eq void (i32, i8*)* %25, null
  br i1 %26, label %aws_raise_error.exit, label %27

27:                                               ; preds = %24
  %28 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
define internal i8* @s_cf_allocator_reallocate(i8* %0, i32 %1, i32 %2, i8* %3) #1 {
  ...
  store i8* %8, i8** %5, align 4, !tbaa !13
...
13:                                               ; preds = %4
  %14 = load i8*, i8** %5, align 4, !tbaa !13
...
7:                                                ; preds = %2
  ...
  %10 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %9, align 4, !tbaa !19
...
3:                                                ; preds = %1
  ...
  %6 = load volatile %struct.aws_error_info_list*, %struct.aws_error_info_list** %5, align 4, !tbaa !13
  ret void
...
3:                                                ; preds = %1
  ...
  %7 = load volatile %struct.aws_error_info_list*, %struct.aws_error_info_list** %6, align 4, !tbaa !13
...
define internal fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %0, i8* %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #12
  store void (i32, i8*)* %0, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  store i8* %1, i8** @s_global_error_context, align 4, !tbaa !13
  ret void
}
...
define internal fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %0, i8* %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #12
  store void (i32, i8*)* %0, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  store i8* %1, i8** @tl_thread_handler_context, align 4, !tbaa !13
  ret void
}
...
19:                                               ; preds = %14
  %20 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !13
...
22:                                               ; preds = %14
  ...
  store volatile %struct.aws_error_info_list* %0, %struct.aws_error_info_list** %23, align 4, !tbaa !13
  ret void
}
...
22:                                               ; preds = %14
  %23 = getelementptr inbounds [16 x %struct.aws_error_info_list*], [16 x %struct.aws_error_info_list*]* @ERROR_SLOTS, i32 0, i32 %17
  store volatile %struct.aws_error_info_list* null, %struct.aws_error_info_list** %23, align 4, !tbaa !13
  ret void
}
...
11:                                               ; preds = %LeafBlock15
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %12 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %13 = icmp eq void (i32, i8*)* %12, null
  br i1 %13, label %16, label %14

14:                                               ; preds = %11
  %15 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %12(i32 42, i8* %15) #12
  br label %aws_raise_error.20.exit

16:                                               ; preds = %11
  %17 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %18 = icmp eq void (i32, i8*)* %17, null
  br i1 %18, label %aws_raise_error.20.exit, label %19

19:                                               ; preds = %16
  %20 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
21:                                               ; preds = %LeafBlock, %LeafBlock3
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %22 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %23 = icmp eq void (i32, i8*)* %22, null
  br i1 %23, label %26, label %24

24:                                               ; preds = %21
  %25 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %22(i32 43, i8* %25) #12
  br label %aws_raise_error.20.exit

26:                                               ; preds = %21
  %27 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %28 = icmp eq void (i32, i8*)* %27, null
  br i1 %28, label %aws_raise_error.20.exit, label %29

29:                                               ; preds = %26
  %30 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
31:                                               ; preds = %LeafBlock1, %NodeBlock5, %LeafBlock17
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %32 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %33 = icmp eq void (i32, i8*)* %32, null
  br i1 %33, label %36, label %34

34:                                               ; preds = %31
  %35 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %32(i32 44, i8* %35) #12
  br label %aws_raise_error.20.exit

36:                                               ; preds = %31
  %37 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %38 = icmp eq void (i32, i8*)* %37, null
  br i1 %38, label %aws_raise_error.20.exit, label %39

39:                                               ; preds = %36
  %40 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
41:                                               ; preds = %LeafBlock11
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %42 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %43 = icmp eq void (i32, i8*)* %42, null
  br i1 %43, label %46, label %44

44:                                               ; preds = %41
  %45 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %42(i32 45, i8* %45) #12
  br label %aws_raise_error.20.exit

46:                                               ; preds = %41
  %47 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %48 = icmp eq void (i32, i8*)* %47, null
  br i1 %48, label %aws_raise_error.20.exit, label %49

49:                                               ; preds = %46
  %50 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
51:                                               ; preds = %NodeBlock7
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %52 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %53 = icmp eq void (i32, i8*)* %52, null
  br i1 %53, label %56, label %54

54:                                               ; preds = %51
  %55 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %52(i32 1, i8* %55) #12
  br label %aws_raise_error.20.exit

56:                                               ; preds = %51
  %57 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %58 = icmp eq void (i32, i8*)* %57, null
  br i1 %58, label %aws_raise_error.20.exit, label %59

59:                                               ; preds = %56
  %60 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
61:                                               ; preds = %NodeBlock21
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %62 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %63 = icmp eq void (i32, i8*)* %62, null
  br i1 %63, label %66, label %64

64:                                               ; preds = %61
  %65 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %62(i32 2, i8* %65) #12
  br label %aws_raise_error.20.exit

66:                                               ; preds = %61
  %67 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %68 = icmp eq void (i32, i8*)* %67, null
  br i1 %68, label %aws_raise_error.20.exit, label %69

69:                                               ; preds = %66
  %70 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
NewDefault:                                       ; preds = %LeafBlock, %LeafBlock1, %LeafBlock3, %LeafBlock11, %LeafBlock15, %LeafBlock17
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %71 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !13
  %72 = icmp eq void (i32, i8*)* %71, null
  br i1 %72, label %75, label %73

73:                                               ; preds = %NewDefault
  %74 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !13
  tail call void %71(i32 46, i8* %74) #12
  br label %aws_raise_error.20.exit

75:                                               ; preds = %NewDefault
  %76 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !13
  %77 = icmp eq void (i32, i8*)* %76, null
  br i1 %77, label %aws_raise_error.20.exit, label %78

78:                                               ; preds = %75
  %79 = load i8*, i8** @s_global_error_context, align 4, !tbaa !13
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_pop_front_harness()
  %1 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  %2 = tail call fastcc i1 @aws_linked_list_empty(%struct.aws_linked_list* %1)
  %3 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_pop_front(%struct.aws_linked_list* %3)
  %4 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_is_valid(%struct.aws_linked_list* %4)
  %5 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  %6 = tail call fastcc %struct.aws_linked_list_node* @aws_linked_list_front(%struct.aws_linked_list* %5)
  %7 = tail call %struct.aws_linked_list_node* @verifier.nondet.2()
  tail call fastcc void @aws_linked_list_remove(%struct.aws_linked_list_node* %7)
  %8 = tail call %struct.aws_linked_list_node* @verifier.nondet.2()
  tail call fastcc void @aws_linked_list_node_reset(%struct.aws_linked_list_node* %8)
  %9 = tail call %struct.aws_allocator* @verifier.nondet.3()
  tail call fastcc void @aws_allocator_is_valid(%struct.aws_allocator* %9)
  tail call fastcc void @aws_default_allocator()
  %10 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %11 = tail call i32 @verifier.nondet.4()
  %12 = tail call i8* @s_default_malloc(%struct.aws_allocator* %10, i32 %11)
  %13 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %14 = tail call i8* @verifier.nondet.5()
  tail call void @s_default_free(%struct.aws_allocator* %13, i8* %14)
  %15 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %16 = tail call i8* @verifier.nondet.5()
  %17 = tail call i32 @verifier.nondet.4()
  %18 = tail call i32 @verifier.nondet.4()
  %19 = tail call i8* @s_default_realloc(%struct.aws_allocator* %15, i8* %16, i32 %17, i32 %18)
  %20 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %21 = tail call i32 @verifier.nondet.4()
  %22 = tail call i32 @verifier.nondet.4()
  %23 = tail call i8* @s_default_calloc(%struct.aws_allocator* %20, i32 %21, i32 %22)
  %24 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %25 = tail call i32 @verifier.nondet.4()
  %26 = tail call fastcc i8* @aws_mem_acquire(%struct.aws_allocator* %24, i32 %25)
  %27 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_raise_error(i32 %27)
  %28 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %29 = tail call i32 @verifier.nondet.4()
  %30 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_mem_calloc(%struct.aws_allocator* %28, i32 %29, i32 %30)
  %31 = tail call i32 @verifier.nondet.4()
  %32 = tail call i32 @verifier.nondet.4()
  %33 = tail call i32* @verifier.nondet.6()
  tail call fastcc void @aws_mul_size_checked(i32 %31, i32 %32, i32* %33)
  %34 = tail call i32 @verifier.nondet.4()
  %35 = tail call i32 @verifier.nondet.4()
  %36 = tail call i32* @verifier.nondet.6()
  tail call fastcc void @aws_mul_u32_checked(i32 %34, i32 %35, i32* %36)
  %37 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %38 = tail call i32 @verifier.nondet.4()
  %39 = tail call i8* (%struct.aws_allocator*, i32, ...) @aws_mem_acquire_many(%struct.aws_allocator* %37, i32 %38)
  %40 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %41 = tail call i8* @verifier.nondet.5()
  tail call fastcc void @aws_mem_release(%struct.aws_allocator* %40, i8* %41)
  %42 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %43 = tail call i8** @verifier.nondet.7()
  %44 = tail call i32 @verifier.nondet.4()
  %45 = tail call i32 @verifier.nondet.4()
  %46 = tail call fastcc i32 @aws_mem_realloc(%struct.aws_allocator* %42, i8** %43, i32 %44, i32 %45)
  %47 = tail call %struct.aws_allocator* @verifier.nondet.3()
  tail call fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %47)
  %48 = tail call i8* @verifier.nondet.5()
  %49 = tail call i32 @verifier.nondet.4()
  %50 = tail call i32 @verifier.nondet.4()
  %51 = tail call i8* @verifier.nondet.5()
  %52 = tail call i8* @s_cf_allocator_reallocate(i8* %48, i32 %49, i32 %50, i8* %51)
  %53 = tail call i8* @verifier.nondet.5()
  %54 = tail call %struct.__CFString* @s_cf_allocator_copy_description(i8* %53)
  %55 = tail call i32 @verifier.nondet.4()
  %56 = tail call i32 @verifier.nondet.4()
  %57 = tail call i8* @verifier.nondet.5()
  %58 = tail call i8* @s_cf_allocator_allocate(i32 %55, i32 %56, i8* %57)
  %59 = tail call i8* @verifier.nondet.5()
  %60 = tail call i8* @verifier.nondet.5()
  tail call void @s_cf_allocator_deallocate(i8* %59, i8* %60)
  %61 = tail call i32 @verifier.nondet.4()
  %62 = tail call i32 @verifier.nondet.4()
  %63 = tail call i8* @verifier.nondet.5()
  %64 = tail call i32 @s_cf_allocator_preferred_size(i32 %61, i32 %62, i8* %63)
  %65 = tail call %struct.__CFAllocator* @verifier.nondet.8()
  tail call fastcc void @aws_wrapped_cf_allocator_destroy(%struct.__CFAllocator* %65)
  tail call fastcc void @aws_last_error()
  %66 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_error_str(i32 %66)
  %67 = tail call i32 @verifier.nondet.4()
  %68 = tail call fastcc %struct.aws_error_info* @get_error_by_code(i32 %67)
  %69 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_error_name(i32 %69)
  %70 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_error_lib_name(i32 %70)
  %71 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_error_debug_str(i32 %71)
  %72 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_raise_error_private(i32 %72)
  tail call fastcc void @aws_reset_error()
  %73 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_restore_error(i32 %73)
  %74 = tail call void (i32, i8*)* @verifier.nondet.9()
  %75 = tail call i8* @verifier.nondet.5()
  tail call fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %74, i8* %75)
  %76 = tail call void (i32, i8*)* @verifier.nondet.9()
  %77 = tail call i8* @verifier.nondet.5()
  tail call fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %76, i8* %77)
  %78 = tail call %struct.aws_error_info_list* @verifier.nondet.10()
  tail call fastcc void @aws_register_error_info(%struct.aws_error_info_list* %78)
  %79 = tail call %struct.aws_error_info_list* @verifier.nondet.10()
  tail call fastcc void @aws_unregister_error_info(%struct.aws_error_info_list* %79)
  %80 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_translate_and_raise_io_error(i32 %80)
  %81 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_raise_error.20(i32 %81)
  ret i32 42
}

declare %struct.aws_linked_list* @verifier.nondet.1() local_unnamed_addr

declare %struct.aws_linked_list_node* @verifier.nondet.2() local_unnamed_addr

declare %struct.aws_allocator* @verifier.nondet.3() local_unnamed_addr
...
!13 = !{!8, !8, i64 0}
!14 = !{!15, !8, i64 0}
!15 = !{!"aws_allocator", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16}
!16 = !{!15, !8, i64 12}
!17 = !{!18, !18, i64 0}
!18 = !{!"int", !9, i64 0}
!19 = !{!15, !8, i64 4}
!20 = !{!15, !8, i64 8}
!21 = !{!22, !23, i64 0}
!22 = !{!"", !23, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16, !8, i64 20, !8, i64 24, !8, i64 28, !8, i64 32}
!23 = !{!"long", !9, i64 0}
!24 = !{!22, !8, i64 4}
!25 = !{!22, !8, i64 8}
!26 = !{!22, !8, i64 12}
...
!31 = !{!22, !8, i64 32}
!32 = !{!33, !34, i64 4}
!33 = !{!"aws_error_info_list", !8, i64 0, !34, i64 4}
!34 = !{!"short", !9, i64 0}
!35 = !{!33, !8, i64 0}
!36 = !{!37, !18, i64 0}
!37 = !{!"aws_error_info", !18, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16}
