; ModuleID = '../out2/aws_linked_list_back_harness.c/aws_linked_list_back_harnessc60f2.bc.txt'
...
define internal fastcc void @aws_linked_list_back_harness() unnamed_addr #1 {
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc %struct.aws_linked_list_node* @aws_linked_list_back(%struct.aws_linked_list* nocapture readonly %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  %2 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1, i32 1
...
16:                                               ; preds = %13
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %17 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %18 = icmp eq void (i32, i8*)* %17, null
  br i1 %18, label %21, label %19

19:                                               ; preds = %16
  %20 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %17(i32 1, i8* %20) #12
  br label %aws_raise_error.exit

21:                                               ; preds = %16
  %22 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %23 = icmp eq void (i32, i8*)* %22, null
  br i1 %23, label %aws_raise_error.exit, label %24

24:                                               ; preds = %21
  %25 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
define internal fastcc void @aws_raise_error(i32 %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %3 = icmp eq void (i32, i8*)* %2, null
  br i1 %3, label %6, label %4

4:                                                ; preds = %1
  %5 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %2(i32 %0, i8* %5) #12
  br label %aws_raise_error_private.exit

6:                                                ; preds = %1
  %7 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %8 = icmp eq void (i32, i8*)* %7, null
  br i1 %8, label %aws_raise_error_private.exit, label %9

9:                                                ; preds = %6
  %10 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
24:                                               ; preds = %21
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %25 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %26 = icmp eq void (i32, i8*)* %25, null
  br i1 %26, label %29, label %27

27:                                               ; preds = %24
  %28 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %25(i32 1, i8* %28) #12
  br label %aws_raise_error.exit

29:                                               ; preds = %24
  %30 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %31 = icmp eq void (i32, i8*)* %30, null
  br i1 %31, label %aws_raise_error.exit, label %32

32:                                               ; preds = %29
  %33 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
  tail call void %30(i32 1, i8* %33) #12
  br label %aws_raise_error.exit

34:                                               ; preds = %19
  %35 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 0
  %36 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %35, align 4, !tbaa !13
...
39:                                               ; preds = %34
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %40 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %41 = icmp eq void (i32, i8*)* %40, null
  br i1 %41, label %44, label %42

42:                                               ; preds = %39
  %43 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %40(i32 1, i8* %43) #12
  br label %aws_raise_error.exit

44:                                               ; preds = %39
  %45 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %46 = icmp eq void (i32, i8*)* %45, null
  br i1 %46, label %aws_raise_error.exit, label %47

47:                                               ; preds = %44
  %48 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
32:                                               ; preds = %28
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %33 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %34 = icmp eq void (i32, i8*)* %33, null
  br i1 %34, label %37, label %35

35:                                               ; preds = %32
  %36 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %33(i32 1, i8* %36) #12
  br label %aws_raise_error.exit

37:                                               ; preds = %32
  %38 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %39 = icmp eq void (i32, i8*)* %38, null
  br i1 %39, label %aws_raise_error.exit, label %40

40:                                               ; preds = %37
  %41 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
45:                                               ; preds = %43
  ...
  %47 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %46, align 4, !tbaa !13
...
50:                                               ; preds = %45
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %51 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %52 = icmp eq void (i32, i8*)* %51, null
  br i1 %52, label %55, label %53

53:                                               ; preds = %50
  %54 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %51(i32 1, i8* %54) #12
  br label %aws_raise_error.exit

55:                                               ; preds = %50
  %56 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %57 = icmp eq void (i32, i8*)* %56, null
  br i1 %57, label %aws_raise_error.exit, label %58

58:                                               ; preds = %55
  %59 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
  tail call void %56(i32 1, i8* %59) #12
  br label %aws_raise_error.exit

60:                                               ; preds = %45
  %61 = load i8*, i8** %1, align 4, !tbaa !12
  ...
  %64 = load i8*, i8** %1, align 4, !tbaa !12
  tail call void @seahorn.fn.enter() #12
  %65 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !18
...
aws_mem_release.exit7:                            ; preds = %68, %70
  store i8* %48, i8** %1, align 4, !tbaa !12
  br label %aws_raise_error.exit
...
19:                                               ; preds = %1
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
  %20 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %21 = icmp eq void (i32, i8*)* %20, null
  br i1 %21, label %24, label %22

22:                                               ; preds = %19
  %23 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  call void %20(i32 1, i8* %23) #12
  br label %aws_raise_error.exit

24:                                               ; preds = %19
  %25 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %26 = icmp eq void (i32, i8*)* %25, null
  br i1 %26, label %aws_raise_error.exit, label %27

27:                                               ; preds = %24
  %28 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
3:                                                ; preds = %1
  ...
  %6 = load volatile %struct.aws_error_info_list*, %struct.aws_error_info_list** %5, align 4, !tbaa !12
  ret void
...
3:                                                ; preds = %1
  ...
  %7 = load volatile %struct.aws_error_info_list*, %struct.aws_error_info_list** %6, align 4, !tbaa !12
...
9:                                                ; preds = %3
  ...
  %11 = load i16, i16* %10, align 4, !tbaa !31
...
14:                                               ; preds = %9
  ...
  %16 = load %struct.aws_error_info*, %struct.aws_error_info** %15, align 4, !tbaa !34
...
define internal fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %0, i8* %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #12
  store void (i32, i8*)* %0, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  store i8* %1, i8** @s_global_error_context, align 4, !tbaa !12
  ret void
}
...
define internal fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %0, i8* %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #12
  store void (i32, i8*)* %0, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  store i8* %1, i8** @tl_thread_handler_context, align 4, !tbaa !12
  ret void
}
...
4:                                                ; preds = %1
  ...
  %6 = load %struct.aws_error_info*, %struct.aws_error_info** %5, align 4, !tbaa !34
...
19:                                               ; preds = %14
  %20 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !12
...
22:                                               ; preds = %14
  ...
  store volatile %struct.aws_error_info_list* %0, %struct.aws_error_info_list** %23, align 4, !tbaa !12
  ret void
}
...
22:                                               ; preds = %14
  %23 = getelementptr inbounds [16 x %struct.aws_error_info_list*], [16 x %struct.aws_error_info_list*]* @ERROR_SLOTS, i32 0, i32 %17
  store volatile %struct.aws_error_info_list* null, %struct.aws_error_info_list** %23, align 4, !tbaa !12
  ret void
}
...
11:                                               ; preds = %LeafBlock15
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %12 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %13 = icmp eq void (i32, i8*)* %12, null
  br i1 %13, label %16, label %14

14:                                               ; preds = %11
  %15 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %12(i32 42, i8* %15) #12
  br label %aws_raise_error.20.exit

16:                                               ; preds = %11
  %17 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %18 = icmp eq void (i32, i8*)* %17, null
  br i1 %18, label %aws_raise_error.20.exit, label %19

19:                                               ; preds = %16
  %20 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
21:                                               ; preds = %LeafBlock, %LeafBlock3
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %22 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %23 = icmp eq void (i32, i8*)* %22, null
  br i1 %23, label %26, label %24

24:                                               ; preds = %21
  %25 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %22(i32 43, i8* %25) #12
  br label %aws_raise_error.20.exit

26:                                               ; preds = %21
  %27 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %28 = icmp eq void (i32, i8*)* %27, null
  br i1 %28, label %aws_raise_error.20.exit, label %29

29:                                               ; preds = %26
  %30 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
31:                                               ; preds = %LeafBlock1, %NodeBlock5, %LeafBlock17
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %32 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %33 = icmp eq void (i32, i8*)* %32, null
  br i1 %33, label %36, label %34

34:                                               ; preds = %31
  %35 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %32(i32 44, i8* %35) #12
  br label %aws_raise_error.20.exit

36:                                               ; preds = %31
  %37 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %38 = icmp eq void (i32, i8*)* %37, null
  br i1 %38, label %aws_raise_error.20.exit, label %39

39:                                               ; preds = %36
  %40 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
41:                                               ; preds = %LeafBlock11
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %42 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %43 = icmp eq void (i32, i8*)* %42, null
  br i1 %43, label %46, label %44

44:                                               ; preds = %41
  %45 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %42(i32 45, i8* %45) #12
  br label %aws_raise_error.20.exit

46:                                               ; preds = %41
  %47 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %48 = icmp eq void (i32, i8*)* %47, null
  br i1 %48, label %aws_raise_error.20.exit, label %49

49:                                               ; preds = %46
  %50 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
51:                                               ; preds = %NodeBlock7
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %52 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %53 = icmp eq void (i32, i8*)* %52, null
  br i1 %53, label %56, label %54

54:                                               ; preds = %51
  %55 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %52(i32 1, i8* %55) #12
  br label %aws_raise_error.20.exit

56:                                               ; preds = %51
  %57 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %58 = icmp eq void (i32, i8*)* %57, null
  br i1 %58, label %aws_raise_error.20.exit, label %59

59:                                               ; preds = %56
  %60 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
61:                                               ; preds = %NodeBlock21
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %62 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %63 = icmp eq void (i32, i8*)* %62, null
  br i1 %63, label %66, label %64

64:                                               ; preds = %61
  %65 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %62(i32 2, i8* %65) #12
  br label %aws_raise_error.20.exit

66:                                               ; preds = %61
  %67 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %68 = icmp eq void (i32, i8*)* %67, null
  br i1 %68, label %aws_raise_error.20.exit, label %69

69:                                               ; preds = %66
  %70 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
NewDefault:                                       ; preds = %LeafBlock, %LeafBlock1, %LeafBlock3, %LeafBlock11, %LeafBlock15, %LeafBlock17
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  %71 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !12
  %72 = icmp eq void (i32, i8*)* %71, null
  br i1 %72, label %75, label %73

73:                                               ; preds = %NewDefault
  %74 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !12
  tail call void %71(i32 46, i8* %74) #12
  br label %aws_raise_error.20.exit

75:                                               ; preds = %NewDefault
  %76 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !12
  %77 = icmp eq void (i32, i8*)* %76, null
  br i1 %77, label %aws_raise_error.20.exit, label %78

78:                                               ; preds = %75
  %79 = load i8*, i8** @s_global_error_context, align 4, !tbaa !12
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_back_harness()
  ...
  %4 = tail call fastcc %struct.aws_linked_list_node* @aws_linked_list_back(%struct.aws_linked_list* %3)
  %5 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_is_valid(%struct.aws_linked_list* %5)
  %6 = tail call %struct.aws_linked_list_node* @verifier.nondet.2()
  tail call fastcc void @aws_linked_list_node_prev_is_valid(%struct.aws_linked_list_node* %6)
  %7 = tail call %struct.aws_linked_list_node* @verifier.nondet.2()
  tail call fastcc void @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* %7)
...
!12 = !{!8, !8, i64 0}
!13 = !{!14, !8, i64 0}
!14 = !{!"aws_allocator", !8, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16}
!15 = !{!14, !8, i64 12}
!16 = !{!17, !17, i64 0}
!17 = !{!"int", !9, i64 0}
!18 = !{!14, !8, i64 4}
!19 = !{!14, !8, i64 8}
!20 = !{!21, !22, i64 0}
!21 = !{!"", !22, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16, !8, i64 20, !8, i64 24, !8, i64 28, !8, i64 32}
!22 = !{!"long", !9, i64 0}
!23 = !{!21, !8, i64 4}
!24 = !{!21, !8, i64 8}
!25 = !{!21, !8, i64 12}
...
!30 = !{!21, !8, i64 32}
!31 = !{!32, !33, i64 4}
!32 = !{!"aws_error_info_list", !8, i64 0, !33, i64 4}
!33 = !{!"short", !9, i64 0}
!34 = !{!32, !8, i64 0}
!35 = !{!36, !17, i64 0}
!36 = !{!"aws_error_info", !17, i64 0, !8, i64 4, !8, i64 8, !8, i64 12, !8, i64 16}
