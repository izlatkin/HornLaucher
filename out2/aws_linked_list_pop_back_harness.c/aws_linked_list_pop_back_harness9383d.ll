; ModuleID = '../out2/aws_linked_list_pop_back_harness.c/aws_linked_list_pop_back_harness9383d.bc.txt'
...
define internal fastcc void @aws_linked_list_pop_back_harness() unnamed_addr #1 {
  ...
  call void @seahorn.fn.enter() #12
  %9 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %8, i32 0, i32 0
  %10 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %9, align 4, !tbaa !12
  %11 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %8, i32 0, i32 1
  %12 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %11, align 4, !tbaa !13
  %13 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %12, i32 0, i32 0
  store %struct.aws_linked_list_node* %10, %struct.aws_linked_list_node** %13, align 4, !tbaa !12
  %14 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %9, align 4, !tbaa !12
  %15 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %14, i32 0, i32 1
  store %struct.aws_linked_list_node* %12, %struct.aws_linked_list_node** %15, align 4, !tbaa !13
  call void @seahorn.fn.enter() #12
  %16 = bitcast %struct.aws_linked_list_node* %8 to i64*
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_pop_back(%struct.aws_linked_list* nocapture readonly %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  tail call void @seahorn.fn.enter() #12
  ...
  %7 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %6, align 4, !tbaa !13
  ...
  %9 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %4, align 4, !tbaa !12
  %10 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %9, i32 0, i32 1
  store %struct.aws_linked_list_node* %7, %struct.aws_linked_list_node** %10, align 4, !tbaa !13
  tail call void @seahorn.fn.enter() #12
...
define internal fastcc void @aws_linked_list_remove(%struct.aws_linked_list_node* %0) unnamed_addr #4 {
  ...
  %3 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %2, align 4, !tbaa !12
  %4 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %0, i32 0, i32 1
  %5 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %4, align 4, !tbaa !13
  %6 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %5, i32 0, i32 0
  store %struct.aws_linked_list_node* %3, %struct.aws_linked_list_node** %6, align 4, !tbaa !12
  %7 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %2, align 4, !tbaa !12
  %8 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %7, i32 0, i32 1
  store %struct.aws_linked_list_node* %5, %struct.aws_linked_list_node** %8, align 4, !tbaa !13
  tail call void @seahorn.fn.enter() #12
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_pop_back_harness()
  ...
  tail call fastcc void @aws_linked_list_pop_back(%struct.aws_linked_list* %3)
  ...
  %6 = tail call fastcc %struct.aws_linked_list_node* @aws_linked_list_back(%struct.aws_linked_list* %5)
