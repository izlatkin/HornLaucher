; ModuleID = '../out2/aws_add_size_checked_harness.c/aws_add_size_checked_harness28824.bc.txt'
...
define internal fastcc void @aws_add_size_checked_harness() unnamed_addr #0 {
...
2:                                                ; preds = %0
  ...
  %5 = tail call i64 bitcast (i64 (...)* @nondet_uint64_t to i64 ()*)() #10
  tail call void @seahorn.fn.enter() #10
  %6 = icmp ne i64 %4, 0
  %7 = sub nuw nsw i64 -1, %4
  %8 = icmp ult i64 %7, %3
  %or.cond.i = and i1 %6, %8
  br i1 %or.cond.i, label %9, label %aws_add_u64_checked.exit

9:                                                ; preds = %2
  tail call void @seahorn.fn.enter() #10
  tail call void @seahorn.fn.enter() #10
  %10 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !5
  %11 = icmp eq void (i32, i8*)* %10, null
  br i1 %11, label %14, label %12

12:                                               ; preds = %9
  %13 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !5
  tail call void %10(i32 5, i8* %13) #10
  br label %aws_add_u64_checked.exit

14:                                               ; preds = %9
  %15 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !5
  %16 = icmp eq void (i32, i8*)* %15, null
  br i1 %16, label %aws_add_u64_checked.exit, label %17

17:                                               ; preds = %14
  %18 = load i8*, i8** @s_global_error_context, align 4, !tbaa !5
  tail call void %15(i32 5, i8* %18) #10
  br label %aws_add_u64_checked.exit

19:                                               ; preds = %0
  %20 = tail call i32 bitcast (i32 (...)* @nondet_uint32_t to i32 ()*)() #10
  %21 = tail call i32 bitcast (i32 (...)* @nondet_uint32_t to i32 ()*)() #10
  %22 = tail call i32 bitcast (i32 (...)* @nondet_uint32_t to i32 ()*)() #10
  tail call void @seahorn.fn.enter() #10
  %23 = icmp ne i32 %21, 0
  %24 = sub nuw nsw i32 -1, %21
  %25 = icmp ult i32 %24, %20
  %or.cond.i1 = and i1 %23, %25
  br i1 %or.cond.i1, label %26, label %aws_add_u64_checked.exit

26:                                               ; preds = %19
  tail call void @seahorn.fn.enter() #10
  tail call void @seahorn.fn.enter() #10
  %27 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !5
  %28 = icmp eq void (i32, i8*)* %27, null
  br i1 %28, label %31, label %29

29:                                               ; preds = %26
  %30 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !5
  tail call void %27(i32 5, i8* %30) #10
  br label %aws_add_u64_checked.exit

31:                                               ; preds = %26
  %32 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !5
  %33 = icmp eq void (i32, i8*)* %32, null
  br i1 %33, label %aws_add_u64_checked.exit, label %34

34:                                               ; preds = %31
  %35 = load i8*, i8** @s_global_error_context, align 4, !tbaa !5
  tail call void %32(i32 5, i8* %35) #10
  br label %aws_add_u64_checked.exit

aws_add_u64_checked.exit:                         ; preds = %34, %31, %29, %19, %17, %14, %12, %2
  ret void
}
...
define internal fastcc void @aws_add_u64_checked(i64 %0, i64 %1, i64* nocapture %2) unnamed_addr #2 {
  tail call void @seahorn.fn.enter() #10
  %4 = icmp ne i64 %1, 0
...
10:                                               ; preds = %7
  ...
  tail call void %8(i32 5, i8* %11) #10
...
15:                                               ; preds = %12
  ...
  tail call void %13(i32 5, i8* %16) #10
  br label %aws_raise_error.exit

17:                                               ; preds = %3
  %18 = add i64 %1, %0
  store i64 %18, i64* %2, align 4, !tbaa !9
  br label %aws_raise_error.exit
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_add_u32_checked(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #2 {
  tail call void @seahorn.fn.enter() #10
  %4 = icmp ne i32 %1, 0
...
9:                                                ; preds = %3
  ...
  %11 = load i16, i16* %10, align 4, !tbaa !13
...
14:                                               ; preds = %9
  ...
  %16 = load %struct.aws_error_info*, %struct.aws_error_info** %15, align 4, !tbaa !16
...
3:                                                ; preds = %1
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1.4, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2, i32 0, i32 0), i32 133) #11
  unreachable

4:                                                ; preds = %1
  %5 = getelementptr inbounds %struct.aws_error_info_list, %struct.aws_error_info_list* %0, i32 0, i32 0
  %6 = load %struct.aws_error_info*, %struct.aws_error_info** %5, align 4, !tbaa !16
...
3:                                                ; preds = %1
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1.4, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2, i32 0, i32 0), i32 167) #11
  unreachable
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_raise_error.5(i32 %0) unnamed_addr #2 {
  tail call void @seahorn.fn.enter() #10
  tail call void @seahorn.fn.enter() #10
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !5
  %3 = icmp eq void (i32, i8*)* %2, null
...
define internal fastcc void @aws_secure_zero(i8* %0, i32 %1) unnamed_addr #0 {
  ...
  tail call void asm sideeffect "", "r,~{memory},~{dirflag},~{fpsr},~{flags}"(i8* %0) #10, !srcloc !19
  ret void
}
...
1:                                                ; preds = %0
  ...
  tail call void @seahorn.fn.enter() #10
  %2 = load %struct.aws_error_info*, %struct.aws_error_info** getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 0), align 8, !tbaa !16
...
5:                                                ; preds = %1
  %6 = load i16, i16* getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 1), align 4, !tbaa !13
  %7 = icmp eq i16 %6, 0
  br i1 %7, label %8, label %9
...
31:                                               ; preds = %.thread1, %30
  ...
  %34 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %33, align 4, !tbaa !20
  %35 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %34, i32 0, i32 1
  %36 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %35, align 4, !tbaa !22
  %37 = tail call i32 %36(%struct.aws_logger* nonnull %32, i32 0) #10
  %38 = icmp ugt i32 %37, 3
  br i1 %38, label %39, label %44

39:                                               ; preds = %31
  %40 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %33, align 4, !tbaa !20
  %41 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %40, i32 0, i32 0
  %42 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %41, align 4, !tbaa !24
...
51:                                               ; preds = %50
  ...
  %53 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %52, align 4, !tbaa !20
  %54 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %53, i32 0, i32 1
  %55 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %54, align 4, !tbaa !22
  %56 = tail call i32 %55(%struct.aws_logger* nonnull %48, i32 0) #10
  %57 = icmp ugt i32 %56, 3
  br i1 %57, label %58, label %76

58:                                               ; preds = %51
  %59 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %52, align 4, !tbaa !20
  %60 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %59, i32 0, i32 0
  %61 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %60, align 4, !tbaa !24
...
64:                                               ; preds = %63
  ...
  %66 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %65, align 4, !tbaa !20
  %67 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %66, i32 0, i32 1
  %68 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %67, align 4, !tbaa !22
  %69 = tail call i32 %68(%struct.aws_logger* nonnull %48, i32 0) #10
  %70 = icmp ugt i32 %69, 3
  br i1 %70, label %71, label %76

71:                                               ; preds = %64
  %72 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %65, align 4, !tbaa !20
  %73 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %72, i32 0, i32 0
  %74 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %73, align 4, !tbaa !24
...
83:                                               ; preds = %82
  ...
  %85 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %84, align 4, !tbaa !20
  %86 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %85, i32 0, i32 1
  %87 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %86, align 4, !tbaa !22
  %88 = tail call i32 %87(%struct.aws_logger* nonnull %80, i32 0) #10
  %89 = icmp ugt i32 %88, 3
  br i1 %89, label %90, label %108

90:                                               ; preds = %83
  %91 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %84, align 4, !tbaa !20
  %92 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %91, i32 0, i32 0
  %93 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %92, align 4, !tbaa !24
...
96:                                               ; preds = %95
  ...
  %98 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %97, align 4, !tbaa !20
  %99 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %98, i32 0, i32 1
  %100 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %99, align 4, !tbaa !22
  %101 = tail call i32 %100(%struct.aws_logger* nonnull %80, i32 0) #10
  %102 = icmp ugt i32 %101, 3
  br i1 %102, label %103, label %108

103:                                              ; preds = %96
  %104 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %97, align 4, !tbaa !20
  %105 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %104, i32 0, i32 0
  %106 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %105, align 4, !tbaa !24
...
115:                                              ; preds = %114
  ...
  %117 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %116, align 4, !tbaa !20
  %118 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %117, i32 0, i32 1
  %119 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %118, align 4, !tbaa !22
  %120 = tail call i32 %119(%struct.aws_logger* nonnull %112, i32 0) #10
  %121 = icmp ugt i32 %120, 3
  br i1 %121, label %122, label %140

122:                                              ; preds = %115
  %123 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %116, align 4, !tbaa !20
  %124 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %123, i32 0, i32 0
  %125 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %124, align 4, !tbaa !24
...
128:                                              ; preds = %127
  ...
  %130 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %129, align 4, !tbaa !20
  %131 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %130, i32 0, i32 1
  %132 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %131, align 4, !tbaa !22
  %133 = tail call i32 %132(%struct.aws_logger* nonnull %112, i32 0) #10
  %134 = icmp ugt i32 %133, 3
  br i1 %134, label %135, label %140

135:                                              ; preds = %128
  %136 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %129, align 4, !tbaa !20
  %137 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %136, i32 0, i32 0
  %138 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %137, align 4, !tbaa !24
...
147:                                              ; preds = %146
  ...
  %149 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %148, align 4, !tbaa !20
  %150 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %149, i32 0, i32 1
  %151 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %150, align 4, !tbaa !22
  %152 = tail call i32 %151(%struct.aws_logger* nonnull %144, i32 0) #10
  %153 = icmp ugt i32 %152, 3
  br i1 %153, label %154, label %172

154:                                              ; preds = %147
  %155 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %148, align 4, !tbaa !20
  %156 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %155, i32 0, i32 0
  %157 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %156, align 4, !tbaa !24
...
160:                                              ; preds = %159
  ...
  %162 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %161, align 4, !tbaa !20
  %163 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %162, i32 0, i32 1
  %164 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %163, align 4, !tbaa !22
  %165 = tail call i32 %164(%struct.aws_logger* nonnull %144, i32 0) #10
  %166 = icmp ugt i32 %165, 3
  br i1 %166, label %167, label %172

167:                                              ; preds = %160
  %168 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %161, align 4, !tbaa !20
  %169 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %168, i32 0, i32 0
  %170 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %169, align 4, !tbaa !24
...
179:                                              ; preds = %178
  ...
  %181 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %180, align 4, !tbaa !20
  %182 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %181, i32 0, i32 1
  %183 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %182, align 4, !tbaa !22
  %184 = tail call i32 %183(%struct.aws_logger* nonnull %176, i32 0) #10
  %185 = icmp ugt i32 %184, 3
  br i1 %185, label %186, label %217

186:                                              ; preds = %179
  %187 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %180, align 4, !tbaa !20
  %188 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %187, i32 0, i32 0
  %189 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %188, align 4, !tbaa !24
...
192:                                              ; preds = %191
  ...
  %194 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %193, align 4, !tbaa !20
  %195 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %194, i32 0, i32 1
  %196 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %195, align 4, !tbaa !22
  %197 = tail call i32 %196(%struct.aws_logger* nonnull %176, i32 0) #10
  %198 = icmp ugt i32 %197, 3
  br i1 %198, label %199, label %217

199:                                              ; preds = %192
  %200 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %193, align 4, !tbaa !20
  %201 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %200, i32 0, i32 0
  %202 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %201, align 4, !tbaa !24
...
205:                                              ; preds = %204
  ...
  %207 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %206, align 4, !tbaa !20
  %208 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %207, i32 0, i32 1
  %209 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %208, align 4, !tbaa !22
  %210 = tail call i32 %209(%struct.aws_logger* nonnull %28, i32 0) #10
  %211 = icmp ugt i32 %210, 3
  br i1 %211, label %212, label %217

212:                                              ; preds = %205
  %213 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %206, align 4, !tbaa !20
  %214 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %213, i32 0, i32 0
  %215 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %214, align 4, !tbaa !24
...
1:                                                ; preds = %0
  ...
  tail call void @seahorn.fn.enter() #10
  %3 = load %struct.aws_error_info*, %struct.aws_error_info** getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 0), align 8, !tbaa !16
...
6:                                                ; preds = %1
  %7 = load i16, i16* getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 1), align 4, !tbaa !13
  %8 = icmp eq i16 %7, 0
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_add_size_checked_harness()
  %1 = tail call i64 @verifier.nondet.1()
  %2 = tail call i64 @verifier.nondet.1()
  %3 = tail call i64* @verifier.nondet.2()
  tail call fastcc void @aws_add_u64_checked(i64 %1, i64 %2, i64* %3)
  %4 = tail call i32 @verifier.nondet.3()
  %5 = tail call i32 @verifier.nondet.3()
  %6 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_add_u32_checked(i32 %4, i32 %5, i32* %6)
  ...
  tail call fastcc void @aws_error_str(i32 %8)
  %9 = tail call i32 @verifier.nondet.3()
  %10 = tail call fastcc %struct.aws_error_info* @get_error_by_code(i32 %9)
  %11 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_name(i32 %11)
  %12 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_lib_name(i32 %12)
  %13 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_debug_str(i32 %13)
  %14 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error_private(i32 %14)
  tail call fastcc void @aws_reset_error()
  %15 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_restore_error(i32 %15)
  %16 = tail call void (i32, i8*)* @verifier.nondet.5()
  %17 = tail call i8* @verifier.nondet.6()
  tail call fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %16, i8* %17)
  %18 = tail call void (i32, i8*)* @verifier.nondet.5()
  %19 = tail call i8* @verifier.nondet.6()
  tail call fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %18, i8* %19)
  %20 = tail call %struct.aws_error_info_list* @verifier.nondet.7()
  tail call fastcc void @aws_register_error_info(%struct.aws_error_info_list* %20)
  %21 = tail call %struct.aws_error_info_list* @verifier.nondet.7()
  tail call fastcc void @aws_unregister_error_info(%struct.aws_error_info_list* %21)
  %22 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_translate_and_raise_io_error(i32 %22)
  %23 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.5(i32 %23)
  %24 = tail call i8* @verifier.nondet.6()
  %25 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_secure_zero(i8* %24, i32 %25)
  %26 = tail call %struct.aws_allocator* @verifier.nondet.8()
...
declare i64* @verifier.nondet.2() local_unnamed_addr

declare i32 @verifier.nondet.3() local_unnamed_addr

declare i32* @verifier.nondet.4() local_unnamed_addr

declare void (i32, i8*)* @verifier.nondet.5() local_unnamed_addr

declare i8* @verifier.nondet.6() local_unnamed_addr

declare %struct.aws_error_info_list* @verifier.nondet.7() local_unnamed_addr

declare %struct.aws_allocator* @verifier.nondet.8() local_unnamed_addr
...
!12 = !{!"int", !7, i64 0}
!13 = !{!14, !15, i64 4}
!14 = !{!"aws_error_info_list", !6, i64 0, !15, i64 4}
!15 = !{!"short", !7, i64 0}
!16 = !{!14, !6, i64 0}
!17 = !{!18, !12, i64 0}
!18 = !{!"aws_error_info", !12, i64 0, !6, i64 4, !6, i64 8, !6, i64 12, !6, i64 16}
!19 = !{i32 1682}
!20 = !{!21, !6, i64 0}
!21 = !{!"aws_logger", !6, i64 0, !6, i64 4, !6, i64 8}
!22 = !{!23, !6, i64 4}
!23 = !{!"aws_logger_vtable", !6, i64 0, !6, i64 4, !6, i64 8, !6, i64 12}
!24 = !{!23, !6, i64 0}
