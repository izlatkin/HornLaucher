; ModuleID = '../out2/aws_linked_list_insert_after_harness.c/aws_linked_list_insert_after_harness09403.bc.txt'
...
define internal fastcc void @aws_linked_list_insert_after_harness() unnamed_addr #1 {
...
define internal fastcc void @aws_linked_list_insert_after(%struct.aws_linked_list_node* %0, %struct.aws_linked_list_node* %1) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #12
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_insert_after_harness()
  %1 = tail call %struct.aws_linked_list_node* @verifier.nondet.1()
  %2 = tail call %struct.aws_linked_list_node* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_insert_after(%struct.aws_linked_list_node* %1, %struct.aws_linked_list_node* %2)
