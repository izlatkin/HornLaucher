; ModuleID = '../out2/aws_hash_table_move_harness.c/aws_hash_table_move_harness9ce29.bc.txt'
...
define internal fastcc void @aws_hash_table_move_harness() unnamed_addr #1 {
  ...
  %5 = bitcast %struct.aws_hash_table* %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %5) #15
  call void @ensure_allocated_hash_table(%struct.aws_hash_table* nonnull %2, i32 -1) #15
  call void @seahorn.fn.enter() #15
  %6 = getelementptr inbounds %struct.aws_hash_table, %struct.aws_hash_table* %2, i32 0, i32 0
  %7 = load %struct.hash_table_state*, %struct.hash_table_state** %6, align 4, !tbaa !5
  %8 = icmp eq %struct.hash_table_state* %7, null
  br i1 %8, label %aws_hash_table_is_valid.exit, label %hash_table_state_is_valid.exit.i

hash_table_state_is_valid.exit.i:                 ; preds = %0
  call void @seahorn.fn.enter() #15
  %9 = getelementptr inbounds %struct.hash_table_state, %struct.hash_table_state* %7, i32 0, i32 0
  %10 = load i64 (i8*)*, i64 (i8*)** %9, align 4, !tbaa !10
  %11 = icmp ne i64 (i8*)* %10, null
  %12 = getelementptr inbounds %struct.hash_table_state, %struct.hash_table_state* %7, i32 0, i32 1
  %13 = load i1 (i8*, i8*)*, i1 (i8*, i8*)** %12, align 4, !tbaa !10
  %14 = icmp ne i1 (i8*, i8*)* %13, null
  %15 = getelementptr inbounds %struct.hash_table_state, %struct.hash_table_state* %7, i32 0, i32 4
  %16 = load %struct.aws_allocator*, %struct.aws_allocator** %15, align 4, !tbaa !10
  %17 = icmp ne %struct.aws_allocator* %16, null
  %18 = getelementptr inbounds %struct.hash_table_state, %struct.hash_table_state* %7, i32 0, i32 5
  %19 = load i32, i32* %18, align 4, !tbaa !11
  %20 = icmp ugt i32 %19, 1
  call void @seahorn.fn.enter() #15
  %21 = call i32 @llvm.ctpop.i32(i32 %19) #15, !range !13
  %22 = icmp eq i32 %21, 1
  %23 = getelementptr inbounds %struct.hash_table_state, %struct.hash_table_state* %7, i32 0, i32 6
  %24 = load i32, i32* %23, align 4, !tbaa !11
  %25 = getelementptr inbounds %struct.hash_table_state, %struct.hash_table_state* %7, i32 0, i32 7
  %26 = load i32, i32* %25, align 4, !tbaa !11
  %27 = icmp ule i32 %24, %26
  %28 = icmp ult i32 %26, %19
  %29 = getelementptr inbounds %struct.hash_table_state, %struct.hash_table_state* %7, i32 0, i32 8
  %30 = load i32, i32* %29, align 4, !tbaa !11
  %31 = add i32 %19, -1
  %32 = icmp eq i32 %30, %31
  %33 = getelementptr inbounds %struct.hash_table_state, %struct.hash_table_state* %7, i32 0, i32 9
  %34 = load double, double* %33, align 4, !tbaa !14
  %35 = fcmp oeq double %34, 0x3FEE666666666666
  %or.cond.i.i = and i1 %11, %14
  %or.cond3.i.i = and i1 %or.cond.i.i, %17
  %or.cond5.i.i = and i1 %or.cond3.i.i, %20
  %or.cond7.i.i = and i1 %or.cond5.i.i, %22
  %or.cond9.i.i = and i1 %or.cond7.i.i, %27
  %or.cond11.i.i = and i1 %28, %or.cond9.i.i
  %or.cond13.i.i = and i1 %32, %or.cond11.i.i
  %or.cond15.i.i = and i1 %35, %or.cond13.i.i
  br label %aws_hash_table_is_valid.exit

aws_hash_table_is_valid.exit:                     ; preds = %0, %hash_table_state_is_valid.exit.i
  %36 = phi i1 [ false, %0 ], [ %or.cond15.i.i, %hash_table_state_is_valid.exit.i ]
  call void @verifier.assume(i1 %36)
  %37 = bitcast %struct.store_byte_from_buffer* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %37) #15
  call void @save_byte_from_hash_table(%struct.aws_hash_table* nonnull %2, %struct.store_byte_from_buffer* nonnull %3) #15
  call void @seahorn.fn.enter() #15, !noalias !16
  %.pmcpy.unpack.i = load %struct.hash_table_state*, %struct.hash_table_state** %6, align 4, !alias.scope !20, !noalias !21
  %38 = getelementptr inbounds %struct.aws_hash_table, %struct.aws_hash_table* %1, i32 0, i32 0
  store %struct.hash_table_state* %.pmcpy.unpack.i, %struct.hash_table_state** %38, align 4, !alias.scope !21, !noalias !20
  %39 = bitcast %struct.aws_hash_table* %2 to i32*
  store i32 0, i32* %39, align 4
  call void @seahorn.fn.enter() #15
  %40 = icmp eq %struct.hash_table_state* %.pmcpy.unpack.i, null
  br i1 %40, label %aws_hash_table_is_valid.exit10, label %hash_table_state_is_valid.exit.i9
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_hash_table_move_harness()
...
!15 = !{!"double", !8, i64 0}
!16 = !{!17, !19}
!17 = distinct !{!17, !18, !"aws_hash_table_move: argument 0"}
!18 = distinct !{!18, !"aws_hash_table_move"}
!19 = distinct !{!19, !18, !"aws_hash_table_move: argument 1"}
!20 = !{!19}
!21 = !{!17}
!22 = !{!23, !7, i64 0}
