; ModuleID = '../out2/aws_linked_list_next_harness.c/aws_linked_list_next_harness73ec7.bc.txt'
...
define internal fastcc void @aws_linked_list_next_harness() unnamed_addr #1 {
...
define internal fastcc %struct.aws_linked_list_node* @aws_linked_list_next(%struct.aws_linked_list_node* nocapture readonly %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #12
...
5:                                                ; preds = %2
  ...
  %7 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %6, align 4, !tbaa !11
...
6:                                                ; preds = %3
  ...
  %8 = load i8* (%struct.aws_allocator*, i32, i32)*, i8* (%struct.aws_allocator*, i32, i32)** %7, align 4, !tbaa !13
...
10:                                               ; preds = %6
  ...
  %12 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %11, align 4, !tbaa !11
...
34:                                               ; preds = %19
  ...
  %36 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %35, align 4, !tbaa !11
...
define internal fastcc void @aws_mul_size_checked(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #3 {
  ...
  tail call void @seahorn.fn.enter() #12
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !14
  ret void
}
...
5:                                                ; preds = %2
  ...
  %7 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %6, align 4, !tbaa !16
...
7:                                                ; preds = %4
  ...
  %9 = load i8* (%struct.aws_allocator*, i8*, i32, i32)*, i8* (%struct.aws_allocator*, i8*, i32, i32)** %8, align 4, !tbaa !17
...
11:                                               ; preds = %7
  ...
  %13 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %12, align 4, !tbaa !11
...
16:                                               ; preds = %11, %7
  ...
  %18 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !16
...
45:                                               ; preds = %43
  ...
  %47 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %46, align 4, !tbaa !11
...
60:                                               ; preds = %45
  ...
  tail call void @seahorn.fn.enter() #12
  %65 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !16
...
define internal fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %0) unnamed_addr #1 {
  ...
  %4 = load i8* (%struct.aws_allocator*, i8*, i32, i32)*, i8* (%struct.aws_allocator*, i8*, i32, i32)** %3, align 4, !tbaa !17
...
7:                                                ; preds = %2
  ...
  %10 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %9, align 4, !tbaa !16
...
9:                                                ; preds = %3
  ...
  %11 = load i16, i16* %10, align 4, !tbaa !29
...
14:                                               ; preds = %9
  ...
  %16 = load %struct.aws_error_info*, %struct.aws_error_info** %15, align 4, !tbaa !32
...
4:                                                ; preds = %1
  ...
  %6 = load %struct.aws_error_info*, %struct.aws_error_info** %5, align 4, !tbaa !32
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_next_harness()
  %1 = tail call %struct.aws_linked_list_node* @verifier.nondet.1()
  %2 = tail call fastcc %struct.aws_linked_list_node* @aws_linked_list_next(%struct.aws_linked_list_node* %1)
  %3 = tail call %struct.aws_linked_list_node* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* %3)
...
!10 = !{!7, !7, i64 0}
!11 = !{!12, !7, i64 0}
!12 = !{!"aws_allocator", !7, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16}
!13 = !{!12, !7, i64 12}
!14 = !{!15, !15, i64 0}
!15 = !{!"int", !8, i64 0}
!16 = !{!12, !7, i64 4}
!17 = !{!12, !7, i64 8}
!18 = !{!19, !20, i64 0}
!19 = !{!"", !20, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16, !7, i64 20, !7, i64 24, !7, i64 28, !7, i64 32}
!20 = !{!"long", !8, i64 0}
!21 = !{!19, !7, i64 4}
!22 = !{!19, !7, i64 8}
!23 = !{!19, !7, i64 12}
...
!28 = !{!19, !7, i64 32}
!29 = !{!30, !31, i64 4}
!30 = !{!"aws_error_info_list", !7, i64 0, !31, i64 4}
!31 = !{!"short", !8, i64 0}
!32 = !{!30, !7, i64 0}
!33 = !{!34, !15, i64 0}
!34 = !{!"aws_error_info", !15, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16}
