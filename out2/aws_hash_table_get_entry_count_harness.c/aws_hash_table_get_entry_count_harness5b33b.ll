; ModuleID = '../out2/aws_hash_table_get_entry_count_harness.c/aws_hash_table_get_entry_count_harness5b33b.bc.txt'
...
define internal fastcc void @aws_hash_table_get_entry_count_harness() unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #15
  %1 = alloca %struct.aws_hash_table, align 4
  %2 = alloca %struct.store_byte_from_buffer, align 4
  %3 = bitcast %struct.aws_hash_table* %1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3) #15
  call void @ensure_allocated_hash_table(%struct.aws_hash_table* nonnull %1, i32 -1) #15
  ...
  br i1 %6, label %aws_hash_table_is_valid.exit, label %hash_table_state_is_valid.exit.i
...
hash_table_state_is_valid.exit.i:                 ; preds = %0
  ...
  call void @seahorn.fn.enter() #15
  %19 = call i32 @llvm.ctpop.i32(i32 %17) #15, !range !13
  %20 = icmp eq i32 %19, 1
  ...
  %or.cond.i.i = and i1 %9, %12
  %or.cond3.i.i = and i1 %or.cond.i.i, %15
  %or.cond5.i.i = and i1 %or.cond3.i.i, %18
  %or.cond7.i.i = and i1 %or.cond5.i.i, %20
  %or.cond9.i.i = and i1 %or.cond7.i.i, %25
  %or.cond11.i.i = and i1 %26, %or.cond9.i.i
  %or.cond13.i.i = and i1 %30, %or.cond11.i.i
  %or.cond15.i.i = and i1 %33, %or.cond13.i.i
  br label %aws_hash_table_is_valid.exit

aws_hash_table_is_valid.exit:                     ; preds = %0, %hash_table_state_is_valid.exit.i
  %34 = phi i1 [ false, %0 ], [ %or.cond15.i.i, %hash_table_state_is_valid.exit.i ]
  call void @verifier.assume(i1 %34)
  %35 = bitcast %struct.store_byte_from_buffer* %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %35) #15
  call void @save_byte_from_hash_table(%struct.aws_hash_table* nonnull %1, %struct.store_byte_from_buffer* nonnull %2) #15
  call void @seahorn.fn.enter() #15
  %36 = load %struct.hash_table_state*, %struct.hash_table_state** %4, align 4, !tbaa !5
  call void @seahorn.fn.enter() #15
  %37 = icmp eq %struct.hash_table_state* %36, null
  br i1 %37, label %aws_hash_table_is_valid.exit10, label %hash_table_state_is_valid.exit.i9
...
aws_hash_table_is_valid.exit10:                   ; preds = %aws_hash_table_is_valid.exit, %hash_table_state_is_valid.exit.i9
  call void @check_hash_table_unchanged(%struct.aws_hash_table* nonnull %1, %struct.store_byte_from_buffer* nonnull %2) #15
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_size_checked.35(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #7 {
  tail call void @seahorn.fn.enter() #15
  tail call void @seahorn.fn.enter() #15
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !19
...
10:                                               ; preds = %7
  %11 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !10
  tail call void %8(i32 5, i8* %11) #15
  br label %aws_raise_error.36.exit

12:                                               ; preds = %7
  %13 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !10
  %14 = icmp eq void (i32, i8*)* %13, null
  br i1 %14, label %aws_raise_error.36.exit, label %15
...
aws_raise_error.36.exit:                          ; preds = %15, %12, %10, %17
  %.0 = phi i32 [ 0, %17 ], [ -1, %10 ], [ -1, %12 ], [ -1, %15 ]
  ret i32 %.0
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_raise_error.36(i32 %0) unnamed_addr #7 {
  tail call void @seahorn.fn.enter() #15
  tail call void @seahorn.fn.enter() #15
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !10
  %3 = icmp eq void (i32, i8*)* %2, null
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_u32_checked.37(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #7 {
  tail call void @seahorn.fn.enter() #15
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !19
  ret void
...
aws_raise_error.36.exit:                          ; preds = %15, %12, %10, %17, %4
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_hash_table_get_entry_count_harness()
  ...
  tail call fastcc void @aws_mul_size_checked.35(i32 %95, i32 %96, i32* %97)
  ...
  tail call fastcc void @aws_raise_error.36(i32 %106)
  %107 = tail call i32 @verifier.nondet.2()
  %108 = tail call i32 @verifier.nondet.2()
  %109 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked.37(i32 %107, i32 %108, i32* %109)
