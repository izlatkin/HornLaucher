; ModuleID = '../out2/aws_ring_buffer_release_harness.c/aws_ring_buffer_release_harnessabe96.bc.txt'
...
@.str.1.25 = private unnamed_addr constant [11 x i8] c"list->data\00", align 1
@.str.2.26 = private unnamed_addr constant [52 x i8] c"/tmp/aws-c-common/include/aws/common/array_list.inl\00", align 1
@.str.3.27 = private unnamed_addr constant [28 x i8] c"!list->length || list->data\00", align 1
...
@s_null_terminator_cursor = internal global %struct.aws_byte_cursor { i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4.28, i32 0, i32 0) }, align 8
@.str.4.28 = private unnamed_addr constant [2 x i8] zeroinitializer, align 1
@.str.34 = private unnamed_addr constant [84 x i8] c"!\22ring_buffer_allocator does not support realloc, as it breaks allocation ordering\22\00", align 1
@.str.1.35 = private unnamed_addr constant [39 x i8] c"/tmp/aws-c-common/source/ring_buffer.c\00", align 1
...
define internal fastcc zeroext i1 @is_empty_state(%struct.aws_ring_buffer* %0) unnamed_addr #1 {
...
define internal fastcc i8* @aws_atomic_load_ptr(%struct.aws_atomic_var* %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i8* @aws_atomic_load_ptr_explicit(%struct.aws_atomic_var* %0, i32 %1) unnamed_addr #3 {
NodeBlock:
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_atomic_priv_xlate_order(i32 %0) unnamed_addr #3 {
NodeBlock7:
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: nounwind ssp uwtable
define internal fastcc zeroext i1 @is_front_valid_state(%struct.aws_ring_buffer* %0) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #18
  %2 = getelementptr inbounds %struct.aws_ring_buffer, %struct.aws_ring_buffer* %0, i32 0, i32 2
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: nounwind ssp uwtable
define internal fastcc zeroext i1 @is_middle_valid_state(%struct.aws_ring_buffer* %0) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #18
  %2 = getelementptr inbounds %struct.aws_ring_buffer, %struct.aws_ring_buffer* %0, i32 0, i32 2
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: nounwind ssp uwtable
define internal fastcc zeroext i1 @is_ends_valid_state(%struct.aws_ring_buffer* %0) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #18
  %2 = getelementptr inbounds %struct.aws_ring_buffer, %struct.aws_ring_buffer* %0, i32 0, i32 2
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: nounwind ssp uwtable
define internal fastcc void @aws_ring_buffer_release_harness() unnamed_addr #1 {
  %1 = tail call i32 @verifier.nondet.25() #18
  tail call void @seahorn.fn.enter() #18
  %2 = alloca %struct.aws_byte_buf, align 8
  %3 = alloca %struct.aws_ring_buffer, align 8
  %.sroa.6 = alloca i32, align 8
  %.sroa.11 = alloca i32, align 4
  %4 = bitcast %struct.aws_byte_buf* %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %4) #18
  %5 = bitcast %struct.aws_ring_buffer* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %5) #18
  call void @ensure_ring_buffer_has_allocated_members(%struct.aws_ring_buffer* nonnull %3, i32 %1) #18
  call void @seahorn.fn.enter() #18
  %6 = getelementptr inbounds %struct.aws_ring_buffer, %struct.aws_ring_buffer* %3, i32 0, i32 2
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %7 = bitcast %struct.aws_atomic_var* %6 to i32*
  %8 = load atomic volatile i32, i32* %7 seq_cst, align 8
  %9 = inttoptr i32 %8 to i8*
  %10 = getelementptr inbounds %struct.aws_ring_buffer, %struct.aws_ring_buffer* %3, i32 0, i32 3
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %11 = bitcast %struct.aws_atomic_var* %10 to i32*
  %12 = load atomic volatile i32, i32* %11 seq_cst, align 4
  %13 = inttoptr i32 %12 to i8*
  %14 = icmp ne i8* %9, %13
  call void @verifier.assume(i1 %14)
  %15 = call fastcc zeroext i1 @aws_ring_buffer_is_valid(%struct.aws_ring_buffer* nonnull %3)
  call void @verifier.assume(i1 %15)
  call void @ensure_byte_buf_has_allocated_buffer_member_in_ring_buf(%struct.aws_byte_buf* nonnull %2, %struct.aws_ring_buffer* nonnull %3) #18
  call void @seahorn.fn.enter() #18
  %16 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %2, i32 0, i32 2
  %17 = load i32, i32* %16, align 8, !tbaa !11
  %18 = icmp eq i32 %17, 0
  %19 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %2, i32 0, i32 0
...
23:                                               ; preds = %21
  %24 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %2, i32 0, i32 1
  %25 = load i8*, i8** %24, align 4, !tbaa !15
  %26 = icmp eq i8* %25, null
  br i1 %26, label %aws_byte_buf_is_valid.exit, label %.thread.i

.thread.i:                                        ; preds = %23, %21
  br label %aws_byte_buf_is_valid.exit

27:                                               ; preds = %0
  %28 = icmp ugt i32 %20, %17
  br i1 %28, label %aws_byte_buf_is_valid.exit, label %29

29:                                               ; preds = %27
  %30 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %2, i32 0, i32 1
  %31 = load i8*, i8** %30, align 4, !tbaa !15
  %32 = icmp ne i8* %31, null
  br label %aws_byte_buf_is_valid.exit

aws_byte_buf_is_valid.exit:                       ; preds = %23, %.thread.i, %27, %29
  %33 = phi i1 [ true, %23 ], [ false, %27 ], [ %32, %29 ], [ false, %.thread.i ]
  call void @verifier.assume(i1 %33)
  %.sroa.6.0.sroa_cast15 = bitcast i32* %.sroa.6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %.sroa.6.0.sroa_cast15)
  %.sroa.11.0.sroa_cast13 = bitcast i32* %.sroa.11 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %.sroa.11.0.sroa_cast13)
  %.pmcpy.elt2 = getelementptr inbounds %struct.aws_ring_buffer, %struct.aws_ring_buffer* %3, i32 0, i32 1
  %.pmcpy.unpack3 = load i8*, i8** %.pmcpy.elt2, align 4
  %34 = getelementptr inbounds %struct.aws_ring_buffer, %struct.aws_ring_buffer* %3, i32 0, i32 2, i32 0
  %.pmcpy.unpack5.unpack = load i8*, i8** %34, align 8
  %35 = getelementptr inbounds %struct.aws_ring_buffer, %struct.aws_ring_buffer* %3, i32 0, i32 3, i32 0
  %.pmcpy.unpack7.unpack = load i8*, i8** %35, align 4
  %36 = ptrtoint i8* %.pmcpy.unpack5.unpack to i32
  store i32 %36, i32* %.sroa.6, align 8
  %37 = ptrtoint i8* %.pmcpy.unpack7.unpack to i32
  store i32 %37, i32* %.sroa.11, align 4
  call void @seahorn.fn.enter() #18
  %38 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %2, i32 0, i32 1
  %39 = load i8*, i8** %38, align 4, !tbaa !15
  %40 = getelementptr inbounds i8, i8* %39, i32 %17
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %41 = ptrtoint i8* %40 to i32
  store atomic volatile i32 %41, i32* %11 release, align 4
  call void @llvm.memset.p0i8.i32(i8* nonnull align 8 dereferenceable(16) %4, i8 0, i32 16, i1 false) #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %.sroa.6.0..sroa.6.8. = load atomic volatile i32, i32* %.sroa.6 seq_cst, align 8
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %.sroa.11.0..sroa.11.12. = load atomic volatile i32, i32* %.sroa.11 seq_cst, align 4
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %42 = load atomic volatile i32, i32* %7 seq_cst, align 8
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %43 = load atomic volatile i32, i32* %11 seq_cst, align 4
  %44 = call fastcc zeroext i1 @aws_ring_buffer_is_valid(%struct.aws_ring_buffer* nonnull %3)
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %.sroa.6.0..sroa.6.8.5 = load atomic volatile i32, i32* %.sroa.6 seq_cst, align 8
  %45 = inttoptr i32 %.sroa.6.0..sroa.6.8.5 to i8*
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %.sroa.11.0..sroa.11.12.9 = load atomic volatile i32, i32* %.sroa.11 seq_cst, align 4
  %46 = inttoptr i32 %.sroa.11.0..sroa.11.12.9 to i8*
  %47 = icmp eq i8* %.pmcpy.unpack3, %46
  %48 = icmp ult i8* %46, %45
  %49 = and i1 %47, %48
  br i1 %49, label %50, label %59

50:                                               ; preds = %aws_byte_buf_is_valid.exit
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %51 = load atomic volatile i32, i32* %7 seq_cst, align 8
  %52 = inttoptr i32 %51 to i8*
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %53 = load atomic volatile i32, i32* %11 seq_cst, align 4
...
56:                                               ; preds = %50
  ...
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %57 = load atomic volatile i32, i32* %7 seq_cst, align 8
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %58 = load atomic volatile i32, i32* %11 seq_cst, align 4
  br label %59

59:                                               ; preds = %56, %50, %aws_byte_buf_is_valid.exit
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %.sroa.6.0..sroa.6.8.6 = load atomic volatile i32, i32* %.sroa.6 seq_cst, align 8
  %60 = inttoptr i32 %.sroa.6.0..sroa.6.8.6 to i8*
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %.sroa.11.0..sroa.11.12.10 = load atomic volatile i32, i32* %.sroa.11 seq_cst, align 4
  %61 = inttoptr i32 %.sroa.11.0..sroa.11.12.10 to i8*
  %62 = icmp ult i8* %.pmcpy.unpack3, %61
  %63 = icmp ult i8* %61, %60
  %64 = and i1 %62, %63
...
65:                                               ; preds = %59
  ...
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %66 = load atomic volatile i32, i32* %7 seq_cst, align 8
  %67 = inttoptr i32 %66 to i8*
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %68 = load atomic volatile i32, i32* %11 seq_cst, align 4
...
71:                                               ; preds = %65
  ...
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %72 = load atomic volatile i32, i32* %7 seq_cst, align 8
  %73 = inttoptr i32 %72 to i8*
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %74 = load atomic volatile i32, i32* %11 seq_cst, align 4
  %75 = inttoptr i32 %74 to i8*
  %76 = load i8*, i8** %.pmcpy.elt2, align 4, !tbaa !5
  %77 = icmp ult i8* %76, %75
  %78 = icmp ult i8* %75, %73
  %79 = and i1 %77, %78
...
80:                                               ; preds = %71
  ...
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %81 = load atomic volatile i32, i32* %7 seq_cst, align 8
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %82 = load atomic volatile i32, i32* %11 seq_cst, align 4
  br label %83

83:                                               ; preds = %80, %71, %65, %59
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %.sroa.6.0..sroa.6.8.7 = load atomic volatile i32, i32* %.sroa.6 seq_cst, align 8
  %84 = inttoptr i32 %.sroa.6.0..sroa.6.8.7 to i8*
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %.sroa.11.0..sroa.11.12.11 = load atomic volatile i32, i32* %.sroa.11 seq_cst, align 4
  %85 = inttoptr i32 %.sroa.11.0..sroa.11.12.11 to i8*
...
87:                                               ; preds = %83
  ...
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %88 = load atomic volatile i32, i32* %7 seq_cst, align 8
  %89 = inttoptr i32 %88 to i8*
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %90 = load atomic volatile i32, i32* %11 seq_cst, align 4
...
93:                                               ; preds = %87
  ...
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %94 = load atomic volatile i32, i32* %7 seq_cst, align 8
  %95 = inttoptr i32 %94 to i8*
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %96 = load atomic volatile i32, i32* %11 seq_cst, align 4
  %97 = inttoptr i32 %96 to i8*
  %98 = load i8*, i8** %.pmcpy.elt2, align 4, !tbaa !5
  %99 = icmp ult i8* %98, %97
  %100 = icmp ult i8* %97, %95
  %101 = and i1 %99, %100
...
102:                                              ; preds = %93
  ...
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %103 = load atomic volatile i32, i32* %7 seq_cst, align 8
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  call void @seahorn.fn.enter() #18
  %104 = load atomic volatile i32, i32* %11 seq_cst, align 4
  br label %105

105:                                              ; preds = %102, %93, %87, %83
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %.sroa.6.0.sroa_cast15)
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %.sroa.11.0.sroa_cast13)
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %5) #18
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %4) #18
  ret void
}

declare void @ensure_ring_buffer_has_allocated_members(%struct.aws_ring_buffer*, i32) local_unnamed_addr #5

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc zeroext i1 @aws_ring_buffer_is_empty(%struct.aws_ring_buffer* %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  %2 = getelementptr inbounds %struct.aws_ring_buffer, %struct.aws_ring_buffer* %0, i32 0, i32 2
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc zeroext i1 @aws_ring_buffer_is_valid(%struct.aws_ring_buffer* %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  %2 = getelementptr inbounds %struct.aws_ring_buffer, %struct.aws_ring_buffer* %0, i32 0, i32 2
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
15:                                               ; preds = %11
  ...
  %17 = load i8*, i8** %16, align 4, !tbaa !16
  %18 = icmp uge i8* %17, %5
...
22:                                               ; preds = %aws_ring_buffer_check_atomic_ptr.exit
  ...
  %24 = load i8*, i8** %23, align 4, !tbaa !16
  %25 = icmp uge i8* %24, %9
...
30:                                               ; preds = %aws_ring_buffer_check_atomic_ptr.exit._crit_edge
  ...
  %32 = load %struct.aws_allocator*, %struct.aws_allocator** %31, align 4, !tbaa !17
...
declare void @ensure_byte_buf_has_allocated_buffer_member_in_ring_buf(%struct.aws_byte_buf*, %struct.aws_ring_buffer*) local_unnamed_addr #5

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc zeroext i1 @aws_ring_buffer_check_atomic_ptr(%struct.aws_ring_buffer* nocapture readonly %0, i8* readnone %1) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  %3 = icmp eq i8* %1, null
...
define internal i8* @s_default_malloc(%struct.aws_allocator* nocapture readnone %0, i32 %1) #1 {
  ...
  store i8* null, i8** %3, align 4, !tbaa !18
...
11:                                               ; preds = %9
  ...
  store i8* null, i8** %5, align 4, !tbaa !18
...
define internal i8* @s_default_calloc(%struct.aws_allocator* nocapture readnone %0, i32 %1, i32 %2) #1 {
  ...
  store i8* null, i8** %4, align 4, !tbaa !18
...
4:                                                ; preds = %2
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 115) #20
  unreachable

5:                                                ; preds = %2
  %6 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 0
  %7 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %6, align 4, !tbaa !19
  %8 = icmp eq i8* (%struct.aws_allocator*, i32)* %7, null
  br i1 %8, label %9, label %10

9:                                                ; preds = %5
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 116) #20
  unreachable
...
12:                                               ; preds = %10
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 118) #20
  unreachable
...
16:                                               ; preds = %13
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %17 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %18 = icmp eq void (i32, i8*)* %17, null
  br i1 %18, label %21, label %19

19:                                               ; preds = %16
  %20 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %17(i32 1, i8* %20) #18
  br label %aws_raise_error.exit

21:                                               ; preds = %16
  %22 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %23 = icmp eq void (i32, i8*)* %22, null
  br i1 %23, label %aws_raise_error.exit, label %24

24:                                               ; preds = %21
  %25 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
define internal fastcc void @aws_raise_error(i32 %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 %0, i32* @tl_last_error, align 4, !tbaa !21
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %3 = icmp eq void (i32, i8*)* %2, null
  br i1 %3, label %6, label %4

4:                                                ; preds = %1
  %5 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %2(i32 %0, i8* %5) #18
  br label %aws_raise_error_private.exit

6:                                                ; preds = %1
  %7 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %8 = icmp eq void (i32, i8*)* %7, null
  br i1 %8, label %aws_raise_error_private.exit, label %9

9:                                                ; preds = %6
  %10 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
5:                                                ; preds = %3
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 128) #20
  unreachable

6:                                                ; preds = %3
  %7 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 3
  %8 = load i8* (%struct.aws_allocator*, i32, i32)*, i8* (%struct.aws_allocator*, i32, i32)** %7, align 4, !tbaa !23
...
10:                                               ; preds = %6
  ...
  %12 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %11, align 4, !tbaa !19
  %13 = icmp eq i8* (%struct.aws_allocator*, i32)* %12, null
  br i1 %13, label %14, label %15

14:                                               ; preds = %10
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 129) #20
  unreachable
...
18:                                               ; preds = %15
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 131) #20
  unreachable
...
24:                                               ; preds = %21
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %25 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %26 = icmp eq void (i32, i8*)* %25, null
  br i1 %26, label %29, label %27

27:                                               ; preds = %24
  %28 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %25(i32 1, i8* %28) #18
  br label %aws_raise_error.exit

29:                                               ; preds = %24
  %30 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %31 = icmp eq void (i32, i8*)* %30, null
  br i1 %31, label %aws_raise_error.exit, label %32

32:                                               ; preds = %29
  %33 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
  tail call void %30(i32 1, i8* %33) #18
  br label %aws_raise_error.exit

34:                                               ; preds = %19
  %35 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 0
  %36 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %35, align 4, !tbaa !19
...
39:                                               ; preds = %34
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %40 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %41 = icmp eq void (i32, i8*)* %40, null
  br i1 %41, label %44, label %42

42:                                               ; preds = %39
  %43 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %40(i32 1, i8* %43) #18
  br label %aws_raise_error.exit

44:                                               ; preds = %39
  %45 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %46 = icmp eq void (i32, i8*)* %45, null
  br i1 %46, label %aws_raise_error.exit, label %47

47:                                               ; preds = %44
  %48 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
4:                                                ; preds = %2
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 215) #20
  unreachable
...
9:                                                ; preds = %5
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 216) #20
  unreachable
...
6:                                                ; preds = %4
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 224) #20
  unreachable
...
11:                                               ; preds = %7
  ...
  %13 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %12, align 4, !tbaa !19
  %14 = icmp eq i8* (%struct.aws_allocator*, i32)* %13, null
  br i1 %14, label %15, label %16

15:                                               ; preds = %11
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 225) #20
  unreachable
...
20:                                               ; preds = %16
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.2, i32 0, i32 0), i32 226) #20
  unreachable
...
23:                                               ; preds = %21
  %24 = load i8*, i8** %1, align 4, !tbaa !18
  tail call void @seahorn.fn.enter() #18
...
aws_mem_release.exit:                             ; preds = %23, %26
  store i8* null, i8** %1, align 4, !tbaa !18
  br label %aws_raise_error.exit
...
28:                                               ; preds = %27
  %29 = load i8*, i8** %1, align 4, !tbaa !18
...
32:                                               ; preds = %28
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %33 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %34 = icmp eq void (i32, i8*)* %33, null
  br i1 %34, label %37, label %35

35:                                               ; preds = %32
  %36 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %33(i32 1, i8* %36) #18
  br label %aws_raise_error.exit

37:                                               ; preds = %32
  %38 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %39 = icmp eq void (i32, i8*)* %38, null
  br i1 %39, label %aws_raise_error.exit, label %40

40:                                               ; preds = %37
  %41 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
  tail call void %38(i32 1, i8* %41) #18
  br label %aws_raise_error.exit

42:                                               ; preds = %28
  store i8* %30, i8** %1, align 4, !tbaa !18
  br label %aws_raise_error.exit
...
45:                                               ; preds = %43
  ...
  %47 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %46, align 4, !tbaa !19
...
50:                                               ; preds = %45
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %51 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %52 = icmp eq void (i32, i8*)* %51, null
  br i1 %52, label %55, label %53

53:                                               ; preds = %50
  %54 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %51(i32 1, i8* %54) #18
  br label %aws_raise_error.exit

55:                                               ; preds = %50
  %56 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %57 = icmp eq void (i32, i8*)* %56, null
  br i1 %57, label %aws_raise_error.exit, label %58

58:                                               ; preds = %55
  %59 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
  tail call void %56(i32 1, i8* %59) #18
  br label %aws_raise_error.exit

60:                                               ; preds = %45
  %61 = load i8*, i8** %1, align 4, !tbaa !18
  ...
  %64 = load i8*, i8** %1, align 4, !tbaa !18
  tail call void @seahorn.fn.enter() #18
...
aws_mem_release.exit7:                            ; preds = %68, %70
  store i8* %48, i8** %1, align 4, !tbaa !18
  br label %aws_raise_error.exit
...
19:                                               ; preds = %1
  ...
  call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %20 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %21 = icmp eq void (i32, i8*)* %20, null
  br i1 %21, label %24, label %22

22:                                               ; preds = %19
  %23 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  call void %20(i32 1, i8* %23) #18
  br label %aws_raise_error.exit

24:                                               ; preds = %19
  %25 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %26 = icmp eq void (i32, i8*)* %25, null
  br i1 %26, label %aws_raise_error.exit, label %27

27:                                               ; preds = %24
  %28 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
define internal i8* @s_cf_allocator_reallocate(i8* %0, i32 %1, i32 %2, i8* %3) #1 {
  ...
  store i8* %8, i8** %5, align 4, !tbaa !18
...
13:                                               ; preds = %4
  %14 = load i8*, i8** %5, align 4, !tbaa !18
...
define internal fastcc i32 @aws_last_error() unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #18
  %1 = load i32, i32* @tl_last_error, align 4, !tbaa !21
  ret i32 %1
}
...
3:                                                ; preds = %1
  ...
  %6 = load volatile %struct.aws_error_info_list*, %struct.aws_error_info_list** %5, align 4, !tbaa !18
  ret void
...
3:                                                ; preds = %1
  ...
  %7 = load volatile %struct.aws_error_info_list*, %struct.aws_error_info_list** %6, align 4, !tbaa !18
...
define internal fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %0, i8* %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #18
  store void (i32, i8*)* %0, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  store i8* %1, i8** @s_global_error_context, align 4, !tbaa !18
  ret void
}
...
define internal fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %0, i8* %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #18
  store void (i32, i8*)* %0, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  store i8* %1, i8** @tl_thread_handler_context, align 4, !tbaa !18
  ret void
}
...
3:                                                ; preds = %1
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1.13, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.14, i32 0, i32 0), i32 133) #20
  unreachable
...
8:                                                ; preds = %4
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3.15, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.14, i32 0, i32 0), i32 134) #20
  unreachable
...
13:                                               ; preds = %9
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4.16, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.14, i32 0, i32 0), i32 135) #20
  unreachable
...
19:                                               ; preds = %14
  %20 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !18
  ...
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6.18, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.14, i32 0, i32 0), i32 144) #20
  unreachable

22:                                               ; preds = %14
  %23 = getelementptr inbounds [16 x %struct.aws_error_info_list*], [16 x %struct.aws_error_info_list*]* @ERROR_SLOTS, i32 0, i32 %17
  store volatile %struct.aws_error_info_list* %0, %struct.aws_error_info_list** %23, align 4, !tbaa !18
  ret void
}
...
3:                                                ; preds = %1
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1.13, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.14, i32 0, i32 0), i32 167) #20
  unreachable
...
8:                                                ; preds = %4
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3.15, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.14, i32 0, i32 0), i32 168) #20
  unreachable
...
13:                                               ; preds = %9
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4.16, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.14, i32 0, i32 0), i32 169) #20
  unreachable
...
19:                                               ; preds = %14
  %20 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !18
  %21 = tail call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %20, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5.17, i32 0, i32 0), i32 %17) #18
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7.19, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.14, i32 0, i32 0), i32 178) #20
  unreachable

22:                                               ; preds = %14
  %23 = getelementptr inbounds [16 x %struct.aws_error_info_list*], [16 x %struct.aws_error_info_list*]* @ERROR_SLOTS, i32 0, i32 %17
  store volatile %struct.aws_error_info_list* null, %struct.aws_error_info_list** %23, align 4, !tbaa !18
  ret void
}
...
1:                                                ; preds = %NodeBlock13
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 34, i32* @tl_last_error, align 4, !tbaa !21
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %3 = icmp eq void (i32, i8*)* %2, null
  br i1 %3, label %6, label %4
...
11:                                               ; preds = %LeafBlock15
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 42, i32* @tl_last_error, align 4, !tbaa !21
  %12 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %13 = icmp eq void (i32, i8*)* %12, null
  br i1 %13, label %16, label %14

14:                                               ; preds = %11
  %15 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %12(i32 42, i8* %15) #18
  br label %aws_raise_error.20.exit

16:                                               ; preds = %11
  %17 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %18 = icmp eq void (i32, i8*)* %17, null
  br i1 %18, label %aws_raise_error.20.exit, label %19

19:                                               ; preds = %16
  %20 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
21:                                               ; preds = %LeafBlock, %LeafBlock3
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 43, i32* @tl_last_error, align 4, !tbaa !21
  %22 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %23 = icmp eq void (i32, i8*)* %22, null
  br i1 %23, label %26, label %24

24:                                               ; preds = %21
  %25 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %22(i32 43, i8* %25) #18
  br label %aws_raise_error.20.exit

26:                                               ; preds = %21
  %27 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %28 = icmp eq void (i32, i8*)* %27, null
  br i1 %28, label %aws_raise_error.20.exit, label %29

29:                                               ; preds = %26
  %30 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
31:                                               ; preds = %LeafBlock1, %NodeBlock5, %LeafBlock17
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 44, i32* @tl_last_error, align 4, !tbaa !21
  %32 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %33 = icmp eq void (i32, i8*)* %32, null
  br i1 %33, label %36, label %34

34:                                               ; preds = %31
  %35 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %32(i32 44, i8* %35) #18
  br label %aws_raise_error.20.exit

36:                                               ; preds = %31
  %37 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %38 = icmp eq void (i32, i8*)* %37, null
  br i1 %38, label %aws_raise_error.20.exit, label %39

39:                                               ; preds = %36
  %40 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
41:                                               ; preds = %LeafBlock11
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 45, i32* @tl_last_error, align 4, !tbaa !21
  %42 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %43 = icmp eq void (i32, i8*)* %42, null
  br i1 %43, label %46, label %44

44:                                               ; preds = %41
  %45 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %42(i32 45, i8* %45) #18
  br label %aws_raise_error.20.exit

46:                                               ; preds = %41
  %47 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %48 = icmp eq void (i32, i8*)* %47, null
  br i1 %48, label %aws_raise_error.20.exit, label %49

49:                                               ; preds = %46
  %50 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
51:                                               ; preds = %NodeBlock7
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %52 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %53 = icmp eq void (i32, i8*)* %52, null
  br i1 %53, label %56, label %54

54:                                               ; preds = %51
  %55 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %52(i32 1, i8* %55) #18
  br label %aws_raise_error.20.exit

56:                                               ; preds = %51
  %57 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %58 = icmp eq void (i32, i8*)* %57, null
  br i1 %58, label %aws_raise_error.20.exit, label %59

59:                                               ; preds = %56
  %60 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
61:                                               ; preds = %NodeBlock21
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 2, i32* @tl_last_error, align 4, !tbaa !21
  %62 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %63 = icmp eq void (i32, i8*)* %62, null
  br i1 %63, label %66, label %64

64:                                               ; preds = %61
  %65 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %62(i32 2, i8* %65) #18
  br label %aws_raise_error.20.exit

66:                                               ; preds = %61
  %67 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %68 = icmp eq void (i32, i8*)* %67, null
  br i1 %68, label %aws_raise_error.20.exit, label %69

69:                                               ; preds = %66
  %70 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
NewDefault:                                       ; preds = %LeafBlock, %LeafBlock1, %LeafBlock3, %LeafBlock11, %LeafBlock15, %LeafBlock17
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 46, i32* @tl_last_error, align 4, !tbaa !21
  %71 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %72 = icmp eq void (i32, i8*)* %71, null
  br i1 %72, label %75, label %73

73:                                               ; preds = %NewDefault
  %74 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %71(i32 46, i8* %74) #18
  br label %aws_raise_error.20.exit

75:                                               ; preds = %NewDefault
  %76 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %77 = icmp eq void (i32, i8*)* %76, null
  br i1 %77, label %aws_raise_error.20.exit, label %78

78:                                               ; preds = %75
  %79 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
6:                                                ; preds = %3
  ...
  store i8* %7, i8** %8, align 4, !tbaa !15
  %9 = icmp eq i8* %7, null
...
13:                                               ; preds = %11
  ...
  %15 = load i8*, i8** %14, align 4, !tbaa !15
...
26:                                               ; preds = %aws_byte_buf_is_valid.exit.thread
  %27 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %28 = icmp eq void (i32, i8*)* %27, null
  br i1 %28, label %aws_raise_error.23.exit, label %29
...
34:                                               ; preds = %aws_byte_buf_is_valid.exit
  ...
  store i8* %37, i8** %.repack8, align 4, !tbaa !15
  %38 = icmp eq i8* %37, null
...
41:                                               ; preds = %34
  ...
  %43 = load i8*, i8** %42, align 4, !tbaa !15
  %44 = load i32, i32* %9, align 4, !tbaa !14
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 %37, i8* align 1 %43, i32 %44, i1 false) #18
  br label %aws_raise_error.23.exit

aws_raise_error.23.exit:                          ; preds = %29, %26, %24, %41, %39, %31
  ret void
}
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_raise_error.23(i32 %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 %0, i32* @tl_last_error, align 4, !tbaa !21
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
...
define internal fastcc void @aws_byte_buf_secure_zero(%struct.aws_byte_buf* nocapture %0) unnamed_addr #1 {
  ...
  %3 = load i8*, i8** %2, align 4, !tbaa !15
  %4 = icmp eq i8* %3, null
...
9:                                                ; preds = %5
  ...
  %11 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %10, align 4, !tbaa !24
...
12:                                               ; preds = %aws_byte_buf_secure_zero.exit
  %13 = load i8*, i8** %2, align 4, !tbaa !15
  %14 = icmp eq i8* %13, null
...
15:                                               ; preds = %12
  ...
  %17 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %16, align 4, !tbaa !24
...
.thread8:                                         ; preds = %4
  ...
  store i8* null, i8** %7, align 4, !tbaa !15
  %8 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
  store i32 0, i32* %8, align 4, !tbaa !14
...
12:                                               ; preds = %aws_byte_cursor_is_valid.exit
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 34, i32* @tl_last_error, align 4, !tbaa !21
  %13 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %14 = icmp eq void (i32, i8*)* %13, null
  br i1 %14, label %17, label %15

15:                                               ; preds = %12
  %16 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %13(i32 34, i8* %16) #18
  br label %aws_raise_error.23.exit

17:                                               ; preds = %12
  %18 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %19 = icmp eq void (i32, i8*)* %18, null
  br i1 %19, label %aws_raise_error.23.exit, label %20

20:                                               ; preds = %17
  %21 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
22:                                               ; preds = %aws_byte_cursor_is_valid.exit
  ...
  store i8* %24, i8** %25, align 4, !tbaa !15
  %26 = icmp eq i8* %24, null
  br i1 %26, label %aws_raise_error.23.exit, label %27

27:                                               ; preds = %22
  %28 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
  store i32 %2, i32* %28, align 4, !tbaa !14
...
aws_raise_error.23.exit:                          ; preds = %.thread8, %20, %17, %15, %22, %27
  ret void
}
...
7:                                                ; preds = %3
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 5, i32* @tl_last_error, align 4, !tbaa !21
  %8 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %9 = icmp eq void (i32, i8*)* %8, null
  br i1 %9, label %12, label %10

10:                                               ; preds = %7
  %11 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %8(i32 5, i8* %11) #18
  br label %aws_add_u32_checked.exit

12:                                               ; preds = %7
  %13 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %14 = icmp eq void (i32, i8*)* %13, null
  br i1 %14, label %aws_add_u32_checked.exit, label %15

15:                                               ; preds = %12
  %16 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
  tail call void %13(i32 5, i8* %16) #18
  br label %aws_add_u32_checked.exit

17:                                               ; preds = %3
  %18 = add i32 %1, %0
  store i32 %18, i32* %2, align 4, !tbaa !21
  br label %aws_add_u32_checked.exit
...
11:                                               ; preds = %2
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 26, i32* @tl_last_error, align 4, !tbaa !21
  %12 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %13 = icmp eq void (i32, i8*)* %12, null
  br i1 %13, label %16, label %14
...
aws_byte_buf_append.exit:                         ; preds = %23, %21
  ...
  %35 = load i8*, i8** %34, align 4, !tbaa !15
  %36 = sub i32 %33, %32
...
aws_raise_error.23.exit:                          ; preds = %19, %16, %14, %23, %21
...
11:                                               ; preds = %10
  store i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.24, i32 0, i32 0), i8** %4, align 4, !tbaa !45
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_array_list_push_back(%struct.aws_array_list* noalias %0, i8* %1) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
...
10:                                               ; preds = %6
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3.27, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.2.26, i32 0, i32 0), i32 312) #20, !noalias !52
  unreachable
...
13:                                               ; preds = %aws_array_list_length.exit
  tail call void @seahorn.fn.enter() #18
  %14 = load i32, i32* @tl_last_error, align 4, !tbaa !21
  %15 = icmp eq i32 %14, 10
  br i1 %15, label %16, label %aws_raise_error.23.exit
...
16:                                               ; preds = %13
  ...
  br i1 %19, label %20, label %aws_raise_error.23.exit

20:                                               ; preds = %16
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 27, i32* @tl_last_error, align 4, !tbaa !21
  %21 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %22 = icmp eq void (i32, i8*)* %21, null
  br i1 %22, label %25, label %23

23:                                               ; preds = %20
  %24 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %21(i32 27, i8* %24) #18
  br label %aws_raise_error.23.exit

25:                                               ; preds = %20
  %26 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %27 = icmp eq void (i32, i8*)* %26, null
  br i1 %27, label %aws_raise_error.23.exit, label %28

28:                                               ; preds = %25
  %29 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
  tail call void %26(i32 27, i8* %29) #18
  br label %aws_raise_error.23.exit

aws_raise_error.23.exit:                          ; preds = %28, %25, %23, %16, %13, %aws_array_list_length.exit
...
9:                                                ; preds = %5
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3.27, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.2.26, i32 0, i32 0), i32 312) #20
  unreachable
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_array_list_set_at(%struct.aws_array_list* noalias %0, i8* %1, i32 %2) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
...
10:                                               ; preds = %6
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1.25, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.2.26, i32 0, i32 0), i32 359) #20
  unreachable
...
22:                                               ; preds = %19
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.3.27, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.2.26, i32 0, i32 0), i32 312) #20, !noalias !60
  unreachable
...
26:                                               ; preds = %24
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 5, i32* @tl_last_error, align 4, !tbaa !21
  %27 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %28 = icmp eq void (i32, i8*)* %27, null
  br i1 %28, label %31, label %29

29:                                               ; preds = %26
  %30 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %27(i32 5, i8* %30) #18
  br label %aws_add_size_checked.exit.thread

31:                                               ; preds = %26
  %32 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %33 = icmp eq void (i32, i8*)* %32, null
  br i1 %33, label %aws_add_size_checked.exit.thread, label %34

34:                                               ; preds = %31
  %35 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
  tail call void %32(i32 5, i8* %35) #18
  br label %aws_add_size_checked.exit.thread

aws_add_size_checked.exit:                        ; preds = %24
  %36 = add nuw i32 %2, 1
  store i32 %36, i32* %16, align 4, !tbaa !21
  br label %aws_add_size_checked.exit.thread
...
declare i32 @aws_array_list_ensure_capacity(%struct.aws_array_list*, i32) local_unnamed_addr #5
...
10:                                               ; preds = %3
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 48, i32* @tl_last_error, align 4, !tbaa !21
  %11 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %12 = icmp eq void (i32, i8*)* %11, null
  br i1 %12, label %15, label %13

13:                                               ; preds = %10
  %14 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %11(i32 48, i8* %14) #18
  br label %aws_raise_error.23.exit

15:                                               ; preds = %10
  %16 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %17 = icmp eq void (i32, i8*)* %16, null
  br i1 %17, label %aws_raise_error.23.exit, label %18

18:                                               ; preds = %15
  %19 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
22:                                               ; preds = %20
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 4, i32* @tl_last_error, align 4, !tbaa !21
  %23 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %24 = icmp eq void (i32, i8*)* %23, null
  br i1 %24, label %27, label %25

25:                                               ; preds = %22
  %26 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %23(i32 4, i8* %26) #18
  br label %aws_raise_error.23.exit

27:                                               ; preds = %22
  %28 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %29 = icmp eq void (i32, i8*)* %28, null
  br i1 %29, label %aws_raise_error.23.exit, label %30

30:                                               ; preds = %27
  %31 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
._crit_edge42:                                    ; preds = %40, %.lr.ph
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 48, i32* @tl_last_error, align 4, !tbaa !21
  %43 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %44 = icmp eq void (i32, i8*)* %43, null
  br i1 %44, label %47, label %45

45:                                               ; preds = %._crit_edge42
  %46 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %43(i32 48, i8* %46) #18
  br label %aws_raise_error.23.exit

47:                                               ; preds = %._crit_edge42
  %48 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %49 = icmp eq void (i32, i8*)* %48, null
  br i1 %49, label %aws_raise_error.23.exit, label %50

50:                                               ; preds = %47
  %51 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
66:                                               ; preds = %.critedge
  %67 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %68 = icmp eq void (i32, i8*)* %67, null
  br i1 %68, label %aws_raise_error.23.exit, label %69
...
._crit_edge:                                      ; preds = %.critedge1, %32
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 48, i32* @tl_last_error, align 4, !tbaa !21
  %80 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %81 = icmp eq void (i32, i8*)* %80, null
  br i1 %81, label %84, label %82

82:                                               ; preds = %._crit_edge
  %83 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %80(i32 48, i8* %83) #18
  br label %aws_raise_error.23.exit

84:                                               ; preds = %._crit_edge
  %85 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %86 = icmp eq void (i32, i8*)* %85, null
  br i1 %86, label %aws_raise_error.23.exit, label %87

87:                                               ; preds = %84
  %88 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
  tail call void %85(i32 48, i8* %88) #18
  br label %aws_raise_error.23.exit

aws_raise_error.23.exit:                          ; preds = %74, %45, %47, %50, %64, %66, %69, %82, %84, %87, %30, %27, %25, %18, %15, %13
  ret void
}
...
.lr.ph:                                           ; preds = %.preheader
  ...
  %16 = load i8*, i8** %15, align 4, !tbaa !15
  br label %42
...
17:                                               ; preds = %3
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 26, i32* @tl_last_error, align 4, !tbaa !21
  %18 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %19 = icmp eq void (i32, i8*)* %18, null
  br i1 %19, label %22, label %20

20:                                               ; preds = %17
  %21 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %18(i32 26, i8* %21) #18
  br label %aws_raise_error.23.exit

22:                                               ; preds = %17
  %23 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %24 = icmp eq void (i32, i8*)* %23, null
  br i1 %24, label %aws_raise_error.23.exit, label %25

25:                                               ; preds = %22
  %26 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
30:                                               ; preds = %._crit_edge
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 5, i32* @tl_last_error, align 4, !tbaa !21
  %31 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %32 = icmp eq void (i32, i8*)* %31, null
  br i1 %32, label %35, label %33

33:                                               ; preds = %30
  %34 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %31(i32 5, i8* %34) #18
  br label %aws_raise_error.23.exit

35:                                               ; preds = %30
  %36 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %37 = icmp eq void (i32, i8*)* %36, null
  br i1 %37, label %aws_raise_error.23.exit, label %38

38:                                               ; preds = %35
  %39 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
  tail call void %36(i32 5, i8* %39) #18
  br label %aws_raise_error.23.exit

40:                                               ; preds = %._crit_edge
  %41 = add i32 %10, %7
  store i32 %41, i32* %6, align 4, !tbaa !21
  br label %aws_raise_error.23.exit
...
aws_raise_error.23.exit:                          ; preds = %40, %38, %35, %33, %25, %22, %20
  ret void
}
...
37:                                               ; preds = %32
  %38 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %39 = icmp eq void (i32, i8*)* %38, null
  br i1 %39, label %aws_raise_error.23.exit, label %40
...
49:                                               ; preds = %42
  br i1 %46, label %50, label %aws_raise_error.23.exit
...
54:                                               ; preds = %50, %42
  ...
  %55 = load i32, i32* %20, align 4, !tbaa !14
  %56 = icmp eq i32 %55, 0
...
63:                                               ; preds = %60
  %64 = load i32, i32* %20, align 4, !tbaa !14
...
69:                                               ; preds = %68
  ...
  %72 = load i32, i32* %18, align 4, !tbaa !11
  tail call void @seahorn.fn.enter() #18
...
.critedge6:                                       ; preds = %69, %68
  ...
  %75 = load i8*, i8** %74, align 4, !tbaa !15
  tail call void @seahorn.fn.enter() #18
...
78:                                               ; preds = %.critedge6
  ...
  %80 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %79, align 4, !tbaa !24
...
aws_mem_release.exit:                             ; preds = %83, %85
  store i8* %.01, i8** %74, align 4, !tbaa !15
  store i32 %.13, i32* %18, align 4, !tbaa !11
  br label %94
...
88:                                               ; preds = %86
  ...
  %90 = load i8*, i8** %89, align 4, !tbaa !15
...
94:                                               ; preds = %88, %86, %aws_mem_release.exit
  ...
  %96 = load i32, i32* %20, align 4, !tbaa !14
  %97 = add i32 %96, %95
  store i32 %97, i32* %20, align 4, !tbaa !14
  br label %aws_raise_error.23.exit

aws_raise_error.23.exit:                          ; preds = %40, %37, %35, %49, %50, %15, %12, %10, %94
  ret void
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_add_size_saturating(i32 %0, i32 %1) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  %3 = icmp ne i32 %1, 0
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_add_u32_saturating(i32 %0, i32 %1) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  %3 = icmp ne i32 %1, 0
  %4 = sub nuw nsw i32 -1, %1
  %5 = icmp ult i32 %4, %0
...
6:                                                ; preds = %2
  tail call void @seahorn.fn.enter() #18
  store i32 34, i32* @tl_last_error, align 4, !tbaa !21
  %7 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %8 = icmp eq void (i32, i8*)* %7, null
  br i1 %8, label %11, label %9

9:                                                ; preds = %6
  %10 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %7(i32 34, i8* %10) #18
  br label %aws_raise_error.23.exit

11:                                               ; preds = %6
  %12 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %13 = icmp eq void (i32, i8*)* %12, null
  br i1 %13, label %aws_raise_error.23.exit, label %14

14:                                               ; preds = %11
  %15 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
aws_byte_buf_is_valid.exit.thread4:               ; preds = %aws_byte_buf_is_valid.exit, %24
  ...
  br i1 %42, label %43, label %aws_raise_error.23.exit
...
43:                                               ; preds = %aws_byte_buf_is_valid.exit.thread4
  ...
  %46 = icmp eq i32 %45, 0
  br i1 %46, label %47, label %aws_raise_error.23.exit

47:                                               ; preds = %43
  store i32 %1, i32* %17, align 4, !tbaa !11
  br label %aws_raise_error.23.exit

aws_raise_error.23.exit:                          ; preds = %40, %37, %35, %14, %11, %9, %47, %43, %aws_byte_buf_is_valid.exit.thread4
...
45:                                               ; preds = %aws_byte_buf_is_valid.exit.thread3
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 5, i32* @tl_last_error, align 4, !tbaa !21
  %46 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %47 = icmp eq void (i32, i8*)* %46, null
  br i1 %47, label %50, label %48

48:                                               ; preds = %45
  %49 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %46(i32 5, i8* %49) #18
  br label %aws_raise_error.23.exit

50:                                               ; preds = %45
  %51 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %52 = icmp eq void (i32, i8*)* %51, null
  br i1 %52, label %aws_raise_error.23.exit, label %53

53:                                               ; preds = %50
  %54 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
aws_raise_error.23.exit:                          ; preds = %53, %50, %48, %55, %40, %37, %35, %14, %11, %9
  ret void
}
...
define internal fastcc void @aws_byte_buf_from_array(%struct.aws_byte_buf* noalias nocapture align 4 %0, i8* %1, i32 %2) unnamed_addr #1 {
  ...
  %6 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 1
  store i8* %5, i8** %6, align 4, !tbaa !15
  %7 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
...
32:                                               ; preds = %2, %31
  ...
  store i32 %6, i32* %33, align 4, !tbaa !14
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc zeroext i16 @aws_ntoh16(i16 zeroext %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc zeroext i16 @_OSSwapInt16(i16 zeroext %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
...
aws_ntoh32.exit:                                  ; preds = %aws_byte_cursor_advance_nospec.exit.i
  ...
  store i32 %27, i32* %1, align 4, !tbaa !21
  br label %aws_byte_cursor_read.exit.thread
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_ntoh32(i32 %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @_OSSwapInt32(i32 %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
...
aws_ntoh32.exit:                                  ; preds = %aws_byte_cursor_advance_nospec.exit.i
  ...
  store i32 %26, i32* %1, align 4, !tbaa !21
  br label %aws_byte_cursor_read.exit.thread
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc float @aws_ntohf32(float %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc float @aws_htonf32(float %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  %2 = bitcast float %0 to i32
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_is_big_endian() unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  ret void
}
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc double @aws_ntohf64(double %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc double @aws_htonf64(double %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  %2 = bitcast double %0 to i64
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i64 @aws_ntoh64(i64 %0) unnamed_addr #3 {
aws_hton64.exit:
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i64 @aws_hton64(i64 %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  %2 = lshr i64 %0, 32
...
10:                                               ; preds = %3
  ...
  %18 = add i32 %7, %2
  store i32 %18, i32* %6, align 4, !tbaa !14
  store i32 0, i32* %.repack, align 4, !tbaa !14
  br label %21
...
15:                                               ; preds = %10
  ...
  store i32 %11, i32* %6, align 4, !tbaa !14
  br label %19
...
5:                                                ; preds = %3
  %6 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
  %7 = load i32, i32* %6, align 4, !tbaa !14, !alias.scope !141, !noalias !142
  %8 = icmp slt i32 %7, 0
  %9 = icmp slt i32 %1, 0
  %or.cond.i = or i1 %9, %8
...
10:                                               ; preds = %5
  %11 = add nuw i32 %7, %1
  %12 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 2
  %13 = load i32, i32* %12, align 4, !tbaa !11, !alias.scope !141, !noalias !142
  %14 = icmp ugt i32 %11, %13
  br i1 %14, label %aws_byte_buf_write.exit, label %15

15:                                               ; preds = %10
  %16 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 1
  %17 = load i8*, i8** %16, align 4, !tbaa !15, !alias.scope !141, !noalias !142
  %18 = getelementptr inbounds i8, i8* %17, i32 %7
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 1 %18, i8* align 1 %2, i32 %1, i1 false) #18
  store i32 %11, i32* %6, align 4, !tbaa !14, !alias.scope !141, !noalias !142
...
5:                                                ; preds = %3
  %6 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
  %7 = load i32, i32* %6, align 4, !tbaa !14, !alias.scope !147, !noalias !148
  %8 = icmp slt i32 %7, 0
  %9 = icmp slt i32 %1, 0
  %or.cond.i = or i1 %9, %8
  br i1 %or.cond.i, label %aws_byte_buf_write.exit, label %10
...
10:                                               ; preds = %5
  %11 = add nuw i32 %7, %1
  %12 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 2
  %13 = load i32, i32* %12, align 4, !tbaa !11, !alias.scope !147, !noalias !148
  %14 = icmp ugt i32 %11, %13
  br i1 %14, label %aws_byte_buf_write.exit, label %15

15:                                               ; preds = %10
  %16 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 1
  %17 = load i8*, i8** %16, align 4, !tbaa !15, !alias.scope !147, !noalias !148
  %18 = getelementptr inbounds i8, i8* %17, i32 %7
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 1 %18, i8* align 1 %2, i32 %1, i1 false) #18
  store i32 %11, i32* %6, align 4, !tbaa !14, !alias.scope !147, !noalias !148
  br label %aws_byte_buf_write.exit
...
25:                                               ; preds = %22
  ...
  %27 = load i8*, i8** %26, align 4, !tbaa !15, !alias.scope !156, !noalias !157
  ...
  store i32 %23, i32* %5, align 4, !tbaa !14, !alias.scope !156, !noalias !157
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_min_size(i32 %0, i32 %1) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  %3 = icmp ult i32 %0, %1
...
define internal fastcc void @aws_byte_buf_write_u8(%struct.aws_byte_buf* noalias nocapture %0, i8 zeroext %1) unnamed_addr #1 {
  ...
  %4 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
  %5 = load i32, i32* %4, align 4, !tbaa !14, !alias.scope !162, !noalias !163
  %6 = icmp slt i32 %5, 0
  br i1 %6, label %aws_byte_buf_write.exit, label %7

7:                                                ; preds = %2
  %8 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 2
  %9 = load i32, i32* %8, align 4, !tbaa !11, !alias.scope !162, !noalias !163
  %10 = icmp ult i32 %5, %9
...
11:                                               ; preds = %7
  ...
  %14 = load i8*, i8** %13, align 4, !tbaa !15, !alias.scope !162, !noalias !163
  %15 = getelementptr inbounds i8, i8* %14, i32 %5
  %16 = load i8, i8* %3, align 1
  store i8 %16, i8* %15, align 1
  store i32 %12, i32* %4, align 4, !tbaa !14, !alias.scope !162, !noalias !163
  br label %aws_byte_buf_write.exit
...
aws_hton16.exit:
  ...
  %4 = load i32, i32* %3, align 4, !tbaa !14, !alias.scope !168, !noalias !169
  %5 = icmp slt i32 %4, 0
...
6:                                                ; preds = %aws_hton16.exit
  %7 = add nuw i32 %4, 2
  %8 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 2
  %9 = load i32, i32* %8, align 4, !tbaa !11, !alias.scope !168, !noalias !169
  %10 = icmp ugt i32 %7, %9
  br i1 %10, label %aws_byte_buf_write.exit, label %11

11:                                               ; preds = %6
  %12 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 1
  %13 = load i8*, i8** %12, align 4, !tbaa !15, !alias.scope !168, !noalias !169
  %14 = getelementptr inbounds i8, i8* %13, i32 %4
  %15 = bitcast i8* %14 to i16*
  %16 = load i16, i16* %2, align 2
  store i16 %16, i16* %15, align 1
  store i32 %7, i32* %3, align 4, !tbaa !14, !alias.scope !168, !noalias !169
  br label %aws_byte_buf_write.exit
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc zeroext i16 @aws_hton16(i16 zeroext %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  %rev.i = tail call i16 @llvm.bswap.i16(i16 %0) #18
  ret i16 %rev.i
...
aws_hton32.exit:                                  ; preds = %2
  ...
  %8 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
  %9 = load i32, i32* %8, align 4, !tbaa !14, !alias.scope !174, !noalias !175
  %10 = icmp slt i32 %9, 0
  br i1 %10, label %aws_byte_buf_write.exit, label %11
...
11:                                               ; preds = %aws_hton32.exit
  ...
  %14 = load i32, i32* %13, align 4, !tbaa !11, !alias.scope !174, !noalias !175
...
16:                                               ; preds = %11
  ...
  %18 = load i8*, i8** %17, align 4, !tbaa !15, !alias.scope !174, !noalias !175
  ...
  store i32 %12, i32* %8, align 4, !tbaa !14, !alias.scope !174, !noalias !175
  br label %aws_byte_buf_write.exit
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_hton32(i32 %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  %2 = tail call i32 @llvm.bswap.i32(i32 %0) #18
  ret i32 %2
...
aws_hton32.exit:
  ...
  %4 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
  %5 = load i32, i32* %4, align 4, !tbaa !14, !alias.scope !180, !noalias !181
  %6 = icmp slt i32 %5, 0
  br i1 %6, label %aws_byte_buf_write.exit, label %7
...
7:                                                ; preds = %aws_hton32.exit
  %8 = add nuw i32 %5, 4
  %9 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 2
  %10 = load i32, i32* %9, align 4, !tbaa !11, !alias.scope !180, !noalias !181
  %11 = icmp ugt i32 %8, %10
  br i1 %11, label %aws_byte_buf_write.exit, label %12

12:                                               ; preds = %7
  %13 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 1
  %14 = load i8*, i8** %13, align 4, !tbaa !15, !alias.scope !180, !noalias !181
  %15 = getelementptr inbounds i8, i8* %14, i32 %5
  %16 = bitcast i8* %15 to i32*
  %17 = load i32, i32* %2, align 4
  store i32 %17, i32* %16, align 1
  store i32 %8, i32* %4, align 4, !tbaa !14, !alias.scope !180, !noalias !181
  br label %aws_byte_buf_write.exit
...
define internal fastcc void @aws_byte_buf_write_float_be32(%struct.aws_byte_buf* nocapture %0, float %1) unnamed_addr #1 {
  ...
  %6 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
  %7 = load i32, i32* %6, align 4, !tbaa !14, !alias.scope !186, !noalias !187
  %8 = icmp slt i32 %7, 0
...
9:                                                ; preds = %2
  ...
  %12 = load i32, i32* %11, align 4, !tbaa !11, !alias.scope !186, !noalias !187
  %13 = icmp ugt i32 %10, %12
  br i1 %13, label %aws_byte_buf_write.exit, label %14

14:                                               ; preds = %9
  %15 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 1
  %16 = load i8*, i8** %15, align 4, !tbaa !15, !alias.scope !186, !noalias !187
  %17 = getelementptr inbounds i8, i8* %16, i32 %7
  %18 = bitcast float* %3 to i32*
  %19 = bitcast i8* %17 to i32*
  %20 = load i32, i32* %18, align 4
  store i32 %20, i32* %19, align 1
  store i32 %10, i32* %6, align 4, !tbaa !14, !alias.scope !186, !noalias !187
  br label %aws_byte_buf_write.exit
...
aws_hton64.exit:
  ...
  %12 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
  %13 = load i32, i32* %12, align 4, !tbaa !14, !alias.scope !192, !noalias !193
...
15:                                               ; preds = %aws_hton64.exit
  %16 = add nuw i32 %13, 8
  %17 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 2
  %18 = load i32, i32* %17, align 4, !tbaa !11, !alias.scope !192, !noalias !193
...
20:                                               ; preds = %15
  ...
  %22 = load i8*, i8** %21, align 4, !tbaa !15, !alias.scope !192, !noalias !193
  %23 = getelementptr inbounds i8, i8* %22, i32 %13
  %24 = bitcast i8* %23 to i64*
  %25 = load i64, i64* %2, align 8
  store i64 %25, i64* %24, align 1
  store i32 %16, i32* %12, align 4, !tbaa !14, !alias.scope !192, !noalias !193
  br label %aws_byte_buf_write.exit
...
define internal fastcc void @aws_byte_buf_write_float_be64(%struct.aws_byte_buf* nocapture %0, double %1) unnamed_addr #1 {
  ...
  %6 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 0
  %7 = load i32, i32* %6, align 4, !tbaa !14, !alias.scope !198, !noalias !199
  %8 = icmp slt i32 %7, 0
  br i1 %8, label %aws_byte_buf_write.exit, label %9
...
9:                                                ; preds = %2
  %10 = add nuw i32 %7, 8
  %11 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 2
  %12 = load i32, i32* %11, align 4, !tbaa !11, !alias.scope !198, !noalias !199
  %13 = icmp ugt i32 %10, %12
  br i1 %13, label %aws_byte_buf_write.exit, label %14

14:                                               ; preds = %9
  %15 = getelementptr inbounds %struct.aws_byte_buf, %struct.aws_byte_buf* %0, i32 0, i32 1
  %16 = load i8*, i8** %15, align 4, !tbaa !15, !alias.scope !198, !noalias !199
  %17 = getelementptr inbounds i8, i8* %16, i32 %7
  %18 = bitcast double* %3 to i64*
  %19 = bitcast i8* %17 to i64*
  %20 = load i64, i64* %18, align 8
  store i64 %20, i64* %19, align 1
  store i32 %10, i32* %6, align 4, !tbaa !14, !alias.scope !198, !noalias !199
  br label %aws_byte_buf_write.exit
...
8:                                                ; preds = %3
  ...
  store %struct.aws_allocator* %1, %struct.aws_allocator** %9, align 4, !tbaa !17
  tail call void @seahorn.fn.enter() #18
  ...
  store i8* %12, i8** %13, align 4, !tbaa !16
  br label %14
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_atomic_init_ptr(%struct.aws_atomic_var* %0, i8* %1) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
...
5:                                                ; preds = %1
  ...
  %7 = load %struct.aws_allocator*, %struct.aws_allocator** %6, align 4, !tbaa !17
  tail call void @seahorn.fn.enter() #18
...
10:                                               ; preds = %5
  ...
  %12 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %11, align 4, !tbaa !24
...
5:                                                ; preds = %3
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 34, i32* @tl_last_error, align 4, !tbaa !21
  %6 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %7 = icmp eq void (i32, i8*)* %6, null
  br i1 %7, label %10, label %8

8:                                                ; preds = %5
  %9 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %6(i32 34, i8* %9) #18
  br label %aws_raise_error.29.exit

10:                                               ; preds = %5
  %11 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %12 = icmp eq void (i32, i8*)* %11, null
  br i1 %12, label %aws_raise_error.29.exit, label %13

13:                                               ; preds = %10
  %14 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
38:                                               ; preds = %35
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %39 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %40 = icmp eq void (i32, i8*)* %39, null
  br i1 %40, label %43, label %41

41:                                               ; preds = %38
  %42 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %39(i32 1, i8* %42) #18
  br label %aws_raise_error.29.exit

43:                                               ; preds = %38
  %44 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %45 = icmp eq void (i32, i8*)* %44, null
  br i1 %45, label %aws_raise_error.29.exit, label %46

46:                                               ; preds = %43
  %47 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
83:                                               ; preds = %74, %63, %57
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %84 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %85 = icmp eq void (i32, i8*)* %84, null
  br i1 %85, label %88, label %86

86:                                               ; preds = %83
  %87 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %84(i32 1, i8* %87) #18
  br label %aws_raise_error.29.exit

88:                                               ; preds = %83
  %89 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %90 = icmp eq void (i32, i8*)* %89, null
  br i1 %90, label %aws_raise_error.29.exit, label %91

91:                                               ; preds = %88
  %92 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_raise_error.29(i32 %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  store i32 %0, i32* @tl_last_error, align 4, !tbaa !21
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i8* @aws_atomic_load_ptr_explicit.30(%struct.aws_atomic_var* %0, i32 %1) unnamed_addr #3 {
NodeBlock:
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
  %Pivot8.i = icmp slt i32 %1, 3
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_atomic_store_ptr_explicit(%struct.aws_atomic_var* %0, i8* %1, i32 %2) unnamed_addr #3 {
NodeBlock:
  tail call void @seahorn.fn.enter() #18
  tail call void @seahorn.fn.enter() #18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_atomic_priv_xlate_order.31(i32 %0) unnamed_addr #3 {
NodeBlock7:
  tail call void @seahorn.fn.enter() #18
  %Pivot8 = icmp slt i32 %0, 3
  br i1 %Pivot8, label %NodeBlock2, label %NodeBlock5
...
9:                                                ; preds = %4
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 34, i32* @tl_last_error, align 4, !tbaa !21
  %10 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %11 = icmp eq void (i32, i8*)* %10, null
  br i1 %11, label %14, label %12

12:                                               ; preds = %9
  %13 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %10(i32 34, i8* %13) #18
  br label %aws_raise_error.29.exit

14:                                               ; preds = %9
  %15 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %16 = icmp eq void (i32, i8*)* %15, null
  br i1 %16, label %aws_raise_error.29.exit, label %17

17:                                               ; preds = %14
  %18 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
29:                                               ; preds = %19
  ...
  %31 = load i8*, i8** %30, align 4, !tbaa !16
  %32 = icmp eq i8* %31, null
...
44:                                               ; preds = %39
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %45 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %46 = icmp eq void (i32, i8*)* %45, null
  br i1 %46, label %49, label %47

47:                                               ; preds = %44
  %48 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %45(i32 1, i8* %48) #18
  br label %aws_raise_error.29.exit

49:                                               ; preds = %44
  %50 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %51 = icmp eq void (i32, i8*)* %50, null
  br i1 %51, label %aws_raise_error.29.exit, label %52

52:                                               ; preds = %49
  %53 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
105:                                              ; preds = %98, %75, %65
  ...
  tail call void @seahorn.fn.enter() #18
  store i32 1, i32* @tl_last_error, align 4, !tbaa !21
  %106 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !18
  %107 = icmp eq void (i32, i8*)* %106, null
  br i1 %107, label %110, label %108

108:                                              ; preds = %105
  %109 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !18
  tail call void %106(i32 1, i8* %109) #18
  br label %aws_raise_error.29.exit

110:                                              ; preds = %105
  %111 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !18
  %112 = icmp eq void (i32, i8*)* %111, null
  br i1 %112, label %aws_raise_error.29.exit, label %113

113:                                              ; preds = %110
  %114 = load i8*, i8** @s_global_error_context, align 4, !tbaa !18
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @s_buf_belongs_to_pool(%struct.aws_ring_buffer* nocapture readnone %0, %struct.aws_byte_buf* nocapture readnone %1) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #18
  ret void
}
...
15:                                               ; preds = %2
  ...
  store i8* (%struct.aws_allocator*, i32)* @s_ring_buffer_mem_acquire, i8* (%struct.aws_allocator*, i32)** %18, align 4, !tbaa !19
  %19 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 1
  store void (%struct.aws_allocator*, i8*)* @s_ring_buffer_mem_release, void (%struct.aws_allocator*, i8*)** %19, align 4, !tbaa !24
  %20 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 3
  store i8* (%struct.aws_allocator*, i32, i32)* @s_ring_buffer_mem_calloc, i8* (%struct.aws_allocator*, i32, i32)** %20, align 4, !tbaa !23
  %21 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 2
  store i8* (%struct.aws_allocator*, i8*, i32, i32)* @s_ring_buffer_mem_realloc, i8* (%struct.aws_allocator*, i8*, i32, i32)** %21, align 4, !tbaa !25
  br label %aws_raise_error.29.exit
...
define internal noalias nonnull i8* @s_ring_buffer_mem_realloc(%struct.aws_allocator* nocapture readnone %0, i8* nocapture readnone %1, i32 %2, i32 %3) #13 {
  tail call void @seahorn.fn.enter() #18
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str.34, i32 0, i32 0), i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.1.35, i32 0, i32 0), i32 304) #20
  unreachable
}
...
define i32 @main() local_unnamed_addr #14 {
  ...
  store i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4.28, i32 0, i32 0), i8** getelementptr inbounds (%struct.aws_byte_cursor, %struct.aws_byte_cursor* @s_null_terminator_cursor, i32 0, i32 1), align 4
  ...
  %2 = tail call fastcc i1 @is_empty_state(%struct.aws_ring_buffer* %1)
  ...
  %11 = tail call fastcc i1 @is_front_valid_state(%struct.aws_ring_buffer* %10)
  %12 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %13 = tail call fastcc i1 @is_middle_valid_state(%struct.aws_ring_buffer* %12)
  %14 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %15 = tail call fastcc i1 @is_ends_valid_state(%struct.aws_ring_buffer* %14)
  tail call fastcc void @aws_ring_buffer_release_harness()
  %16 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %17 = tail call fastcc i1 @aws_ring_buffer_is_empty(%struct.aws_ring_buffer* %16)
  %18 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %19 = tail call fastcc i1 @aws_ring_buffer_is_valid(%struct.aws_ring_buffer* %18)
  %20 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %21 = tail call i8* @verifier.nondet.4()
  %22 = tail call fastcc i1 @aws_ring_buffer_check_atomic_ptr(%struct.aws_ring_buffer* %20, i8* %21)
  %23 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_allocator_is_valid(%struct.aws_allocator* %23)
  ...
  %26 = tail call i8* @s_default_malloc(%struct.aws_allocator* %24, i32 %25)
  %27 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %28 = tail call i8* @verifier.nondet.4()
  tail call void @s_default_free(%struct.aws_allocator* %27, i8* %28)
  %29 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %30 = tail call i8* @verifier.nondet.4()
  %31 = tail call i32 @verifier.nondet.3()
  %32 = tail call i32 @verifier.nondet.3()
  %33 = tail call i8* @s_default_realloc(%struct.aws_allocator* %29, i8* %30, i32 %31, i32 %32)
  %34 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %35 = tail call i32 @verifier.nondet.3()
  %36 = tail call i32 @verifier.nondet.3()
  %37 = tail call i8* @s_default_calloc(%struct.aws_allocator* %34, i32 %35, i32 %36)
  %38 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %39 = tail call i32 @verifier.nondet.3()
  %40 = tail call fastcc i8* @aws_mem_acquire(%struct.aws_allocator* %38, i32 %39)
  %41 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error(i32 %41)
  %42 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %43 = tail call i32 @verifier.nondet.3()
  %44 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_mem_calloc(%struct.aws_allocator* %42, i32 %43, i32 %44)
  %45 = tail call i32 @verifier.nondet.3()
  %46 = tail call i32 @verifier.nondet.3()
  %47 = tail call i32* @verifier.nondet.6()
  tail call fastcc void @aws_mul_size_checked(i32 %45, i32 %46, i32* %47)
  %48 = tail call i32 @verifier.nondet.3()
  %49 = tail call i32 @verifier.nondet.3()
  %50 = tail call i32* @verifier.nondet.6()
  tail call fastcc void @aws_mul_u32_checked(i32 %48, i32 %49, i32* %50)
  %51 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %52 = tail call i32 @verifier.nondet.3()
  %53 = tail call i8* (%struct.aws_allocator*, i32, ...) @aws_mem_acquire_many(%struct.aws_allocator* %51, i32 %52)
  %54 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %55 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_mem_release(%struct.aws_allocator* %54, i8* %55)
  %56 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %57 = tail call i8** @verifier.nondet.7()
  %58 = tail call i32 @verifier.nondet.3()
  %59 = tail call i32 @verifier.nondet.3()
  %60 = tail call fastcc i32 @aws_mem_realloc(%struct.aws_allocator* %56, i8** %57, i32 %58, i32 %59)
  %61 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %61)
  %62 = tail call i8* @verifier.nondet.4()
  %63 = tail call i32 @verifier.nondet.3()
  %64 = tail call i32 @verifier.nondet.3()
  %65 = tail call i8* @verifier.nondet.4()
  %66 = tail call i8* @s_cf_allocator_reallocate(i8* %62, i32 %63, i32 %64, i8* %65)
  %67 = tail call i8* @verifier.nondet.4()
  %68 = tail call %struct.__CFString* @s_cf_allocator_copy_description(i8* %67)
  %69 = tail call i32 @verifier.nondet.3()
  %70 = tail call i32 @verifier.nondet.3()
  %71 = tail call i8* @verifier.nondet.4()
  %72 = tail call i8* @s_cf_allocator_allocate(i32 %69, i32 %70, i8* %71)
  %73 = tail call i8* @verifier.nondet.4()
  %74 = tail call i8* @verifier.nondet.4()
  tail call void @s_cf_allocator_deallocate(i8* %73, i8* %74)
  %75 = tail call i32 @verifier.nondet.3()
  %76 = tail call i32 @verifier.nondet.3()
  %77 = tail call i8* @verifier.nondet.4()
  %78 = tail call i32 @s_cf_allocator_preferred_size(i32 %75, i32 %76, i8* %77)
  %79 = tail call %struct.__CFAllocator* @verifier.nondet.8()
  tail call fastcc void @aws_wrapped_cf_allocator_destroy(%struct.__CFAllocator* %79)
  %80 = tail call fastcc i32 @aws_last_error()
  %81 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_str(i32 %81)
  %82 = tail call i32 @verifier.nondet.3()
  %83 = tail call fastcc %struct.aws_error_info* @get_error_by_code(i32 %82)
  %84 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_name(i32 %84)
  %85 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_lib_name(i32 %85)
  %86 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_debug_str(i32 %86)
  %87 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error_private(i32 %87)
  tail call fastcc void @aws_reset_error()
  %88 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_restore_error(i32 %88)
  %89 = tail call void (i32, i8*)* @verifier.nondet.9()
  %90 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %89, i8* %90)
  %91 = tail call void (i32, i8*)* @verifier.nondet.9()
  %92 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %91, i8* %92)
  %93 = tail call %struct.aws_error_info_list* @verifier.nondet.10()
  tail call fastcc void @aws_register_error_info(%struct.aws_error_info_list* %93)
  %94 = tail call %struct.aws_error_info_list* @verifier.nondet.10()
  tail call fastcc void @aws_unregister_error_info(%struct.aws_error_info_list* %94)
  %95 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_translate_and_raise_io_error(i32 %95)
  %96 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.20(i32 %96)
  %97 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %98 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %99 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_byte_buf_init(%struct.aws_byte_buf* %97, %struct.aws_allocator* %98, i32 %99)
  %100 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %101 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %102 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_buf_init_copy(%struct.aws_byte_buf* %100, %struct.aws_allocator* %101, %struct.aws_byte_buf* %102)
  %103 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %104 = tail call fastcc i1 @aws_byte_buf_is_valid(%struct.aws_byte_buf* %103)
  %105 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.23(i32 %105)
  %106 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %107 = tail call fastcc i1 @aws_byte_cursor_is_valid(%struct.aws_byte_cursor* %106)
  %108 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %109 = tail call i1 @verifier.nondet.13()
  tail call fastcc void @aws_byte_buf_reset(%struct.aws_byte_buf* %108, i1 %109)
  %110 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_buf_secure_zero(%struct.aws_byte_buf* %110)
  %111 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_buf_clean_up(%struct.aws_byte_buf* %111)
  %112 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_buf_clean_up_secure(%struct.aws_byte_buf* %112)
  %113 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %114 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_buf_eq(%struct.aws_byte_buf* %113, %struct.aws_byte_buf* %114)
  %115 = tail call i8* @verifier.nondet.4()
  %116 = tail call i32 @verifier.nondet.3()
  %117 = tail call i8* @verifier.nondet.4()
  %118 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_eq(i8* %115, i32 %116, i8* %117, i32 %118)
  %119 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %120 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_buf_eq_ignore_case(%struct.aws_byte_buf* %119, %struct.aws_byte_buf* %120)
  %121 = tail call i8* @verifier.nondet.4()
  %122 = tail call i32 @verifier.nondet.3()
  %123 = tail call i8* @verifier.nondet.4()
  %124 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_eq_ignore_case(i8* %121, i32 %122, i8* %123, i32 %124)
  %125 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %126 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_buf_eq_c_str(%struct.aws_byte_buf* %125, i8* %126)
  %127 = tail call i8* @verifier.nondet.4()
  %128 = tail call i32 @verifier.nondet.3()
  %129 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_array_eq_c_str(i8* %127, i32 %128, i8* %129)
  %130 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %131 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_buf_eq_c_str_ignore_case(%struct.aws_byte_buf* %130, i8* %131)
  %132 = tail call i8* @verifier.nondet.4()
  %133 = tail call i32 @verifier.nondet.3()
  %134 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_array_eq_c_str_ignore_case(i8* %132, i32 %133, i8* %134)
  %135 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %136 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %137 = tail call i32 @verifier.nondet.3()
  %138 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_buf_init_copy_from_cursor(%struct.aws_byte_buf* %135, %struct.aws_allocator* %136, i32 %137, i8* %138)
  %139 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %140 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %141 = tail call i32 (%struct.aws_byte_buf*, %struct.aws_allocator*, ...) @aws_byte_buf_init_cache_and_update_cursors(%struct.aws_byte_buf* %139, %struct.aws_allocator* %140)
  %142 = tail call i32 @verifier.nondet.3()
  %143 = tail call i32 @verifier.nondet.3()
  %144 = tail call i32* @verifier.nondet.6()
  %145 = tail call fastcc i32 @aws_add_size_checked(i32 %142, i32 %143, i32* %144)
  %146 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %147 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  tail call fastcc void @aws_byte_buf_append_and_update(%struct.aws_byte_buf* %146, %struct.aws_byte_cursor* %147)
  %148 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %149 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %150 = tail call fastcc i32 @aws_byte_buf_append(%struct.aws_byte_buf* %148, %struct.aws_byte_cursor* %149)
  %151 = tail call i32 @verifier.nondet.3()
  %152 = tail call i32 @verifier.nondet.3()
  %153 = tail call i32* @verifier.nondet.6()
  %154 = tail call fastcc i32 @aws_add_u32_checked(i32 %151, i32 %152, i32* %153)
  %155 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %156 = tail call i8 @verifier.nondet.14()
  %157 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %158 = tail call fastcc i1 @aws_byte_cursor_next_split(%struct.aws_byte_cursor* %155, i8 %156, %struct.aws_byte_cursor* %157)
  %159 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %160 = tail call i8 @verifier.nondet.14()
  %161 = tail call i32 @verifier.nondet.3()
  %162 = tail call %struct.aws_array_list* @verifier.nondet.15()
  tail call fastcc void @aws_byte_cursor_split_on_char_n(%struct.aws_byte_cursor* %159, i8 %160, i32 %161, %struct.aws_array_list* %162)
  %163 = tail call %struct.aws_array_list* @verifier.nondet.15()
  %164 = tail call i8* @verifier.nondet.4()
  %165 = tail call fastcc i32 @aws_array_list_push_back(%struct.aws_array_list* %163, i8* %164)
  %166 = tail call %struct.aws_array_list* @verifier.nondet.15()
  %167 = tail call fastcc i32 @aws_array_list_length(%struct.aws_array_list* %166)
  %168 = tail call %struct.aws_array_list* @verifier.nondet.15()
  %169 = tail call i8* @verifier.nondet.4()
  %170 = tail call i32 @verifier.nondet.3()
  %171 = tail call fastcc i32 @aws_array_list_set_at(%struct.aws_array_list* %168, i8* %169, i32 %170)
  %172 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %173 = tail call i8 @verifier.nondet.14()
  %174 = tail call %struct.aws_array_list* @verifier.nondet.15()
  tail call fastcc void @aws_byte_cursor_split_on_char(%struct.aws_byte_cursor* %172, i8 %173, %struct.aws_array_list* %174)
  ...
  tail call fastcc void @aws_byte_cursor_find_exact(%struct.aws_byte_cursor* %175, %struct.aws_byte_cursor* %176, %struct.aws_byte_cursor* %177)
  %178 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %179 = tail call i32 @verifier.nondet.3()
  %180 = tail call fastcc i64 @aws_byte_cursor_advance(%struct.aws_byte_cursor* %178, i32 %179)
  %181 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %182 = tail call i32 @verifier.nondet.3()
  %183 = tail call i32 (%struct.aws_byte_buf*, i32, ...) @aws_byte_buf_cat(%struct.aws_byte_buf* %181, i32 %182)
  %184 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_cursor_from_buf(%struct.aws_byte_buf* %184)
  %185 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %186 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  tail call fastcc void @aws_byte_cursor_eq(%struct.aws_byte_cursor* %185, %struct.aws_byte_cursor* %186)
  %187 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %188 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  tail call fastcc void @aws_byte_cursor_eq_ignore_case(%struct.aws_byte_cursor* %187, %struct.aws_byte_cursor* %188)
  tail call fastcc void @aws_lookup_table_to_lower_get()
  %189 = tail call i8* @verifier.nondet.4()
  %190 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_hash_array_ignore_case(i8* %189, i32 %190)
  %191 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_hash_byte_cursor_ptr_ignore_case(i8* %191)
  %192 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %193 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_cursor_eq_byte_buf(%struct.aws_byte_cursor* %192, %struct.aws_byte_buf* %193)
  %194 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %195 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_cursor_eq_byte_buf_ignore_case(%struct.aws_byte_cursor* %194, %struct.aws_byte_buf* %195)
  %196 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %197 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_cursor_eq_c_str(%struct.aws_byte_cursor* %196, i8* %197)
  %198 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %199 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_cursor_eq_c_str_ignore_case(%struct.aws_byte_cursor* %198, i8* %199)
  %200 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %201 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %202 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_buf_append_with_lookup(%struct.aws_byte_buf* %200, %struct.aws_byte_cursor* %201, i8* %202)
  %203 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %204 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  tail call fastcc void @aws_byte_buf_append_dynamic(%struct.aws_byte_buf* %203, %struct.aws_byte_cursor* %204)
  %205 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %206 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %207 = tail call i1 @verifier.nondet.13()
  tail call fastcc void @s_aws_byte_buf_append_dynamic(%struct.aws_byte_buf* %205, %struct.aws_byte_cursor* %206, i1 %207)
  %208 = tail call i32 @verifier.nondet.3()
  %209 = tail call i32 @verifier.nondet.3()
  %210 = tail call fastcc i32 @aws_add_size_saturating(i32 %208, i32 %209)
  %211 = tail call i32 @verifier.nondet.3()
  %212 = tail call i32 @verifier.nondet.3()
  %213 = tail call fastcc i32 @aws_add_u32_saturating(i32 %211, i32 %212)
  %214 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %215 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  tail call fastcc void @aws_byte_buf_append_dynamic_secure(%struct.aws_byte_buf* %214, %struct.aws_byte_cursor* %215)
  %216 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %217 = tail call i8 @verifier.nondet.14()
  tail call fastcc void @aws_byte_buf_append_byte_dynamic(%struct.aws_byte_buf* %216, i8 %217)
  %218 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %219 = tail call i8 @verifier.nondet.14()
  %220 = tail call i1 @verifier.nondet.13()
  tail call fastcc void @s_aws_byte_buf_append_byte_dynamic(%struct.aws_byte_buf* %218, i8 %219, i1 %220)
  %221 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %222 = tail call i8 @verifier.nondet.14()
  tail call fastcc void @aws_byte_buf_append_byte_dynamic_secure(%struct.aws_byte_buf* %221, i8 %222)
  %223 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %224 = tail call i32 @verifier.nondet.3()
  %225 = tail call fastcc i32 @aws_byte_buf_reserve(%struct.aws_byte_buf* %223, i32 %224)
  %226 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %227 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_byte_buf_reserve_relative(%struct.aws_byte_buf* %226, i32 %227)
  %228 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %229 = tail call i1 (i8)* @verifier.nondet.16()
  tail call fastcc void @aws_byte_cursor_right_trim_pred(%struct.aws_byte_cursor* %228, i1 (i8)* %229)
  %230 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %231 = tail call i1 (i8)* @verifier.nondet.16()
  %232 = tail call fastcc i64 @aws_byte_cursor_left_trim_pred(%struct.aws_byte_cursor* %230, i1 (i8)* %231)
  %233 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %234 = tail call i1 (i8)* @verifier.nondet.16()
  tail call fastcc void @aws_byte_cursor_trim_pred(%struct.aws_byte_cursor* %233, i1 (i8)* %234)
  %235 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %236 = tail call i1 (i8)* @verifier.nondet.16()
  tail call fastcc void @aws_byte_cursor_satisfies_pred(%struct.aws_byte_cursor* %235, i1 (i8)* %236)
  %237 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %238 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  tail call fastcc void @aws_byte_cursor_compare_lexical(%struct.aws_byte_cursor* %237, %struct.aws_byte_cursor* %238)
  %239 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %240 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %241 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_cursor_compare_lookup(%struct.aws_byte_cursor* %239, %struct.aws_byte_cursor* %240, i8* %241)
  %242 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %243 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_buf_from_c_str(%struct.aws_byte_buf* noalias %242, i8* %243)
  %244 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %245 = tail call i8* @verifier.nondet.4()
  %246 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_byte_buf_from_array(%struct.aws_byte_buf* noalias %244, i8* %245, i32 %246)
  %247 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %248 = tail call i8* @verifier.nondet.4()
  %249 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_byte_buf_from_empty_array(%struct.aws_byte_buf* noalias %247, i8* %248, i32 %249)
  %250 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_cursor_from_c_str(i8* %250)
  %251 = tail call i8* @verifier.nondet.4()
  %252 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_byte_cursor_from_array(i8* %251, i32 %252)
  %253 = tail call i32 @verifier.nondet.3()
  %254 = tail call i32 @verifier.nondet.3()
  %255 = tail call fastcc i32 @aws_nospec_mask(i32 %253, i32 %254)
  %256 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %257 = tail call i32 @verifier.nondet.3()
  %258 = tail call fastcc i64 @aws_byte_cursor_advance_nospec(%struct.aws_byte_cursor* %256, i32 %257)
  %259 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %260 = tail call i8* @verifier.nondet.4()
  %261 = tail call i32 @verifier.nondet.3()
  %262 = tail call fastcc i1 @aws_byte_cursor_read(%struct.aws_byte_cursor* %259, i8* %260, i32 %261)
  %263 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %264 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_cursor_read_and_fill_buffer(%struct.aws_byte_cursor* %263, %struct.aws_byte_buf* %264)
  %265 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %266 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_cursor_read_u8(%struct.aws_byte_cursor* %265, i8* %266)
  %267 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %268 = tail call i16* @verifier.nondet.17()
  tail call fastcc void @aws_byte_cursor_read_be16(%struct.aws_byte_cursor* %267, i16* %268)
  %269 = tail call i16 @verifier.nondet.18()
  %270 = tail call fastcc i16 @aws_ntoh16(i16 %269)
  %271 = tail call i16 @verifier.nondet.18()
  %272 = tail call fastcc i16 @_OSSwapInt16(i16 %271)
  %273 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %274 = tail call i32* @verifier.nondet.6()
  tail call fastcc void @aws_byte_cursor_read_be24(%struct.aws_byte_cursor* %273, i32* %274)
  %275 = tail call i32 @verifier.nondet.3()
  %276 = tail call fastcc i32 @aws_ntoh32(i32 %275)
  %277 = tail call i32 @verifier.nondet.3()
  %278 = tail call fastcc i32 @_OSSwapInt32(i32 %277)
  %279 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %280 = tail call i32* @verifier.nondet.6()
  tail call fastcc void @aws_byte_cursor_read_be32(%struct.aws_byte_cursor* %279, i32* %280)
  %281 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %282 = tail call float* @verifier.nondet.19()
  tail call fastcc void @aws_byte_cursor_read_float_be32(%struct.aws_byte_cursor* %281, float* %282)
  %283 = tail call float @verifier.nondet.20()
  %284 = tail call fastcc float @aws_ntohf32(float %283)
  %285 = tail call float @verifier.nondet.20()
  %286 = tail call fastcc float @aws_htonf32(float %285)
  tail call fastcc void @aws_is_big_endian()
  %287 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %288 = tail call double* @verifier.nondet.21()
  tail call fastcc void @aws_byte_cursor_read_float_be64(%struct.aws_byte_cursor* %287, double* %288)
  %289 = tail call double @verifier.nondet.22()
  %290 = tail call fastcc double @aws_ntohf64(double %289)
  %291 = tail call double @verifier.nondet.22()
  %292 = tail call fastcc double @aws_htonf64(double %291)
  %293 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %294 = tail call i64* @verifier.nondet.23()
  tail call fastcc void @aws_byte_cursor_read_be64(%struct.aws_byte_cursor* %293, i64* %294)
  %295 = tail call i64 @verifier.nondet.24()
  %296 = tail call fastcc i64 @aws_ntoh64(i64 %295)
  %297 = tail call i64 @verifier.nondet.24()
  %298 = tail call fastcc i64 @aws_hton64(i64 %297)
  tail call fastcc void @aws_lookup_table_hex_to_num_get()
  %299 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  %300 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_cursor_read_hex_u8(%struct.aws_byte_cursor* %299, i8* %300)
  %301 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %302 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %303 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_byte_buf_advance(%struct.aws_byte_buf* %301, %struct.aws_byte_buf* %302, i32 %303)
  %304 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %305 = tail call i8* @verifier.nondet.4()
  %306 = tail call i32 @verifier.nondet.3()
  %307 = tail call fastcc i1 @aws_byte_buf_write(%struct.aws_byte_buf* %304, i8* %305, i32 %306)
  %308 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %309 = tail call i32 @verifier.nondet.3()
  %310 = tail call i8* @verifier.nondet.4()
  %311 = tail call i32 @verifier.nondet.3()
  %312 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_byte_buf_write_from_whole_buffer(%struct.aws_byte_buf* %308, i32 %309, i8* %310)
  %313 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %314 = tail call i32 @verifier.nondet.3()
  %315 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_byte_buf_write_from_whole_cursor(%struct.aws_byte_buf* %313, i32 %314, i8* %315)
  %316 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %317 = tail call %struct.aws_byte_cursor* @verifier.nondet.12()
  tail call fastcc void @aws_byte_buf_write_to_capacity(%struct.aws_byte_buf* %316, %struct.aws_byte_cursor* %317)
  %318 = tail call i32 @verifier.nondet.3()
  %319 = tail call i32 @verifier.nondet.3()
  %320 = tail call fastcc i32 @aws_min_size(i32 %318, i32 %319)
  %321 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %322 = tail call i8 @verifier.nondet.14()
  tail call fastcc void @aws_byte_buf_write_u8(%struct.aws_byte_buf* %321, i8 %322)
  %323 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %324 = tail call i8 @verifier.nondet.14()
  %325 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_byte_buf_write_u8_n(%struct.aws_byte_buf* %323, i8 %324, i32 %325)
  %326 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %327 = tail call i16 @verifier.nondet.18()
  tail call fastcc void @aws_byte_buf_write_be16(%struct.aws_byte_buf* %326, i16 %327)
  %328 = tail call i16 @verifier.nondet.18()
  %329 = tail call fastcc i16 @aws_hton16(i16 %328)
  %330 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %331 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_byte_buf_write_be24(%struct.aws_byte_buf* %330, i32 %331)
  %332 = tail call i32 @verifier.nondet.3()
  %333 = tail call fastcc i32 @aws_hton32(i32 %332)
  %334 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %335 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_byte_buf_write_be32(%struct.aws_byte_buf* %334, i32 %335)
  %336 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %337 = tail call float @verifier.nondet.20()
  tail call fastcc void @aws_byte_buf_write_float_be32(%struct.aws_byte_buf* %336, float %337)
  %338 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %339 = tail call i64 @verifier.nondet.24()
  tail call fastcc void @aws_byte_buf_write_be64(%struct.aws_byte_buf* %338, i64 %339)
  %340 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %341 = tail call double @verifier.nondet.22()
  tail call fastcc void @aws_byte_buf_write_float_be64(%struct.aws_byte_buf* %340, double %341)
  %342 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_byte_buf_append_null_terminator(%struct.aws_byte_buf* %342)
  %343 = tail call i8 @verifier.nondet.14()
  tail call fastcc void @aws_isalnum(i8 %343)
  %344 = tail call i8 @verifier.nondet.14()
  tail call fastcc void @aws_isalpha(i8 %344)
  %345 = tail call i8 @verifier.nondet.14()
  tail call fastcc void @aws_isdigit(i8 %345)
  %346 = tail call i8 @verifier.nondet.14()
  tail call fastcc void @aws_isxdigit(i8 %346)
  %347 = tail call i8 @verifier.nondet.14()
  tail call fastcc void @aws_isspace(i8 %347)
  %348 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %349 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %350 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_ring_buffer_init(%struct.aws_ring_buffer* %348, %struct.aws_allocator* %349, i32 %350)
  %351 = tail call %struct.aws_atomic_var* @verifier.nondet.2()
  %352 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_atomic_init_ptr(%struct.aws_atomic_var* %351, i8* %352)
  %353 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  tail call fastcc void @aws_ring_buffer_clean_up(%struct.aws_ring_buffer* %353)
  %354 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %355 = tail call i32 @verifier.nondet.3()
  %356 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  %357 = tail call fastcc i32 @aws_ring_buffer_acquire(%struct.aws_ring_buffer* %354, i32 %355, %struct.aws_byte_buf* %356)
  %358 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.29(i32 %358)
  %359 = tail call %struct.aws_atomic_var* @verifier.nondet.2()
  %360 = tail call i32 @verifier.nondet.3()
  %361 = tail call fastcc i8* @aws_atomic_load_ptr_explicit.30(%struct.aws_atomic_var* %359, i32 %360)
  %362 = tail call %struct.aws_atomic_var* @verifier.nondet.2()
  %363 = tail call i8* @verifier.nondet.4()
  %364 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_atomic_store_ptr_explicit(%struct.aws_atomic_var* %362, i8* %363, i32 %364)
  %365 = tail call i32 @verifier.nondet.3()
  %366 = tail call fastcc i32 @aws_atomic_priv_xlate_order.31(i32 %365)
  %367 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %368 = tail call i32 @verifier.nondet.3()
  %369 = tail call i32 @verifier.nondet.3()
  %370 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_ring_buffer_acquire_up_to(%struct.aws_ring_buffer* %367, i32 %368, i32 %369, %struct.aws_byte_buf* %370)
  %371 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %372 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_ring_buffer_release(%struct.aws_ring_buffer* %371, %struct.aws_byte_buf* %372)
  %373 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %374 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @aws_ring_buffer_buf_belongs_to_pool(%struct.aws_ring_buffer* %373, %struct.aws_byte_buf* %374)
  %375 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  %376 = tail call %struct.aws_byte_buf* @verifier.nondet.11()
  tail call fastcc void @s_buf_belongs_to_pool(%struct.aws_ring_buffer* %375, %struct.aws_byte_buf* %376)
  %377 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %378 = tail call %struct.aws_ring_buffer* @verifier.nondet.1()
  tail call fastcc void @aws_ring_buffer_allocator_init(%struct.aws_allocator* %377, %struct.aws_ring_buffer* %378)
  %379 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %380 = tail call i32 @verifier.nondet.3()
  %381 = tail call i8* @s_ring_buffer_mem_acquire(%struct.aws_allocator* %379, i32 %380)
  %382 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %383 = tail call i8* @verifier.nondet.4()
  tail call void @s_ring_buffer_mem_release(%struct.aws_allocator* %382, i8* %383)
  %384 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %385 = tail call i32 @verifier.nondet.3()
  %386 = tail call i32 @verifier.nondet.3()
  %387 = tail call i8* @s_ring_buffer_mem_calloc(%struct.aws_allocator* %384, i32 %385, i32 %386)
  %388 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %389 = tail call i8* @verifier.nondet.4()
  %390 = tail call i32 @verifier.nondet.3()
  %391 = tail call i32 @verifier.nondet.3()
  %392 = tail call i8* @s_ring_buffer_mem_realloc(%struct.aws_allocator* %388, i8* %389, i32 %390, i32 %391)
  unreachable
}
...
attributes #4 = { cold noreturn "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!11 = !{!12, !13, i64 8}
!12 = !{!"aws_byte_buf", !13, i64 0, !7, i64 4, !13, i64 8, !7, i64 12}
!13 = !{!"long", !8, i64 0}
!14 = !{!12, !13, i64 0}
!15 = !{!12, !7, i64 4}
!16 = !{!6, !7, i64 16}
...
!18 = !{!7, !7, i64 0}
!19 = !{!20, !7, i64 0}
!20 = !{!"aws_allocator", !7, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16}
!21 = !{!22, !22, i64 0}
!22 = !{!"int", !8, i64 0}
!23 = !{!20, !7, i64 12}
!24 = !{!20, !7, i64 4}
!25 = !{!20, !7, i64 8}
!26 = !{!27, !13, i64 0}
!27 = !{!"", !13, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16, !7, i64 20, !7, i64 24, !7, i64 28, !7, i64 32}
!28 = !{!27, !7, i64 4}
!29 = !{!27, !7, i64 8}
!30 = !{!27, !7, i64 12}
!31 = !{!27, !7, i64 16}
...
!39 = !{!37, !7, i64 0}
!40 = !{!41, !22, i64 0}
!41 = !{!"aws_error_info", !22, i64 0, !7, i64 4, !7, i64 8, !7, i64 12, !7, i64 16}
!42 = !{!12, !7, i64 12}
!43 = !{!44, !13, i64 0}
!44 = !{!"aws_byte_cursor", !13, i64 0, !7, i64 4}
!45 = !{!44, !7, i64 4}
!46 = !{i32 1682}
...
!55 = !{!56, !13, i64 8}
!56 = !{!"aws_array_list", !7, i64 0, !13, i64 4, !13, i64 8, !13, i64 12, !7, i64 16}
!57 = !{!56, !7, i64 16}
!58 = !{!56, !7, i64 0}
!59 = !{!56, !13, i64 12}
!60 = !{!61}
