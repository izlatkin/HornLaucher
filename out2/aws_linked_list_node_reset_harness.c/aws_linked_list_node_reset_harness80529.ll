; ModuleID = '../out2/aws_linked_list_node_reset_harness.c/aws_linked_list_node_reset_harness80529.bc.txt'
...
define internal fastcc void @aws_linked_list_node_reset_harness() unnamed_addr #1 {
...
define internal fastcc void @aws_linked_list_node_reset(%struct.aws_linked_list_node* %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #12
...
.lr.ph5:                                          ; preds = %2, %.lr.ph5
  ...
  %7 = load i64, i64* %6, align 4, !tbaa !5
  %8 = icmp eq i64 %7, 0
  %9 = add nuw i32 %.014, 1
  %10 = icmp ult i32 %9, %4
  %or.cond = and i1 %8, %10
  br i1 %or.cond, label %.lr.ph5, label %.loopexit, !llvm.loop !9
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_node_reset_harness()
  %1 = tail call %struct.aws_linked_list_node* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_node_reset(%struct.aws_linked_list_node* %1)
  %2 = tail call i8* @verifier.nondet.2()
  %3 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_is_mem_zeroed(i8* %2, i32 %3)
  %4 = tail call %struct.aws_allocator* @verifier.nondet.4()
  tail call fastcc void @aws_allocator_is_valid(%struct.aws_allocator* %4)
  tail call fastcc void @aws_default_allocator()
  %5 = tail call %struct.aws_allocator* @verifier.nondet.4()
  %6 = tail call i32 @verifier.nondet.3()
  %7 = tail call i8* @s_default_malloc(%struct.aws_allocator* %5, i32 %6)
  %8 = tail call %struct.aws_allocator* @verifier.nondet.4()
  %9 = tail call i8* @verifier.nondet.2()
  tail call void @s_default_free(%struct.aws_allocator* %8, i8* %9)
  %10 = tail call %struct.aws_allocator* @verifier.nondet.4()
  %11 = tail call i8* @verifier.nondet.2()
  ...
  %19 = tail call %struct.aws_allocator* @verifier.nondet.4()
  ...
  %32 = tail call %struct.aws_allocator* @verifier.nondet.4()
  ...
  %35 = tail call %struct.aws_allocator* @verifier.nondet.4()
  %36 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_mem_release(%struct.aws_allocator* %35, i8* %36)
  %37 = tail call %struct.aws_allocator* @verifier.nondet.4()
  ...
  %43 = tail call i8* @verifier.nondet.2()
  ...
  %48 = tail call i8* @verifier.nondet.2()
  ...
  %70 = tail call i8* @verifier.nondet.2()
...
!13 = !{!14, !12, i64 0}
!14 = !{!"aws_allocator", !12, i64 0, !12, i64 4, !12, i64 8, !12, i64 12, !12, i64 16}
!15 = !{!14, !12, i64 12}
!16 = !{!17, !17, i64 0}
!17 = !{!"int", !7, i64 0}
!18 = !{!14, !12, i64 4}
!19 = !{!14, !12, i64 8}
!20 = !{!21, !22, i64 0}
!21 = !{!"", !22, i64 0, !12, i64 4, !12, i64 8, !12, i64 12, !12, i64 16, !12, i64 20, !12, i64 24, !12, i64 28, !12, i64 32}
!22 = !{!"long", !7, i64 0}
!23 = !{!21, !12, i64 4}
!24 = !{!21, !12, i64 8}
!25 = !{!21, !12, i64 12}
...
!30 = !{!21, !12, i64 32}
!31 = !{!32, !33, i64 4}
!32 = !{!"aws_error_info_list", !12, i64 0, !33, i64 4}
!33 = !{!"short", !7, i64 0}
!34 = !{!32, !12, i64 0}
!35 = !{!36, !17, i64 0}
!36 = !{!"aws_error_info", !17, i64 0, !12, i64 4, !12, i64 8, !12, i64 12, !12, i64 16}
