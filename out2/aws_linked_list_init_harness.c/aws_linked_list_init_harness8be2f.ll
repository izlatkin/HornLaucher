; ModuleID = '../out2/aws_linked_list_init_harness.c/aws_linked_list_init_harness8be2f.bc.txt'
...
define internal fastcc void @aws_linked_list_init_harness() unnamed_addr #1 {
...
define internal fastcc void @aws_linked_list_init(%struct.aws_linked_list* %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #12
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_is_valid(%struct.aws_linked_list* nocapture readnone %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #12
  ret void
}
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_init_harness()
  %1 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_init(%struct.aws_linked_list* %1)
  %2 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  tail call fastcc void @aws_linked_list_is_valid(%struct.aws_linked_list* %2)
  %3 = tail call %struct.aws_allocator* @verifier.nondet.2()
  tail call fastcc void @aws_allocator_is_valid(%struct.aws_allocator* %3)
  ...
  %6 = tail call i8* @s_default_malloc(%struct.aws_allocator* %4, i32 %5)
  %7 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %8 = tail call i8* @verifier.nondet.4()
  tail call void @s_default_free(%struct.aws_allocator* %7, i8* %8)
  ...
  %13 = tail call i8* @s_default_realloc(%struct.aws_allocator* %9, i8* %10, i32 %11, i32 %12)
  %14 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %15 = tail call i32 @verifier.nondet.3()
  %16 = tail call i32 @verifier.nondet.3()
  %17 = tail call i8* @s_default_calloc(%struct.aws_allocator* %14, i32 %15, i32 %16)
  %18 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %19 = tail call i32 @verifier.nondet.3()
  %20 = tail call fastcc i8* @aws_mem_acquire(%struct.aws_allocator* %18, i32 %19)
  %21 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error(i32 %21)
  %22 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %23 = tail call i32 @verifier.nondet.3()
  %24 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_mem_calloc(%struct.aws_allocator* %22, i32 %23, i32 %24)
  %25 = tail call i32 @verifier.nondet.3()
  %26 = tail call i32 @verifier.nondet.3()
  %27 = tail call i32* @verifier.nondet.5()
  tail call fastcc void @aws_mul_size_checked(i32 %25, i32 %26, i32* %27)
  %28 = tail call i32 @verifier.nondet.3()
  %29 = tail call i32 @verifier.nondet.3()
  %30 = tail call i32* @verifier.nondet.5()
  tail call fastcc void @aws_mul_u32_checked(i32 %28, i32 %29, i32* %30)
  %31 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %32 = tail call i32 @verifier.nondet.3()
  %33 = tail call i8* (%struct.aws_allocator*, i32, ...) @aws_mem_acquire_many(%struct.aws_allocator* %31, i32 %32)
  %34 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %35 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_mem_release(%struct.aws_allocator* %34, i8* %35)
  %36 = tail call %struct.aws_allocator* @verifier.nondet.2()
  %37 = tail call i8** @verifier.nondet.6()
  %38 = tail call i32 @verifier.nondet.3()
  %39 = tail call i32 @verifier.nondet.3()
  %40 = tail call fastcc i32 @aws_mem_realloc(%struct.aws_allocator* %36, i8** %37, i32 %38, i32 %39)
  %41 = tail call %struct.aws_allocator* @verifier.nondet.2()
  tail call fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %41)
  %42 = tail call i8* @verifier.nondet.4()
  %43 = tail call i32 @verifier.nondet.3()
  %44 = tail call i32 @verifier.nondet.3()
  %45 = tail call i8* @verifier.nondet.4()
  %46 = tail call i8* @s_cf_allocator_reallocate(i8* %42, i32 %43, i32 %44, i8* %45)
  %47 = tail call i8* @verifier.nondet.4()
  %48 = tail call %struct.__CFString* @s_cf_allocator_copy_description(i8* %47)
  %49 = tail call i32 @verifier.nondet.3()
  %50 = tail call i32 @verifier.nondet.3()
  %51 = tail call i8* @verifier.nondet.4()
  %52 = tail call i8* @s_cf_allocator_allocate(i32 %49, i32 %50, i8* %51)
  %53 = tail call i8* @verifier.nondet.4()
  %54 = tail call i8* @verifier.nondet.4()
  tail call void @s_cf_allocator_deallocate(i8* %53, i8* %54)
  %55 = tail call i32 @verifier.nondet.3()
  %56 = tail call i32 @verifier.nondet.3()
  %57 = tail call i8* @verifier.nondet.4()
  %58 = tail call i32 @s_cf_allocator_preferred_size(i32 %55, i32 %56, i8* %57)
  %59 = tail call %struct.__CFAllocator* @verifier.nondet.7()
  tail call fastcc void @aws_wrapped_cf_allocator_destroy(%struct.__CFAllocator* %59)
  tail call fastcc void @aws_last_error()
  %60 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_str(i32 %60)
  %61 = tail call i32 @verifier.nondet.3()
  %62 = tail call fastcc %struct.aws_error_info* @get_error_by_code(i32 %61)
  %63 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_name(i32 %63)
  %64 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_lib_name(i32 %64)
  %65 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_debug_str(i32 %65)
  %66 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error_private(i32 %66)
  tail call fastcc void @aws_reset_error()
  %67 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_restore_error(i32 %67)
  %68 = tail call void (i32, i8*)* @verifier.nondet.8()
  %69 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %68, i8* %69)
  %70 = tail call void (i32, i8*)* @verifier.nondet.8()
  %71 = tail call i8* @verifier.nondet.4()
  tail call fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %70, i8* %71)
  %72 = tail call %struct.aws_error_info_list* @verifier.nondet.9()
  tail call fastcc void @aws_register_error_info(%struct.aws_error_info_list* %72)
  %73 = tail call %struct.aws_error_info_list* @verifier.nondet.9()
  tail call fastcc void @aws_unregister_error_info(%struct.aws_error_info_list* %73)
  %74 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_translate_and_raise_io_error(i32 %74)
  %75 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.20(i32 %75)
  ret i32 42
}
