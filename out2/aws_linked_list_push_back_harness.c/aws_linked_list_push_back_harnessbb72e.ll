; ModuleID = '../out2/aws_linked_list_push_back_harness.c/aws_linked_list_push_back_harnessbb72e.bc.txt'
...
define internal fastcc void @aws_linked_list_push_back_harness() unnamed_addr #1 {
  ...
  call void @seahorn.fn.enter() #12
  %5 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %1, i32 0, i32 1, i32 1
  %6 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %5, align 4, !tbaa !5
  %7 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %6, i32 0, i32 0
  store %struct.aws_linked_list_node* %2, %struct.aws_linked_list_node** %7, align 4, !tbaa !10
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
...
define internal fastcc void @aws_linked_list_push_back(%struct.aws_linked_list* %0, %struct.aws_linked_list_node* %1) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  %3 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1
  tail call void @seahorn.fn.enter() #12
  %4 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %1, i32 0, i32 0
  store %struct.aws_linked_list_node* %3, %struct.aws_linked_list_node** %4, align 4, !tbaa !10
  %5 = getelementptr inbounds %struct.aws_linked_list, %struct.aws_linked_list* %0, i32 0, i32 1, i32 1
  %6 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %5, align 4, !tbaa !5
  %7 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %1, i32 0, i32 1
  store %struct.aws_linked_list_node* %6, %struct.aws_linked_list_node** %7, align 4, !tbaa !5
  %8 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %5, align 4, !tbaa !5
  %9 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %8, i32 0, i32 0
  store %struct.aws_linked_list_node* %1, %struct.aws_linked_list_node** %9, align 4, !tbaa !10
...
define internal fastcc void @aws_linked_list_insert_before(%struct.aws_linked_list_node* %0, %struct.aws_linked_list_node* %1) unnamed_addr #4 {
  ...
  store %struct.aws_linked_list_node* %0, %struct.aws_linked_list_node** %3, align 4, !tbaa !10
  ...
  store %struct.aws_linked_list_node* %5, %struct.aws_linked_list_node** %6, align 4, !tbaa !5
  %7 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %4, align 4, !tbaa !5
  %8 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %7, i32 0, i32 0
  store %struct.aws_linked_list_node* %1, %struct.aws_linked_list_node** %8, align 4, !tbaa !10
  store %struct.aws_linked_list_node* %1, %struct.aws_linked_list_node** %4, align 4, !tbaa !5
  ret void
}
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_push_back_harness()
  %1 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  %2 = tail call %struct.aws_linked_list_node* @verifier.nondet.2()
  tail call fastcc void @aws_linked_list_push_back(%struct.aws_linked_list* %1, %struct.aws_linked_list_node* %2)
