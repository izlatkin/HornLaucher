; ModuleID = '../out2/aws_linked_list_prev_harness.c/aws_linked_list_prev_harness101a0.bc.txt'
...
define internal fastcc void @aws_linked_list_prev_harness() unnamed_addr #1 {
...
define internal fastcc %struct.aws_linked_list_node* @aws_linked_list_prev(%struct.aws_linked_list_node* nocapture readonly %0) unnamed_addr #3 {
  tail call void @seahorn.fn.enter() #12
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_prev_harness()
  %1 = tail call %struct.aws_linked_list_node* @verifier.nondet.1()
  %2 = tail call fastcc %struct.aws_linked_list_node* @aws_linked_list_prev(%struct.aws_linked_list_node* %1)
