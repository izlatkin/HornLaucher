; ModuleID = '../out2/aws_array_list_set_at_harness.c/aws_array_list_set_at_harness48d70.bc.txt'
...
@.str.4 = private unnamed_addr constant [24 x i8] c"allocator != ((void*)0)\00", align 1
@.str.1.5 = private unnamed_addr constant [37 x i8] c"/tmp/aws-c-common/source/allocator.c\00", align 1
@.str.2.6 = private unnamed_addr constant [37 x i8] c"allocator->mem_acquire != ((void*)0)\00", align 1
@.str.3.7 = private unnamed_addr constant [10 x i8] c"size != 0\00", align 1
@.str.4.9 = private unnamed_addr constant [48 x i8] c"allocator->mem_calloc || allocator->mem_acquire\00", align 1
...
@.str.1.15 = private unnamed_addr constant [11 x i8] c"error_info\00", align 1
@.str.2.16 = private unnamed_addr constant [33 x i8] c"/tmp/aws-c-common/source/error.c\00", align 1
@.str.3.17 = private unnamed_addr constant [23 x i8] c"error_info->error_list\00", align 1
@.str.4.18 = private unnamed_addr constant [18 x i8] c"error_info->count\00", align 1
@__stderrp = external local_unnamed_addr global %struct.__sFILE*, align 4
@.str.5.19 = private unnamed_addr constant [25 x i8] c"Bad error slot index %d\0A\00", align 1
@.str.6.20 = private unnamed_addr constant [6 x i8] c"false\00", align 1
@.str.7.21 = private unnamed_addr constant [2 x i8] c"0\00", align 1
@.str.28 = private unnamed_addr constant [33 x i8] c"from->item_size == to->item_size\00", align 1
@.str.1.29 = private unnamed_addr constant [38 x i8] c"/tmp/aws-c-common/source/array_list.c\00", align 1
@.str.2.30 = private unnamed_addr constant [11 x i8] c"from->data\00", align 1
@.str.3.33 = private unnamed_addr constant [17 x i8] c"a < list->length\00", align 1
@.str.4.34 = private unnamed_addr constant [17 x i8] c"b < list->length\00", align 1
@.str.7.35 = private unnamed_addr constant [6 x i8] c"item1\00", align 1
@.str.8.36 = private unnamed_addr constant [6 x i8] c"item2\00", align 1
@.str.5.38 = private unnamed_addr constant [28 x i8] c"!list->length || list->data\00", align 1
@.str.6.39 = private unnamed_addr constant [52 x i8] c"/tmp/aws-c-common/include/aws/common/array_list.inl\00", align 1
...
@.str.40 = private unnamed_addr constant [11 x i8] c"libnuma.so\00", align 1
@.str.1.41 = private unnamed_addr constant [13 x i8] c"libnuma.so.1\00", align 1
@.str.2.42 = private unnamed_addr constant [13 x i8] c"libnuma.so.2\00", align 1
@.str.3.43 = private unnamed_addr constant [26 x i8] c"static: libnuma.so loaded\00", align 1
@.str.4.44 = private unnamed_addr constant [14 x i8] c"set_mempolicy\00", align 1
@.str.5.45 = private unnamed_addr constant [31 x i8] c"static: set_mempolicy() loaded\00", align 1
@.str.6.46 = private unnamed_addr constant [39 x i8] c"static: set_mempolicy() failed to load\00", align 1
@.str.7.47 = private unnamed_addr constant [15 x i8] c"numa_available\00", align 1
@.str.8.48 = private unnamed_addr constant [32 x i8] c"static: numa_available() loaded\00", align 1
@.str.9.49 = private unnamed_addr constant [40 x i8] c"static: numa_available() failed to load\00", align 1
...
@.str.12.50 = private unnamed_addr constant [51 x i8] c"static: numa_num_configured_nodes() failed to load\00", align 1
...
@.str.28.51 = private unnamed_addr constant [14 x i8] c"AWS_ERROR_OOM\00", align 1
...
@.str.40.52 = private unnamed_addr constant [28 x i8] c"AWS_ERROR_OVERFLOW_DETECTED\00", align 1
...
define internal fastcc void @aws_array_list_set_at_harness() unnamed_addr #1 {
  %1 = tail call i32 @verifier.nondet.10() #14
  tail call void @seahorn.fn.enter() #14
  %2 = alloca %struct.aws_array_list, align 8
  %3 = alloca %struct.aws_array_list, align 8
  %4 = alloca %struct.store_byte_from_buffer, align 4
  %5 = bitcast %struct.aws_array_list* %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %5) #14
  %6 = call zeroext i1 @aws_array_list_is_bounded(%struct.aws_array_list* nonnull %2, i32 0, i32 2) #14
  call void @verifier.assume(i1 %6)
  call void @ensure_array_list_has_allocated_data_member(%struct.aws_array_list* nonnull %2) #14
  call void @seahorn.fn.enter() #14, !noalias !5
  %7 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %2, i32 0, i32 2
  %8 = load i32, i32* %7, align 8, !tbaa !8, !alias.scope !5
  %9 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %2, i32 0, i32 3
  %10 = load i32, i32* %9, align 4, !tbaa !14, !alias.scope !5
  call void @seahorn.fn.enter() #14
  call void @seahorn.fn.enter() #14
  %11 = mul i32 %10, %8
  %12 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %2, i32 0, i32 1
  %13 = load i32, i32* %12, align 4, !tbaa !15, !alias.scope !5
  %14 = icmp uge i32 %13, %11
  %15 = icmp eq i32 %13, 0
  %16 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %2, i32 0, i32 4
  %17 = load i8*, i8** %16, align 8, !tbaa !16, !alias.scope !5
  br i1 %15, label %18, label %20

18:                                               ; preds = %0
  %19 = icmp eq i8* %17, null
  br i1 %19, label %.thread.i, label %aws_array_list_is_valid.exit
...
.thread.i:                                        ; preds = %20, %18
  %22 = phi i1 [ %21, %20 ], [ true, %18 ]
  %or.cond3.i = and i1 %14, %22
  %23 = icmp ne i32 %10, 0
  %spec.select.i = and i1 %23, %or.cond3.i
  br label %aws_array_list_is_valid.exit

aws_array_list_is_valid.exit:                     ; preds = %18, %.thread.i
  %24 = phi i1 [ %spec.select.i, %.thread.i ], [ false, %18 ]
  call void @verifier.assume(i1 %24)
  %25 = icmp ne i8* %17, null
  call void @verifier.assume(i1 %25)
  %26 = call i8* @malloc(i32 %10) #15
  %27 = bitcast %struct.aws_array_list* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %27) #14
  %.pmcpy.elt = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %2, i32 0, i32 0
  %.pmcpy.unpack = load %struct.aws_allocator*, %struct.aws_allocator** %.pmcpy.elt, align 8
  %.repack = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %3, i32 0, i32 0
  store %struct.aws_allocator* %.pmcpy.unpack, %struct.aws_allocator** %.repack, align 8
  %.repack10 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %3, i32 0, i32 1
  store i32 %13, i32* %.repack10, align 4
  %.repack12 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %3, i32 0, i32 2
  store i32 %8, i32* %.repack12, align 8
  %.repack14 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %3, i32 0, i32 3
  store i32 %10, i32* %.repack14, align 4
  %.repack16 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %3, i32 0, i32 4
  store i8* %17, i8** %.repack16, align 8
  %28 = bitcast %struct.store_byte_from_buffer* %4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %28) #14
  call void @save_byte_from_array(i8* %17, i32 %13, %struct.store_byte_from_buffer* nonnull %4) #14
  call void @seahorn.fn.enter() #14, !noalias !17
  %29 = load i32, i32* %7, align 8, !tbaa !8, !alias.scope !17
  %30 = load i32, i32* %9, align 4, !tbaa !14, !alias.scope !17
  call void @seahorn.fn.enter() #14
  call void @seahorn.fn.enter() #14
  %31 = mul i32 %30, %29
  %32 = load i32, i32* %12, align 4, !tbaa !15, !alias.scope !17
  %33 = icmp uge i32 %32, %31
  %34 = icmp eq i32 %32, 0
  %35 = load i8*, i8** %16, align 8, !tbaa !16, !alias.scope !17
  br i1 %34, label %36, label %38

36:                                               ; preds = %aws_array_list_is_valid.exit
  %37 = icmp eq i8* %35, null
  br i1 %37, label %.thread.i3, label %aws_array_list_is_valid.exit5

38:                                               ; preds = %aws_array_list_is_valid.exit
  %39 = icmp ne i8* %35, null
  br label %.thread.i3

.thread.i3:                                       ; preds = %38, %36
  %40 = phi i1 [ %39, %38 ], [ true, %36 ]
  %or.cond3.i1 = and i1 %33, %40
  %41 = icmp ne i32 %30, 0
  %spec.select.i2 = and i1 %41, %or.cond3.i1
  br label %aws_array_list_is_valid.exit5

aws_array_list_is_valid.exit5:                    ; preds = %36, %.thread.i3
  %42 = phi i1 [ %spec.select.i2, %.thread.i3 ], [ false, %36 ]
  call void @verifier.assume(i1 %42)
  %43 = icmp ne i8* %26, null
  call void @verifier.assume(i1 %43)
  %44 = call fastcc i32 @aws_array_list_set_at(%struct.aws_array_list* nonnull %2, i8* %26, i32 %1)
  %45 = icmp eq i32 %44, 0
  br i1 %45, label %aws_array_list_is_valid.exit10, label %46

46:                                               ; preds = %aws_array_list_is_valid.exit5
  call void @assert_array_list_equivalence(%struct.aws_array_list* nonnull %2, %struct.aws_array_list* nonnull %3, %struct.store_byte_from_buffer* nonnull %4) #14
  br label %aws_array_list_is_valid.exit10

aws_array_list_is_valid.exit10:                   ; preds = %46, %aws_array_list_is_valid.exit5
  call void @seahorn.fn.enter() #14, !noalias !20
  call void @seahorn.fn.enter() #14
  call void @seahorn.fn.enter() #14
...
declare void @save_byte_from_array(i8*, i32, %struct.store_byte_from_buffer*) local_unnamed_addr #3

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_array_list_set_at(%struct.aws_array_list* noalias nocapture %0, i8* %1, i32 %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  %4 = tail call fastcc i32 @aws_array_list_ensure_capacity(%struct.aws_array_list* %0, i32 %2)
  %5 = icmp eq i32 %4, 0
...
6:                                                ; preds = %3
  ...
  %8 = load i8*, i8** %7, align 4, !tbaa !16
  %9 = icmp eq i8* %8, null
  br i1 %9, label %10, label %aws_array_list_length.exit

10:                                               ; preds = %6
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.39, i32 0, i32 0), i32 359) #16
  unreachable

aws_array_list_length.exit:                       ; preds = %6
  %11 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 3
  %12 = load i32, i32* %11, align 4, !tbaa !14
  %13 = mul i32 %12, %2
  %14 = getelementptr inbounds i8, i8* %8, i32 %13
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 %14, i8* align 1 %1, i32 %12, i1 false) #14
  tail call void @seahorn.fn.enter() #14, !noalias !23
  %15 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 2
  %16 = load i32, i32* %15, align 4, !tbaa !8, !alias.scope !23
  %17 = icmp ugt i32 %16, %2
  br i1 %17, label %aws_add_size_checked.exit.thread, label %18

18:                                               ; preds = %aws_array_list_length.exit
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %19 = icmp eq i32 %2, -1
  br i1 %19, label %20, label %aws_add_size_checked.exit

20:                                               ; preds = %18
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %21 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %22 = icmp eq void (i32, i8*)* %21, null
  br i1 %22, label %25, label %23

23:                                               ; preds = %20
  %24 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %21(i32 5, i8* %24) #14
  br label %aws_add_size_checked.exit.thread

25:                                               ; preds = %20
  %26 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %27 = icmp eq void (i32, i8*)* %26, null
  br i1 %27, label %aws_add_size_checked.exit.thread, label %28

28:                                               ; preds = %25
  %29 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %26(i32 5, i8* %29) #14
  br label %aws_add_size_checked.exit.thread

aws_add_size_checked.exit:                        ; preds = %18
  %30 = add nuw i32 %2, 1
  store i32 %30, i32* %15, align 4, !tbaa !27
  br label %aws_add_size_checked.exit.thread

aws_add_size_checked.exit.thread:                 ; preds = %28, %25, %23, %aws_array_list_length.exit, %aws_add_size_checked.exit, %3
  %.0 = phi i32 [ -1, %3 ], [ 0, %aws_add_size_checked.exit ], [ 0, %aws_array_list_length.exit ], [ -1, %23 ], [ -1, %25 ], [ -1, %28 ]
  ret i32 %.0
}

declare void @assert_array_list_equivalence(%struct.aws_array_list*, %struct.aws_array_list*, %struct.store_byte_from_buffer*) local_unnamed_addr #3
...
declare i8* @__memcpy_chk(i8*, i8*, i32, i32) local_unnamed_addr #7
...
9:                                                ; preds = %5
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.38, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.39, i32 0, i32 0), i32 312) #16
  unreachable
...
7:                                                ; preds = %3
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %8 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %9 = icmp eq void (i32, i8*)* %8, null
  br i1 %9, label %12, label %10

10:                                               ; preds = %7
  %11 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %8(i32 5, i8* %11) #14
  br label %aws_add_u32_checked.exit

12:                                               ; preds = %7
  %13 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %14 = icmp eq void (i32, i8*)* %13, null
  br i1 %14, label %aws_add_u32_checked.exit, label %15

15:                                               ; preds = %12
  %16 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %13(i32 5, i8* %16) #14
  br label %aws_add_u32_checked.exit
...
aws_raise_error.exit:                             ; preds = %15, %12, %10, %17
...
define internal fastcc void @aws_raise_error(i32 %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %3 = icmp eq void (i32, i8*)* %2, null
  br i1 %3, label %6, label %4

4:                                                ; preds = %1
  %5 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %2(i32 %0, i8* %5) #14
  br label %aws_raise_error_private.exit

6:                                                ; preds = %1
  %7 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %8 = icmp eq void (i32, i8*)* %7, null
  br i1 %8, label %aws_raise_error_private.exit, label %9

9:                                                ; preds = %6
  %10 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %7(i32 %0, i8* %10) #14
  br label %aws_raise_error_private.exit
...
define internal i8* @s_default_malloc(%struct.aws_allocator* nocapture readnone %0, i32 %1) #1 {
  ...
  store i8* null, i8** %3, align 4, !tbaa !26
  %7 = call i32 @posix_memalign(i8** nonnull %3, i32 %5, i32 %1) #14
  %8 = icmp eq i32 %7, 0
...
11:                                               ; preds = %9
  ...
  store i8* null, i8** %5, align 4, !tbaa !26
  %15 = call i32 @posix_memalign(i8** nonnull %5, i32 %13, i32 %3) #14
  %16 = icmp ne i32 %15, 0
...
20:                                               ; preds = %11
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 %17, i8* nonnull align 1 %1, i32 %2, i1 false) #14
  call void @seahorn.fn.enter() #14
  call void @free(i8* nonnull %1) #14
  br label %21
...
define internal i8* @s_default_calloc(%struct.aws_allocator* nocapture readnone %0, i32 %1, i32 %2) #1 {
  ...
  store i8* null, i8** %4, align 4, !tbaa !26
  %9 = call i32 @posix_memalign(i8** nonnull %4, i32 %7, i32 %5) #14
  %10 = icmp eq i32 %9, 0
...
14:                                               ; preds = %3
  call void @llvm.memset.p0i8.i32(i8* nonnull align 1 %12, i8 0, i32 %5, i1 false) #14
  br label %15
...
4:                                                ; preds = %2
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 115) #16
  unreachable

5:                                                ; preds = %2
  %6 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 0
  %7 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %6, align 4, !tbaa !29
  %8 = icmp eq i8* (%struct.aws_allocator*, i32)* %7, null
  br i1 %8, label %9, label %10

9:                                                ; preds = %5
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.2.6, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 116) #16
  unreachable
...
12:                                               ; preds = %10
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3.7, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 118) #16
  unreachable

13:                                               ; preds = %10
  %14 = tail call i8* %7(%struct.aws_allocator* nonnull %0, i32 %1) #14
  %15 = icmp eq i8* %14, null
  br i1 %15, label %16, label %aws_raise_error.8.exit

16:                                               ; preds = %13
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %17 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %18 = icmp eq void (i32, i8*)* %17, null
  br i1 %18, label %21, label %19

19:                                               ; preds = %16
  %20 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %17(i32 1, i8* %20) #14
  br label %aws_raise_error.8.exit

21:                                               ; preds = %16
  %22 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %23 = icmp eq void (i32, i8*)* %22, null
  br i1 %23, label %aws_raise_error.8.exit, label %24

24:                                               ; preds = %21
  %25 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %22(i32 1, i8* %25) #14
  br label %aws_raise_error.8.exit

aws_raise_error.8.exit:                           ; preds = %24, %21, %19, %13
  ret i8* %14
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_raise_error.8(i32 %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %3 = icmp eq void (i32, i8*)* %2, null
...
5:                                                ; preds = %3
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 128) #16
  unreachable
...
10:                                               ; preds = %6
  ...
  %12 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %11, align 4, !tbaa !29
  %13 = icmp eq i8* (%struct.aws_allocator*, i32)* %12, null
  br i1 %13, label %14, label %15

14:                                               ; preds = %10
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.4.9, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 129) #16
  unreachable
...
18:                                               ; preds = %15
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 131) #16
  unreachable
...
21:                                               ; preds = %19
  %22 = tail call i8* %8(%struct.aws_allocator* nonnull %0, i32 %1, i32 %2) #14
  %23 = icmp eq i8* %22, null
  br i1 %23, label %24, label %aws_raise_error.8.exit

24:                                               ; preds = %21
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %25 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %26 = icmp eq void (i32, i8*)* %25, null
  br i1 %26, label %29, label %27

27:                                               ; preds = %24
  %28 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %25(i32 1, i8* %28) #14
  br label %aws_raise_error.8.exit

29:                                               ; preds = %24
  %30 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %31 = icmp eq void (i32, i8*)* %30, null
  br i1 %31, label %aws_raise_error.8.exit, label %32

32:                                               ; preds = %29
  %33 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %30(i32 1, i8* %33) #14
  br label %aws_raise_error.8.exit

34:                                               ; preds = %19
  %35 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 0
  %36 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %35, align 4, !tbaa !29
  %37 = tail call i8* %36(%struct.aws_allocator* nonnull %0, i32 %20) #14
...
39:                                               ; preds = %34
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %40 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %41 = icmp eq void (i32, i8*)* %40, null
  br i1 %41, label %44, label %42

42:                                               ; preds = %39
  %43 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %40(i32 1, i8* %43) #14
  br label %aws_raise_error.8.exit

44:                                               ; preds = %39
  %45 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %46 = icmp eq void (i32, i8*)* %45, null
  br i1 %46, label %aws_raise_error.8.exit, label %47

47:                                               ; preds = %44
  %48 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %45(i32 1, i8* %48) #14
  br label %aws_raise_error.8.exit

49:                                               ; preds = %34
  call void @llvm.memset.p0i8.i32(i8* nonnull align 1 %37, i8 0, i32 %20, i1 false) #14
  br label %aws_raise_error.8.exit

aws_raise_error.8.exit:                           ; preds = %47, %44, %42, %32, %29, %27, %49, %21
  ret void
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_size_checked.10(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !27
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_u32_checked.11(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !27
  ret void
...
4:                                                ; preds = %2
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 215) #16
  unreachable

5:                                                ; preds = %2
  %6 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 1
  %7 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %6, align 4, !tbaa !32
  %8 = icmp eq void (%struct.aws_allocator*, i8*)* %7, null
  br i1 %8, label %9, label %10

9:                                                ; preds = %5
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 216) #16
  unreachable
...
12:                                               ; preds = %10
  tail call void %7(%struct.aws_allocator* nonnull %0, i8* nonnull %1) #14
  br label %13
...
6:                                                ; preds = %4
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 224) #16
  unreachable

7:                                                ; preds = %4
  %8 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 2
  %9 = load i8* (%struct.aws_allocator*, i8*, i32, i32)*, i8* (%struct.aws_allocator*, i8*, i32, i32)** %8, align 4, !tbaa !33
...
11:                                               ; preds = %7
  ...
  %13 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %12, align 4, !tbaa !29
  %14 = icmp eq i8* (%struct.aws_allocator*, i32)* %13, null
  br i1 %14, label %15, label %16

15:                                               ; preds = %11
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 225) #16
  unreachable

16:                                               ; preds = %11, %7
  %17 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 1
  %18 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !32
  %19 = icmp eq void (%struct.aws_allocator*, i8*)* %18, null
  br i1 %19, label %20, label %21

20:                                               ; preds = %16
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.1.5, i32 0, i32 0), i32 226) #16
  unreachable
...
23:                                               ; preds = %21
  %24 = load i8*, i8** %1, align 4, !tbaa !26
  tail call void @seahorn.fn.enter() #14
  %25 = icmp eq i8* %24, null
  br i1 %25, label %aws_mem_release.exit, label %26

26:                                               ; preds = %23
  tail call void %18(%struct.aws_allocator* nonnull %0, i8* nonnull %24) #14
  br label %aws_mem_release.exit

aws_mem_release.exit:                             ; preds = %23, %26
  store i8* null, i8** %1, align 4, !tbaa !26
  br label %aws_raise_error.8.exit
...
28:                                               ; preds = %27
  %29 = load i8*, i8** %1, align 4, !tbaa !26
  %30 = tail call i8* %9(%struct.aws_allocator* nonnull %0, i8* %29, i32 %2, i32 %3) #14
...
32:                                               ; preds = %28
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %33 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %34 = icmp eq void (i32, i8*)* %33, null
  br i1 %34, label %37, label %35

35:                                               ; preds = %32
  %36 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %33(i32 1, i8* %36) #14
  br label %aws_raise_error.8.exit

37:                                               ; preds = %32
  %38 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %39 = icmp eq void (i32, i8*)* %38, null
  br i1 %39, label %aws_raise_error.8.exit, label %40

40:                                               ; preds = %37
  %41 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %38(i32 1, i8* %41) #14
  br label %aws_raise_error.8.exit

42:                                               ; preds = %28
  store i8* %30, i8** %1, align 4, !tbaa !26
  br label %aws_raise_error.8.exit

43:                                               ; preds = %27
  %44 = icmp ugt i32 %3, %2
  br i1 %44, label %45, label %aws_raise_error.8.exit

45:                                               ; preds = %43
  %46 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %0, i32 0, i32 0
  %47 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %46, align 4, !tbaa !29
  %48 = tail call i8* %47(%struct.aws_allocator* nonnull %0, i32 %3) #14
...
50:                                               ; preds = %45
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %51 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %52 = icmp eq void (i32, i8*)* %51, null
  br i1 %52, label %55, label %53

53:                                               ; preds = %50
  %54 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %51(i32 1, i8* %54) #14
  br label %aws_raise_error.8.exit

55:                                               ; preds = %50
  %56 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %57 = icmp eq void (i32, i8*)* %56, null
  br i1 %57, label %aws_raise_error.8.exit, label %58

58:                                               ; preds = %55
  %59 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %56(i32 1, i8* %59) #14
  br label %aws_raise_error.8.exit

60:                                               ; preds = %45
  %61 = load i8*, i8** %1, align 4, !tbaa !26
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 %48, i8* align 1 %61, i32 %2, i1 false) #14
  %62 = getelementptr inbounds i8, i8* %48, i32 %2
  %63 = sub i32 %3, %2
  call void @llvm.memset.p0i8.i32(i8* nonnull align 1 %62, i8 0, i32 %63, i1 false) #14
  %64 = load i8*, i8** %1, align 4, !tbaa !26
  tail call void @seahorn.fn.enter() #14
  %65 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !32
...
70:                                               ; preds = %68
  tail call void %65(%struct.aws_allocator* nonnull %0, i8* nonnull %64) #14
  br label %aws_mem_release.exit7

aws_mem_release.exit7:                            ; preds = %68, %70
  store i8* %48, i8** %1, align 4, !tbaa !26
  br label %aws_raise_error.8.exit

aws_raise_error.8.exit:                           ; preds = %58, %55, %53, %40, %37, %35, %aws_mem_release.exit7, %43, %42, %aws_mem_release.exit
...
define internal fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %0) unnamed_addr #1 {
  ...
  %4 = load i8* (%struct.aws_allocator*, i8*, i32, i32)*, i8* (%struct.aws_allocator*, i8*, i32, i32)** %3, align 4, !tbaa !33
  ...
  call void @llvm.lifetime.start.p0i8(i64 36, i8* nonnull %6) #14
  %7 = getelementptr inbounds %struct.CFAllocatorContext, %struct.CFAllocatorContext* %2, i32 0, i32 0
  store i32 0, i32* %7, align 4, !tbaa !34
  ...
  store %struct.aws_allocator* %0, %struct.aws_allocator** %9, align 4, !tbaa !36
  %10 = getelementptr inbounds %struct.CFAllocatorContext, %struct.CFAllocatorContext* %2, i32 0, i32 2
  store i8* (i8*)* null, i8* (i8*)** %10, align 4, !tbaa !37
  %11 = getelementptr inbounds %struct.CFAllocatorContext, %struct.CFAllocatorContext* %2, i32 0, i32 3
  store void (i8*)* null, void (i8*)** %11, align 4, !tbaa !38
  %12 = getelementptr inbounds %struct.CFAllocatorContext, %struct.CFAllocatorContext* %2, i32 0, i32 4
  store %struct.__CFString* (i8*)* @s_cf_allocator_copy_description, %struct.__CFString* (i8*)** %12, align 4, !tbaa !39
  %13 = getelementptr inbounds %struct.CFAllocatorContext, %struct.CFAllocatorContext* %2, i32 0, i32 5
  store i8* (i32, i32, i8*)* @s_cf_allocator_allocate, i8* (i32, i32, i8*)** %13, align 4, !tbaa !40
  %14 = getelementptr inbounds %struct.CFAllocatorContext, %struct.CFAllocatorContext* %2, i32 0, i32 6
  store i8* (i8*, i32, i32, i8*)* %spec.store.select, i8* (i8*, i32, i32, i8*)** %14, align 4, !tbaa !41
  %15 = getelementptr inbounds %struct.CFAllocatorContext, %struct.CFAllocatorContext* %2, i32 0, i32 7
  store void (i8*, i8*)* @s_cf_allocator_deallocate, void (i8*, i8*)** %15, align 4, !tbaa !42
  %16 = getelementptr inbounds %struct.CFAllocatorContext, %struct.CFAllocatorContext* %2, i32 0, i32 8
  store i32 (i32, i32, i8*)* @s_cf_allocator_preferred_size, i32 (i32, i32, i8*)** %16, align 4, !tbaa !43
  %17 = call %struct.__CFAllocator* @CFAllocatorCreate(%struct.__CFAllocator* null, %struct.CFAllocatorContext* nonnull %2) #14
  %18 = icmp eq %struct.__CFAllocator* %17, null
  br i1 %18, label %19, label %aws_raise_error.8.exit

19:                                               ; preds = %1
  call void @seahorn.fn.enter() #14
  call void @seahorn.fn.enter() #14
  %20 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %21 = icmp eq void (i32, i8*)* %20, null
  br i1 %21, label %24, label %22

22:                                               ; preds = %19
  %23 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  call void %20(i32 1, i8* %23) #14
  br label %aws_raise_error.8.exit

24:                                               ; preds = %19
  %25 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %26 = icmp eq void (i32, i8*)* %25, null
  br i1 %26, label %aws_raise_error.8.exit, label %27

27:                                               ; preds = %24
  %28 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  call void %25(i32 1, i8* %28) #14
  br label %aws_raise_error.8.exit

aws_raise_error.8.exit:                           ; preds = %27, %24, %22, %1
  call void @llvm.lifetime.end.p0i8(i64 36, i8* nonnull %6) #14
  ret void
}
...
define internal i8* @s_cf_allocator_reallocate(i8* %0, i32 %1, i32 %2, i8* %3) #1 {
  ...
  store i8* %8, i8** %5, align 4, !tbaa !26
...
13:                                               ; preds = %4
  %14 = load i8*, i8** %5, align 4, !tbaa !26
...
7:                                                ; preds = %2
  ...
  %10 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %9, align 4, !tbaa !32
...
aws_mem_release.exit:                             ; preds = %7
  tail call void %10(%struct.aws_allocator* nonnull %3, i8* nonnull %4) #14
  ret void
}
...
define internal fastcc void @aws_wrapped_cf_allocator_destroy(%struct.__CFAllocator* %0) unnamed_addr #1 {
  ...
  tail call void @CFRelease(i8* %2) #14
  ret void
}
...
3:                                                ; preds = %1
  ...
  %6 = load volatile %struct.aws_error_info_list*, %struct.aws_error_info_list** %5, align 4, !tbaa !26
  ret void
...
3:                                                ; preds = %1
  ...
  %7 = load volatile %struct.aws_error_info_list*, %struct.aws_error_info_list** %6, align 4, !tbaa !26
...
9:                                                ; preds = %3
  ...
  %11 = load i16, i16* %10, align 4, !tbaa !44
...
14:                                               ; preds = %9
  ...
  %16 = load %struct.aws_error_info*, %struct.aws_error_info** %15, align 4, !tbaa !47
...
define internal fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %0, i8* %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #14
  store void (i32, i8*)* %0, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  store i8* %1, i8** @s_global_error_context, align 4, !tbaa !26
  ret void
}
...
define internal fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %0, i8* %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #14
  store void (i32, i8*)* %0, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  store i8* %1, i8** @tl_thread_handler_context, align 4, !tbaa !26
  ret void
}
...
3:                                                ; preds = %1
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1.15, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.16, i32 0, i32 0), i32 133) #16
  unreachable

4:                                                ; preds = %1
  %5 = getelementptr inbounds %struct.aws_error_info_list, %struct.aws_error_info_list* %0, i32 0, i32 0
  %6 = load %struct.aws_error_info*, %struct.aws_error_info** %5, align 4, !tbaa !47
  %7 = icmp eq %struct.aws_error_info* %6, null
  br i1 %7, label %8, label %9

8:                                                ; preds = %4
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3.17, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.16, i32 0, i32 0), i32 134) #16
  unreachable
...
13:                                               ; preds = %9
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4.18, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.16, i32 0, i32 0), i32 135) #16
  unreachable
...
19:                                               ; preds = %14
  %20 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !26
  %21 = tail call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %20, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5.19, i32 0, i32 0), i32 %17) #14
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6.20, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.16, i32 0, i32 0), i32 144) #16
  unreachable

22:                                               ; preds = %14
  %23 = getelementptr inbounds [16 x %struct.aws_error_info_list*], [16 x %struct.aws_error_info_list*]* @ERROR_SLOTS, i32 0, i32 %17
  store volatile %struct.aws_error_info_list* %0, %struct.aws_error_info_list** %23, align 4, !tbaa !26
  ret void
}
...
3:                                                ; preds = %1
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1.15, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.16, i32 0, i32 0), i32 167) #16
  unreachable
...
8:                                                ; preds = %4
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3.17, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.16, i32 0, i32 0), i32 168) #16
  unreachable
...
13:                                               ; preds = %9
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4.18, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.16, i32 0, i32 0), i32 169) #16
  unreachable
...
19:                                               ; preds = %14
  %20 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !26
  %21 = tail call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %20, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5.19, i32 0, i32 0), i32 %17) #14
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7.21, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.16, i32 0, i32 0), i32 178) #16
  unreachable

22:                                               ; preds = %14
  %23 = getelementptr inbounds [16 x %struct.aws_error_info_list*], [16 x %struct.aws_error_info_list*]* @ERROR_SLOTS, i32 0, i32 %17
  store volatile %struct.aws_error_info_list* null, %struct.aws_error_info_list** %23, align 4, !tbaa !26
  ret void
}
...
4:                                                ; preds = %1
  %5 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %2(i32 34, i8* %5) #14
  br label %aws_raise_error.22.exit

6:                                                ; preds = %1
  %7 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %8 = icmp eq void (i32, i8*)* %7, null
  br i1 %8, label %aws_raise_error.22.exit, label %9

9:                                                ; preds = %6
  %10 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %7(i32 34, i8* %10) #14
  br label %aws_raise_error.22.exit

11:                                               ; preds = %LeafBlock15
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %12 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %13 = icmp eq void (i32, i8*)* %12, null
  br i1 %13, label %16, label %14

14:                                               ; preds = %11
  %15 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %12(i32 42, i8* %15) #14
  br label %aws_raise_error.22.exit

16:                                               ; preds = %11
  %17 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %18 = icmp eq void (i32, i8*)* %17, null
  br i1 %18, label %aws_raise_error.22.exit, label %19

19:                                               ; preds = %16
  %20 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %17(i32 42, i8* %20) #14
  br label %aws_raise_error.22.exit

21:                                               ; preds = %LeafBlock, %LeafBlock3
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %22 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %23 = icmp eq void (i32, i8*)* %22, null
  br i1 %23, label %26, label %24

24:                                               ; preds = %21
  %25 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %22(i32 43, i8* %25) #14
  br label %aws_raise_error.22.exit

26:                                               ; preds = %21
  %27 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %28 = icmp eq void (i32, i8*)* %27, null
  br i1 %28, label %aws_raise_error.22.exit, label %29

29:                                               ; preds = %26
  %30 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %27(i32 43, i8* %30) #14
  br label %aws_raise_error.22.exit

31:                                               ; preds = %LeafBlock1, %NodeBlock5, %LeafBlock17
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %32 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %33 = icmp eq void (i32, i8*)* %32, null
  br i1 %33, label %36, label %34

34:                                               ; preds = %31
  %35 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %32(i32 44, i8* %35) #14
  br label %aws_raise_error.22.exit

36:                                               ; preds = %31
  %37 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %38 = icmp eq void (i32, i8*)* %37, null
  br i1 %38, label %aws_raise_error.22.exit, label %39

39:                                               ; preds = %36
  %40 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %37(i32 44, i8* %40) #14
  br label %aws_raise_error.22.exit

41:                                               ; preds = %LeafBlock11
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %42 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %43 = icmp eq void (i32, i8*)* %42, null
  br i1 %43, label %46, label %44

44:                                               ; preds = %41
  %45 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %42(i32 45, i8* %45) #14
  br label %aws_raise_error.22.exit

46:                                               ; preds = %41
  %47 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %48 = icmp eq void (i32, i8*)* %47, null
  br i1 %48, label %aws_raise_error.22.exit, label %49

49:                                               ; preds = %46
  %50 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %47(i32 45, i8* %50) #14
  br label %aws_raise_error.22.exit

51:                                               ; preds = %NodeBlock7
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %52 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %53 = icmp eq void (i32, i8*)* %52, null
  br i1 %53, label %56, label %54

54:                                               ; preds = %51
  %55 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %52(i32 1, i8* %55) #14
  br label %aws_raise_error.22.exit

56:                                               ; preds = %51
  %57 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %58 = icmp eq void (i32, i8*)* %57, null
  br i1 %58, label %aws_raise_error.22.exit, label %59

59:                                               ; preds = %56
  %60 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %57(i32 1, i8* %60) #14
  br label %aws_raise_error.22.exit

61:                                               ; preds = %NodeBlock21
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %62 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %63 = icmp eq void (i32, i8*)* %62, null
  br i1 %63, label %66, label %64

64:                                               ; preds = %61
  %65 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %62(i32 2, i8* %65) #14
  br label %aws_raise_error.22.exit

66:                                               ; preds = %61
  %67 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %68 = icmp eq void (i32, i8*)* %67, null
  br i1 %68, label %aws_raise_error.22.exit, label %69

69:                                               ; preds = %66
  %70 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %67(i32 2, i8* %70) #14
  br label %aws_raise_error.22.exit

NewDefault:                                       ; preds = %LeafBlock, %LeafBlock1, %LeafBlock3, %LeafBlock11, %LeafBlock15, %LeafBlock17
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %71 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %72 = icmp eq void (i32, i8*)* %71, null
  br i1 %72, label %75, label %73

73:                                               ; preds = %NewDefault
  %74 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %71(i32 46, i8* %74) #14
  br label %aws_raise_error.22.exit

75:                                               ; preds = %NewDefault
  %76 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %77 = icmp eq void (i32, i8*)* %76, null
  br i1 %77, label %aws_raise_error.22.exit, label %78

78:                                               ; preds = %75
  %79 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %76(i32 46, i8* %79) #14
  br label %aws_raise_error.22.exit

aws_raise_error.22.exit:                          ; preds = %78, %75, %73, %69, %66, %64, %59, %56, %54, %49, %46, %44, %39, %36, %34, %29, %26, %24, %19, %16, %14, %9, %6, %4
  ret void
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_raise_error.22(i32 %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %3 = icmp eq void (i32, i8*)* %2, null
...
define internal fastcc i32 @aws_array_list_calc_necessary_size(%struct.aws_array_list* noalias nocapture readonly %0, i32 %1, i32* nocapture %2) unnamed_addr #1 {
  ...
  %6 = call fastcc i32 @aws_add_size_checked.23(i32 %1, i32 1, i32* nonnull %4)
  %7 = icmp eq i32 %6, 0
  br i1 %7, label %8, label %13

8:                                                ; preds = %3
  %9 = load i32, i32* %4, align 4, !tbaa !50
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_add_size_checked.23(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %4 = icmp ne i32 %1, 0
  %5 = sub nuw nsw i32 -1, %1
...
10:                                               ; preds = %7
  %11 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %8(i32 5, i8* %11) #14
  br label %aws_add_u32_checked.27.exit

12:                                               ; preds = %7
  %13 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %14 = icmp eq void (i32, i8*)* %13, null
  br i1 %14, label %aws_add_u32_checked.27.exit, label %15
...
aws_add_u32_checked.27.exit:                      ; preds = %10, %12, %15, %17
  %.0.i = phi i32 [ 0, %17 ], [ -1, %10 ], [ -1, %12 ], [ -1, %15 ]
  ret i32 %.0.i
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_size_checked.24(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !27
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_u32_checked.25(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !27
  ret void
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_raise_error.26(i32 %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %3 = icmp eq void (i32, i8*)* %2, null
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_add_u32_checked.27(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  %4 = icmp ne i32 %1, 0
  %5 = sub nuw nsw i32 -1, %1
  %6 = icmp ult i32 %5, %0
...
10:                                               ; preds = %7
  %11 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %8(i32 5, i8* %11) #14
  br label %aws_raise_error.26.exit

12:                                               ; preds = %7
  %13 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %14 = icmp eq void (i32, i8*)* %13, null
  br i1 %14, label %aws_raise_error.26.exit, label %15
...
aws_raise_error.26.exit:                          ; preds = %15, %12, %10, %17
  %.0 = phi i32 [ 0, %17 ], [ -1, %10 ], [ -1, %12 ], [ -1, %15 ]
  ret i32 %.0
}
...
define internal fastcc void @aws_array_list_shrink_to_fit(%struct.aws_array_list* noalias nocapture %0) unnamed_addr #1 {
  ...
  %3 = load %struct.aws_allocator*, %struct.aws_allocator** %2, align 4, !tbaa !51
...
5:                                                ; preds = %1
  ...
  br i1 %13, label %14, label %aws_raise_error.26.exit
...
16:                                               ; preds = %14
  ...
  %18 = icmp eq i8* %17, null
  br i1 %18, label %aws_raise_error.26.exit, label %19

19:                                               ; preds = %16
  %20 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 4
  %21 = load i8*, i8** %20, align 4, !tbaa !16
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 %17, i8* align 1 %21, i32 %10, i1 false) #14
  tail call void @seahorn.fn.enter() #14
  %22 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %3, i32 0, i32 1
  %23 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %22, align 4, !tbaa !32
...
28:                                               ; preds = %26
  tail call void %23(%struct.aws_allocator* nonnull %3, i8* nonnull %21) #14
  br label %.critedge
...
30:                                               ; preds = %1
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %31 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %32 = icmp eq void (i32, i8*)* %31, null
  br i1 %32, label %35, label %33

33:                                               ; preds = %30
  %34 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %31(i32 28, i8* %34) #14
  br label %aws_raise_error.26.exit

35:                                               ; preds = %30
  %36 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %37 = icmp eq void (i32, i8*)* %36, null
  br i1 %37, label %aws_raise_error.26.exit, label %38

38:                                               ; preds = %35
  %39 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %36(i32 28, i8* %39) #14
  br label %aws_raise_error.26.exit

aws_raise_error.26.exit:                          ; preds = %38, %35, %33, %5, %16, %.critedge
  ret void
}
...
8:                                                ; preds = %2
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.28, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.29, i32 0, i32 0), i32 61) #16
  unreachable
...
13:                                               ; preds = %9
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2.30, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.29, i32 0, i32 0), i32 62) #16
  unreachable
...
23:                                               ; preds = %21
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 1 %25, i8* nonnull align 1 %11, i32 %17, i1 false) #14
  br label %26
...
28:                                               ; preds = %14
  ...
  %30 = load %struct.aws_allocator*, %struct.aws_allocator** %29, align 4, !tbaa !51
...
32:                                               ; preds = %28
  ...
  br i1 %34, label %aws_raise_error.26.exit, label %35

35:                                               ; preds = %32
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 %33, i8* nonnull align 1 %11, i32 %17, i1 false) #14
...
39:                                               ; preds = %35
  ...
  %41 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %40, align 4, !tbaa !32
...
aws_mem_release.exit:                             ; preds = %39
  tail call void %41(%struct.aws_allocator* nonnull %30, i8* nonnull %37) #14
  br label %44
...
46:                                               ; preds = %28
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %47 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %48 = icmp eq void (i32, i8*)* %47, null
  br i1 %48, label %51, label %49

49:                                               ; preds = %46
  %50 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %47(i32 26, i8* %50) #14
  br label %aws_raise_error.26.exit

51:                                               ; preds = %46
  %52 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %53 = icmp eq void (i32, i8*)* %52, null
  br i1 %53, label %aws_raise_error.26.exit, label %54

54:                                               ; preds = %51
  %55 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %52(i32 26, i8* %55) #14
  br label %aws_raise_error.26.exit

aws_raise_error.26.exit:                          ; preds = %54, %51, %49, %44, %32, %26
  ret void
}

; Function Attrs: nounwind ssp uwtable
define internal fastcc i32 @aws_array_list_ensure_capacity(%struct.aws_array_list* noalias nocapture %0, i32 %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14, !noalias !52
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %3 = icmp eq i32 %1, -1
...
4:                                                ; preds = %2
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %5 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %6 = icmp eq void (i32, i8*)* %5, null
  br i1 %6, label %9, label %7

7:                                                ; preds = %4
  %8 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %5(i32 5, i8* %8) #14
  br label %aws_array_list_calc_necessary_size.exit

9:                                                ; preds = %4
  %10 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %11 = icmp eq void (i32, i8*)* %10, null
  br i1 %11, label %aws_array_list_calc_necessary_size.exit, label %12

12:                                               ; preds = %9
  %13 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %10(i32 5, i8* %13) #14
  br label %aws_array_list_calc_necessary_size.exit

14:                                               ; preds = %2
  %15 = add nuw i32 %1, 1
  %16 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 3
  %17 = load i32, i32* %16, align 4, !tbaa !14, !alias.scope !52
  tail call void @seahorn.fn.enter() #14, !noalias !52
  tail call void @seahorn.fn.enter() #14, !noalias !52
  %18 = mul i32 %17, %15
...
22:                                               ; preds = %14
  ...
  %24 = load %struct.aws_allocator*, %struct.aws_allocator** %23, align 4, !tbaa !51
...
26:                                               ; preds = %22
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %27 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %28 = icmp eq void (i32, i8*)* %27, null
  br i1 %28, label %31, label %29

29:                                               ; preds = %26
  %30 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %27(i32 10, i8* %30) #14
  br label %aws_array_list_calc_necessary_size.exit

31:                                               ; preds = %26
  %32 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %33 = icmp eq void (i32, i8*)* %32, null
  br i1 %33, label %aws_array_list_calc_necessary_size.exit, label %34

34:                                               ; preds = %31
  %35 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %32(i32 10, i8* %35) #14
  br label %aws_array_list_calc_necessary_size.exit
...
.critedge:                                        ; preds = %36
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %41 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %42 = icmp eq void (i32, i8*)* %41, null
  br i1 %42, label %45, label %43

43:                                               ; preds = %.critedge
  %44 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %41(i32 27, i8* %44) #14
  br label %aws_array_list_calc_necessary_size.exit

45:                                               ; preds = %.critedge
  %46 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %47 = icmp eq void (i32, i8*)* %46, null
  br i1 %47, label %aws_array_list_calc_necessary_size.exit, label %48

48:                                               ; preds = %45
  %49 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %46(i32 27, i8* %49) #14
  br label %aws_array_list_calc_necessary_size.exit
...
53:                                               ; preds = %50
  ...
  br i1 %56, label %.critedge6, label %57

57:                                               ; preds = %53
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 %51, i8* nonnull align 1 %55, i32 %20, i1 false) #14
  tail call void @seahorn.fn.enter() #14
  %58 = getelementptr inbounds %struct.aws_allocator, %struct.aws_allocator* %24, i32 0, i32 1
  %59 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %58, align 4, !tbaa !32
...
aws_mem_release.exit:                             ; preds = %57
  tail call void %59(%struct.aws_allocator* nonnull %24, i8* nonnull %55) #14
  br label %.critedge6

.critedge6:                                       ; preds = %aws_mem_release.exit, %53
  store i8* %51, i8** %54, align 4, !tbaa !16
  store i32 %39, i32* %19, align 4, !tbaa !15
  br label %aws_array_list_calc_necessary_size.exit

aws_array_list_calc_necessary_size.exit:          ; preds = %48, %45, %43, %34, %31, %29, %12, %9, %7, %14, %.critedge6, %50
  %.2 = phi i32 [ -1, %50 ], [ 0, %.critedge6 ], [ 0, %14 ], [ -1, %7 ], [ -1, %9 ], [ -1, %12 ], [ -1, %29 ], [ -1, %31 ], [ -1, %34 ], [ -1, %43 ], [ -1, %45 ], [ -1, %48 ]
  ret i32 %.2
}
...
7:                                                ; preds = %3
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3.33, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.29, i32 0, i32 0), i32 193) #16
  unreachable
...
10:                                               ; preds = %8
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4.34, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.29, i32 0, i32 0), i32 194) #16
  unreachable
...
13:                                               ; preds = %11
  tail call void @seahorn.fn.enter() #14, !noalias !55
  tail call void @seahorn.fn.enter() #14, !noalias !58
  %14 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 4
  %15 = load i8*, i8** %14, align 4, !tbaa !16, !alias.scope !58
  %16 = icmp eq i8* %15, null
  br i1 %16, label %17, label %aws_array_list_get_at_ptr.exit4

17:                                               ; preds = %13
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.38, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.39, i32 0, i32 0), i32 312) #16, !noalias !58
  unreachable
...
aws_array_list_get_at_ptr.exit4:                  ; preds = %13
  ...
  %19 = load i32, i32* %18, align 4, !tbaa !14, !alias.scope !55
  tail call void @seahorn.fn.enter() #14, !noalias !61
  tail call void @seahorn.fn.enter() #14, !noalias !64
  %20 = mul i32 %19, %1
...
define internal fastcc void @aws_array_list_get_at_ptr(%struct.aws_array_list* noalias nocapture readonly %0, i8** nocapture %1, i32 %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14, !noalias !67
  %4 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 2
  %5 = load i32, i32* %4, align 4, !tbaa !8, !alias.scope !67
  %6 = icmp eq i32 %5, 0
  br i1 %6, label %aws_array_list_length.37.exit, label %7

7:                                                ; preds = %3
  %8 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 4
  %9 = load i8*, i8** %8, align 4, !tbaa !16, !alias.scope !67
  %10 = icmp eq i8* %9, null
  br i1 %10, label %11, label %aws_array_list_length.37.exit

11:                                               ; preds = %7
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.38, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.39, i32 0, i32 0), i32 312) #16, !noalias !67
  unreachable

aws_array_list_length.37.exit:                    ; preds = %3, %7
  %12 = icmp ugt i32 %5, %2
  br i1 %12, label %13, label %20

13:                                               ; preds = %aws_array_list_length.37.exit
  %14 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 4
  ...
  store i8* %19, i8** %1, align 4, !tbaa !26
  br label %aws_raise_error.26.exit

20:                                               ; preds = %aws_array_list_length.37.exit
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %21 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %22 = icmp eq void (i32, i8*)* %21, null
...
23:                                               ; preds = %20
  %24 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %21(i32 10, i8* %24) #14
  br label %aws_raise_error.26.exit

25:                                               ; preds = %20
  %26 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %27 = icmp eq void (i32, i8*)* %26, null
  br i1 %27, label %aws_raise_error.26.exit, label %28

28:                                               ; preds = %25
  %29 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %26(i32 10, i8* %29) #14
  br label %aws_raise_error.26.exit

aws_raise_error.26.exit:                          ; preds = %28, %25, %23, %13
  ret void
}
...
6:                                                ; preds = %3
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7.35, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.29, i32 0, i32 0), i32 172) #16
  unreachable
...
9:                                                ; preds = %7
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.8.36, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.29, i32 0, i32 0), i32 173) #16
  unreachable
...
._crit_edge:                                      ; preds = %.lr.ph, %10
  ...
  %14 = and i32 %2, 127
  %15 = call i8* @__memcpy_chk(i8* nonnull %12, i8* nonnull %.0.lcssa, i32 %14, i32 128) #14
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 %.0.lcssa, i8* nonnull align 1 %.01.lcssa, i32 %14, i1 false) #14
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 %.01.lcssa, i8* nonnull align 1 %12, i32 %14, i1 false) #14
...
.lr.ph:                                           ; preds = %10, %.lr.ph
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 dereferenceable(128) %.07, i8* nonnull align 1 dereferenceable(128) %.016, i32 128, i1 false) #14
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 1 dereferenceable(128) %.016, i8* nonnull align 1 dereferenceable(128) %12, i32 128, i1 false) #14
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_array_list_length.37(%struct.aws_array_list* noalias nocapture readonly %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  %2 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 2
  %3 = load i32, i32* %2, align 4, !tbaa !8
  %4 = icmp eq i32 %3, 0
...
define internal fastcc void @aws_secure_zero(i8* %0, i32 %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #14
  call void @llvm.memset.p0i8.i32(i8* align 1 %0, i8 0, i32 %1, i1 false) #14
  tail call void asm sideeffect "", "r,~{memory},~{dirflag},~{fpsr},~{flags}"(i8* %0) #14, !srcloc !72
  ret void
}
...
1:                                                ; preds = %0
  ...
  tail call void @seahorn.fn.enter() #14
  %2 = load %struct.aws_error_info*, %struct.aws_error_info** getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 0), align 8, !tbaa !47
...
5:                                                ; preds = %1
  %6 = load i16, i16* getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 1), align 4, !tbaa !44
  %7 = icmp eq i16 %6, 0
  br i1 %7, label %8, label %9
...
14:                                               ; preds = %9
  %15 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !26
  %16 = tail call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %15, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5.19, i32 0, i32 0), i32 %12) #14
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6.20, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.16, i32 0, i32 0), i32 144) #16
  unreachable
...
aws_register_error_info.exit:                     ; preds = %9
  ...
  store volatile %struct.aws_error_info_list* @s_list, %struct.aws_error_info_list** %17, align 4, !tbaa !26
  tail call void @aws_register_log_subject_info_list(%struct.aws_log_subject_info_list* nonnull @s_common_log_subject_list) #14
  tail call void @aws_thread_initialize_thread_management() #14
  %18 = tail call i8* @dlopen(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.40, i32 0, i32 0), i32 4) #14
  store i8* %18, i8** @g_libnuma_handle, align 4, !tbaa !26
  %19 = icmp eq i8* %18, null
  br i1 %19, label %20, label %.thread1

20:                                               ; preds = %aws_register_error_info.exit
  %21 = tail call i8* @dlopen(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1.41, i32 0, i32 0), i32 4) #14
  store i8* %21, i8** @g_libnuma_handle, align 4, !tbaa !26
  %22 = icmp eq i8* %21, null
  br i1 %22, label %25, label %.thread1

.thread1:                                         ; preds = %20, %aws_register_error_info.exit
  %23 = tail call %struct.aws_logger* @aws_logger_get() #14
  %24 = icmp eq %struct.aws_logger* %23, null
  br i1 %24, label %44, label %31

25:                                               ; preds = %20
  %26 = tail call i8* @dlopen(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2.42, i32 0, i32 0), i32 4) #14
  store i8* %26, i8** @g_libnuma_handle, align 4, !tbaa !26
  %27 = icmp eq i8* %26, null
  %28 = tail call %struct.aws_logger* @aws_logger_get() #14
...
31:                                               ; preds = %.thread1, %30
  ...
  %34 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %33, align 4, !tbaa !73
  %35 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %34, i32 0, i32 1
  %36 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %35, align 4, !tbaa !75
  %37 = tail call i32 %36(%struct.aws_logger* nonnull %32, i32 0) #14
  %38 = icmp ugt i32 %37, 3
  br i1 %38, label %39, label %44

39:                                               ; preds = %31
  %40 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %33, align 4, !tbaa !73
  %41 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %40, i32 0, i32 0
  %42 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %41, align 4, !tbaa !77
  %43 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %42(%struct.aws_logger* nonnull %32, i32 4, i32 0, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3.43, i32 0, i32 0)) #14
  br label %44

44:                                               ; preds = %.thread1, %39, %31, %30
  %45 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !26
  %46 = tail call i8* @dlsym(i8* %45, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4.44, i32 0, i32 0)) #14
  store i8* %46, i8** bitcast (i32 (i32, i32*, i32)** @g_set_mempolicy_ptr to i8**), align 4, !tbaa !26
  %47 = icmp eq i8* %46, null
  %48 = tail call %struct.aws_logger* @aws_logger_get() #14
...
51:                                               ; preds = %50
  ...
  %53 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %52, align 4, !tbaa !73
  %54 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %53, i32 0, i32 1
  %55 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %54, align 4, !tbaa !75
  %56 = tail call i32 %55(%struct.aws_logger* nonnull %48, i32 0) #14
  %57 = icmp ugt i32 %56, 3
  br i1 %57, label %58, label %76

58:                                               ; preds = %51
  %59 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %52, align 4, !tbaa !73
  %60 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %59, i32 0, i32 0
  %61 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %60, align 4, !tbaa !77
  %62 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %61(%struct.aws_logger* nonnull %48, i32 4, i32 0, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.5.45, i32 0, i32 0)) #14
  br label %76
...
64:                                               ; preds = %63
  ...
  %66 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %65, align 4, !tbaa !73
  %67 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %66, i32 0, i32 1
  %68 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %67, align 4, !tbaa !75
  %69 = tail call i32 %68(%struct.aws_logger* nonnull %48, i32 0) #14
  %70 = icmp ugt i32 %69, 3
  br i1 %70, label %71, label %76

71:                                               ; preds = %64
  %72 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %65, align 4, !tbaa !73
  %73 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %72, i32 0, i32 0
  %74 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %73, align 4, !tbaa !77
  %75 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %74(%struct.aws_logger* nonnull %48, i32 4, i32 0, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.6.46, i32 0, i32 0)) #14
  br label %76

76:                                               ; preds = %71, %64, %63, %58, %51, %50
  %77 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !26
  %78 = tail call i8* @dlsym(i8* %77, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.7.47, i32 0, i32 0)) #14
  store i8* %78, i8** bitcast (i32 ()** @g_numa_available_ptr to i8**), align 4, !tbaa !26
  %79 = icmp eq i8* %78, null
  %80 = tail call %struct.aws_logger* @aws_logger_get() #14
...
83:                                               ; preds = %82
  ...
  %85 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %84, align 4, !tbaa !73
  %86 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %85, i32 0, i32 1
  %87 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %86, align 4, !tbaa !75
  %88 = tail call i32 %87(%struct.aws_logger* nonnull %80, i32 0) #14
  %89 = icmp ugt i32 %88, 3
  br i1 %89, label %90, label %108

90:                                               ; preds = %83
  %91 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %84, align 4, !tbaa !73
  %92 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %91, i32 0, i32 0
  %93 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %92, align 4, !tbaa !77
  %94 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %93(%struct.aws_logger* nonnull %80, i32 4, i32 0, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.8.48, i32 0, i32 0)) #14
  br label %108
...
96:                                               ; preds = %95
  ...
  %98 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %97, align 4, !tbaa !73
  %99 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %98, i32 0, i32 1
  %100 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %99, align 4, !tbaa !75
  %101 = tail call i32 %100(%struct.aws_logger* nonnull %80, i32 0) #14
  %102 = icmp ugt i32 %101, 3
  br i1 %102, label %103, label %108

103:                                              ; preds = %96
  %104 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %97, align 4, !tbaa !73
  %105 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %104, i32 0, i32 0
  %106 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %105, align 4, !tbaa !77
  %107 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %106(%struct.aws_logger* nonnull %80, i32 4, i32 0, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.9.49, i32 0, i32 0)) #14
  br label %108

108:                                              ; preds = %103, %96, %95, %90, %83, %82
  %109 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !26
  %110 = tail call i8* @dlsym(i8* %109, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.10, i32 0, i32 0)) #14
  store i8* %110, i8** bitcast (i32 ()** @g_numa_num_configured_nodes_ptr to i8**), align 4, !tbaa !26
  %111 = icmp eq i8* %110, null
  %112 = tail call %struct.aws_logger* @aws_logger_get() #14
...
115:                                              ; preds = %114
  ...
  %117 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %116, align 4, !tbaa !73
  %118 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %117, i32 0, i32 1
  %119 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %118, align 4, !tbaa !75
  %120 = tail call i32 %119(%struct.aws_logger* nonnull %112, i32 0) #14
  %121 = icmp ugt i32 %120, 3
  br i1 %121, label %122, label %140

122:                                              ; preds = %115
  %123 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %116, align 4, !tbaa !73
  %124 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %123, i32 0, i32 0
  %125 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %124, align 4, !tbaa !77
  %126 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %125(%struct.aws_logger* nonnull %112, i32 4, i32 0, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.11, i32 0, i32 0)) #14
  br label %140
...
128:                                              ; preds = %127
  ...
  %130 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %129, align 4, !tbaa !73
  %131 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %130, i32 0, i32 1
  %132 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %131, align 4, !tbaa !75
  %133 = tail call i32 %132(%struct.aws_logger* nonnull %112, i32 0) #14
  %134 = icmp ugt i32 %133, 3
  br i1 %134, label %135, label %140

135:                                              ; preds = %128
  %136 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %129, align 4, !tbaa !73
  %137 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %136, i32 0, i32 0
  %138 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %137, align 4, !tbaa !77
  %139 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %138(%struct.aws_logger* nonnull %112, i32 4, i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.12.50, i32 0, i32 0)) #14
  br label %140

140:                                              ; preds = %135, %128, %127, %122, %115, %114
  %141 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !26
  %142 = tail call i8* @dlsym(i8* %141, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.13, i32 0, i32 0)) #14
  store i8* %142, i8** bitcast (i32 ()** @g_numa_num_possible_cpus_ptr to i8**), align 4, !tbaa !26
  %143 = icmp eq i8* %142, null
  %144 = tail call %struct.aws_logger* @aws_logger_get() #14
...
147:                                              ; preds = %146
  ...
  %149 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %148, align 4, !tbaa !73
  %150 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %149, i32 0, i32 1
  %151 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %150, align 4, !tbaa !75
  %152 = tail call i32 %151(%struct.aws_logger* nonnull %144, i32 0) #14
  %153 = icmp ugt i32 %152, 3
  br i1 %153, label %154, label %172

154:                                              ; preds = %147
  %155 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %148, align 4, !tbaa !73
  %156 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %155, i32 0, i32 0
  %157 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %156, align 4, !tbaa !77
  %158 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %157(%struct.aws_logger* nonnull %144, i32 4, i32 0, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.14, i32 0, i32 0)) #14
  br label %172
...
160:                                              ; preds = %159
  ...
  %162 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %161, align 4, !tbaa !73
  %163 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %162, i32 0, i32 1
  %164 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %163, align 4, !tbaa !75
  %165 = tail call i32 %164(%struct.aws_logger* nonnull %144, i32 0) #14
  %166 = icmp ugt i32 %165, 3
  br i1 %166, label %167, label %172

167:                                              ; preds = %160
  %168 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %161, align 4, !tbaa !73
  %169 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %168, i32 0, i32 0
  %170 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %169, align 4, !tbaa !77
  %171 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %170(%struct.aws_logger* nonnull %144, i32 4, i32 0, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.15, i32 0, i32 0)) #14
  br label %172

172:                                              ; preds = %167, %160, %159, %154, %147, %146
  %173 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !26
  %174 = tail call i8* @dlsym(i8* %173, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.16, i32 0, i32 0)) #14
  store i8* %174, i8** bitcast (i32 (i32)** @g_numa_node_of_cpu_ptr to i8**), align 4, !tbaa !26
  %175 = icmp eq i8* %174, null
  %176 = tail call %struct.aws_logger* @aws_logger_get() #14
...
179:                                              ; preds = %178
  ...
  %181 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %180, align 4, !tbaa !73
  %182 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %181, i32 0, i32 1
  %183 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %182, align 4, !tbaa !75
  %184 = tail call i32 %183(%struct.aws_logger* nonnull %176, i32 0) #14
  %185 = icmp ugt i32 %184, 3
  br i1 %185, label %186, label %217

186:                                              ; preds = %179
  %187 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %180, align 4, !tbaa !73
  %188 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %187, i32 0, i32 0
  %189 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %188, align 4, !tbaa !77
  %190 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %189(%struct.aws_logger* nonnull %176, i32 4, i32 0, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.17, i32 0, i32 0)) #14
  br label %217
...
192:                                              ; preds = %191
  ...
  %194 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %193, align 4, !tbaa !73
  %195 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %194, i32 0, i32 1
  %196 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %195, align 4, !tbaa !75
  %197 = tail call i32 %196(%struct.aws_logger* nonnull %176, i32 0) #14
  %198 = icmp ugt i32 %197, 3
  br i1 %198, label %199, label %217

199:                                              ; preds = %192
  %200 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %193, align 4, !tbaa !73
  %201 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %200, i32 0, i32 0
  %202 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %201, align 4, !tbaa !77
  %203 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %202(%struct.aws_logger* nonnull %176, i32 4, i32 0, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.18, i32 0, i32 0)) #14
  br label %217
...
205:                                              ; preds = %204
  ...
  %207 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %206, align 4, !tbaa !73
  %208 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %207, i32 0, i32 1
  %209 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %208, align 4, !tbaa !75
  %210 = tail call i32 %209(%struct.aws_logger* nonnull %28, i32 0) #14
  %211 = icmp ugt i32 %210, 3
  br i1 %211, label %212, label %217

212:                                              ; preds = %205
  %213 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %206, align 4, !tbaa !73
  %214 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %213, i32 0, i32 0
  %215 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %214, align 4, !tbaa !77
  %216 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %215(%struct.aws_logger* nonnull %28, i32 4, i32 0, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.19, i32 0, i32 0)) #14
  br label %217
...
1:                                                ; preds = %0
  ...
  %2 = tail call i32 @aws_thread_join_all_managed() #14
  tail call void @seahorn.fn.enter() #14
  %3 = load %struct.aws_error_info*, %struct.aws_error_info** getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 0), align 8, !tbaa !47
...
6:                                                ; preds = %1
  %7 = load i16, i16* getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 1), align 4, !tbaa !44
  %8 = icmp eq i16 %7, 0
  br i1 %8, label %9, label %10
...
15:                                               ; preds = %10
  %16 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !26
  %17 = tail call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %16, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5.19, i32 0, i32 0), i32 %13) #14
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7.21, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.16, i32 0, i32 0), i32 178) #16
  unreachable
...
aws_unregister_error_info.exit:                   ; preds = %10
  ...
  store volatile %struct.aws_error_info_list* null, %struct.aws_error_info_list** %18, align 4, !tbaa !26
  tail call void @aws_unregister_log_subject_info_list(%struct.aws_log_subject_info_list* nonnull @s_common_log_subject_list) #14
  %19 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !26
  %20 = icmp eq i8* %19, null
  br i1 %20, label %23, label %21

21:                                               ; preds = %aws_unregister_error_info.exit
  %22 = tail call i32 @dlclose(i8* nonnull %19) #14
  br label %23
...
1:                                                ; preds = %0
  %2 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !26
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_array_list_set_at_harness()
  ...
  %6 = tail call fastcc i32 @aws_array_list_set_at(%struct.aws_array_list* %3, i8* %4, i32 %5)
  %7 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %8 = tail call fastcc i32 @aws_array_list_length(%struct.aws_array_list* %7)
  %9 = tail call i32 @verifier.nondet.3()
  %10 = tail call i32 @verifier.nondet.3()
  %11 = tail call i32* @verifier.nondet.4()
  %12 = tail call fastcc i32 @aws_add_size_checked(i32 %9, i32 %10, i32* %11)
  %13 = tail call i32 @verifier.nondet.3()
  %14 = tail call i32 @verifier.nondet.3()
  %15 = tail call i32* @verifier.nondet.4()
  %16 = tail call fastcc i32 @aws_add_u32_checked(i32 %13, i32 %14, i32* %15)
  %17 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error(i32 %17)
  ...
  %23 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked(i32 %21, i32 %22, i32* %23)
  %24 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_allocator_is_valid(%struct.aws_allocator* %24)
  tail call fastcc void @aws_default_allocator()
  %25 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %26 = tail call i32 @verifier.nondet.3()
  %27 = tail call i8* @s_default_malloc(%struct.aws_allocator* %25, i32 %26)
  %28 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %29 = tail call i8* @verifier.nondet.2()
  tail call void @s_default_free(%struct.aws_allocator* %28, i8* %29)
  %30 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %31 = tail call i8* @verifier.nondet.2()
  %32 = tail call i32 @verifier.nondet.3()
  %33 = tail call i32 @verifier.nondet.3()
  %34 = tail call i8* @s_default_realloc(%struct.aws_allocator* %30, i8* %31, i32 %32, i32 %33)
  %35 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %36 = tail call i32 @verifier.nondet.3()
  %37 = tail call i32 @verifier.nondet.3()
  %38 = tail call i8* @s_default_calloc(%struct.aws_allocator* %35, i32 %36, i32 %37)
  %39 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %40 = tail call i32 @verifier.nondet.3()
  %41 = tail call fastcc i8* @aws_mem_acquire(%struct.aws_allocator* %39, i32 %40)
  %42 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.8(i32 %42)
  %43 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %44 = tail call i32 @verifier.nondet.3()
  %45 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_mem_calloc(%struct.aws_allocator* %43, i32 %44, i32 %45)
  %46 = tail call i32 @verifier.nondet.3()
  %47 = tail call i32 @verifier.nondet.3()
  %48 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked.10(i32 %46, i32 %47, i32* %48)
  %49 = tail call i32 @verifier.nondet.3()
  %50 = tail call i32 @verifier.nondet.3()
  %51 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked.11(i32 %49, i32 %50, i32* %51)
  %52 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %53 = tail call i32 @verifier.nondet.3()
  %54 = tail call i8* (%struct.aws_allocator*, i32, ...) @aws_mem_acquire_many(%struct.aws_allocator* %52, i32 %53)
  %55 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %56 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_mem_release(%struct.aws_allocator* %55, i8* %56)
  %57 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %58 = tail call i8** @verifier.nondet.6()
  %59 = tail call i32 @verifier.nondet.3()
  %60 = tail call i32 @verifier.nondet.3()
  %61 = tail call fastcc i32 @aws_mem_realloc(%struct.aws_allocator* %57, i8** %58, i32 %59, i32 %60)
  %62 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %62)
  %63 = tail call i8* @verifier.nondet.2()
  %64 = tail call i32 @verifier.nondet.3()
  %65 = tail call i32 @verifier.nondet.3()
  %66 = tail call i8* @verifier.nondet.2()
  %67 = tail call i8* @s_cf_allocator_reallocate(i8* %63, i32 %64, i32 %65, i8* %66)
  %68 = tail call i8* @verifier.nondet.2()
  %69 = tail call %struct.__CFString* @s_cf_allocator_copy_description(i8* %68)
  %70 = tail call i32 @verifier.nondet.3()
  %71 = tail call i32 @verifier.nondet.3()
  %72 = tail call i8* @verifier.nondet.2()
  %73 = tail call i8* @s_cf_allocator_allocate(i32 %70, i32 %71, i8* %72)
  %74 = tail call i8* @verifier.nondet.2()
  %75 = tail call i8* @verifier.nondet.2()
  tail call void @s_cf_allocator_deallocate(i8* %74, i8* %75)
  %76 = tail call i32 @verifier.nondet.3()
  %77 = tail call i32 @verifier.nondet.3()
  %78 = tail call i8* @verifier.nondet.2()
  %79 = tail call i32 @s_cf_allocator_preferred_size(i32 %76, i32 %77, i8* %78)
  %80 = tail call %struct.__CFAllocator* @verifier.nondet.7()
  tail call fastcc void @aws_wrapped_cf_allocator_destroy(%struct.__CFAllocator* %80)
  ...
  %89 = tail call void (i32, i8*)* @verifier.nondet.8()
  %90 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %89, i8* %90)
  %91 = tail call void (i32, i8*)* @verifier.nondet.8()
  %92 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %91, i8* %92)
  %93 = tail call %struct.aws_error_info_list* @verifier.nondet.9()
  tail call fastcc void @aws_register_error_info(%struct.aws_error_info_list* %93)
  %94 = tail call %struct.aws_error_info_list* @verifier.nondet.9()
  ...
  tail call fastcc void @aws_raise_error.22(i32 %96)
  %97 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %98 = tail call i32 @verifier.nondet.3()
  %99 = tail call i32* @verifier.nondet.4()
  %100 = tail call fastcc i32 @aws_array_list_calc_necessary_size(%struct.aws_array_list* %97, i32 %98, i32* %99)
  %101 = tail call i32 @verifier.nondet.3()
  %102 = tail call i32 @verifier.nondet.3()
  %103 = tail call i32* @verifier.nondet.4()
  %104 = tail call fastcc i32 @aws_add_size_checked.23(i32 %101, i32 %102, i32* %103)
  %105 = tail call i32 @verifier.nondet.3()
  %106 = tail call i32 @verifier.nondet.3()
  %107 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked.24(i32 %105, i32 %106, i32* %107)
  %108 = tail call i32 @verifier.nondet.3()
  %109 = tail call i32 @verifier.nondet.3()
  %110 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked.25(i32 %108, i32 %109, i32* %110)
  %111 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.26(i32 %111)
  %112 = tail call i32 @verifier.nondet.3()
  %113 = tail call i32 @verifier.nondet.3()
  %114 = tail call i32* @verifier.nondet.4()
  %115 = tail call fastcc i32 @aws_add_u32_checked.27(i32 %112, i32 %113, i32* %114)
  %116 = tail call %struct.aws_array_list* @verifier.nondet.1()
  tail call fastcc void @aws_array_list_shrink_to_fit(%struct.aws_array_list* %116)
  %117 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %118 = tail call %struct.aws_array_list* @verifier.nondet.1()
  tail call fastcc void @aws_array_list_copy(%struct.aws_array_list* %117, %struct.aws_array_list* %118)
  %119 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %120 = tail call i32 @verifier.nondet.3()
  %121 = tail call fastcc i32 @aws_array_list_ensure_capacity(%struct.aws_array_list* %119, i32 %120)
  %122 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %123 = tail call i32 @verifier.nondet.3()
  %124 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_swap(%struct.aws_array_list* %122, i32 %123, i32 %124)
  %125 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %126 = tail call i8** @verifier.nondet.6()
  %127 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_get_at_ptr(%struct.aws_array_list* %125, i8** %126, i32 %127)
  %128 = tail call i8* @verifier.nondet.2()
  %129 = tail call i8* @verifier.nondet.2()
  %130 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_mem_swap(i8* %128, i8* %129, i32 %130)
  %131 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %132 = tail call fastcc i32 @aws_array_list_length.37(%struct.aws_array_list* %131)
  %133 = tail call i8* @verifier.nondet.2()
  %134 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_secure_zero(i8* %133, i32 %134)
  %135 = tail call %struct.aws_allocator* @verifier.nondet.5()
...
attributes #5 = { nofree nounwind allocsize(0) "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
attributes #8 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!16 = !{!9, !10, i64 16}
!17 = !{!18}
!18 = distinct !{!18, !19, !"aws_array_list_is_valid: argument 0"}
!19 = distinct !{!19, !"aws_array_list_is_valid"}
!20 = !{!21}
!21 = distinct !{!21, !22, !"aws_array_list_is_valid: argument 0"}
!22 = distinct !{!22, !"aws_array_list_is_valid"}
!23 = !{!24}
...
!28 = !{!"int", !11, i64 0}
!29 = !{!30, !10, i64 0}
!30 = !{!"aws_allocator", !10, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16}
!31 = !{!30, !10, i64 12}
!32 = !{!30, !10, i64 4}
!33 = !{!30, !10, i64 8}
!34 = !{!35, !13, i64 0}
!35 = !{!"", !13, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16, !10, i64 20, !10, i64 24, !10, i64 28, !10, i64 32}
!36 = !{!35, !10, i64 4}
!37 = !{!35, !10, i64 8}
!38 = !{!35, !10, i64 12}
!39 = !{!35, !10, i64 16}
...
!43 = !{!35, !10, i64 32}
!44 = !{!45, !46, i64 4}
!45 = !{!"aws_error_info_list", !10, i64 0, !46, i64 4}
!46 = !{!"short", !11, i64 0}
!47 = !{!45, !10, i64 0}
!48 = !{!49, !28, i64 0}
!49 = !{!"aws_error_info", !28, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16}
!50 = !{!13, !13, i64 0}
!51 = !{!9, !10, i64 0}
!52 = !{!53}
!53 = distinct !{!53, !54, !"aws_array_list_calc_necessary_size: argument 0"}
!54 = distinct !{!54, !"aws_array_list_calc_necessary_size"}
!55 = !{!56}
!56 = distinct !{!56, !57, !"aws_array_list_get_at_ptr: argument 0"}
!57 = distinct !{!57, !"aws_array_list_get_at_ptr"}
!58 = !{!59, !56}
!59 = distinct !{!59, !60, !"aws_array_list_length.37: argument 0"}
!60 = distinct !{!60, !"aws_array_list_length.37"}
!61 = !{!62}
!62 = distinct !{!62, !63, !"aws_array_list_get_at_ptr: argument 0"}
!63 = distinct !{!63, !"aws_array_list_get_at_ptr"}
!64 = !{!65, !62}
!65 = distinct !{!65, !66, !"aws_array_list_length.37: argument 0"}
!66 = distinct !{!66, !"aws_array_list_length.37"}
!67 = !{!68}
!68 = distinct !{!68, !69, !"aws_array_list_length.37: argument 0"}
!69 = distinct !{!69, !"aws_array_list_length.37"}
!70 = distinct !{!70, !71}
!71 = !{!"llvm.loop.unroll.disable"}
!72 = !{i32 1682}
!73 = !{!74, !10, i64 0}
!74 = !{!"aws_logger", !10, i64 0, !10, i64 4, !10, i64 8}
!75 = !{!76, !10, i64 4}
!76 = !{!"aws_logger_vtable", !10, i64 0, !10, i64 4, !10, i64 8, !10, i64 12}
!77 = !{!76, !10, i64 0}
