; ModuleID = '../out2/aws_mul_size_checked_harness.c/aws_mul_size_checked_harnessa3062.bc.txt'
...
define internal fastcc void @aws_mul_size_checked_harness() unnamed_addr #0 {
  tail call void @seahorn.fn.enter() #10
  %1 = tail call zeroext i1 bitcast (i1 (...)* @nondet_bool to i1 ()*)() #10
  br i1 %1, label %2, label %6

2:                                                ; preds = %0
  %3 = tail call i32 bitcast (i32 (...)* @nondet_int to i32 ()*)() #10
...
6:                                                ; preds = %0
  ...
  %8 = tail call i32 bitcast (i32 (...)* @nondet_uint32_t to i32 ()*)() #10
  %9 = tail call i32 bitcast (i32 (...)* @nondet_uint32_t to i32 ()*)() #10
  tail call void @seahorn.fn.enter() #10
  br label %10
...
declare i32 @nondet_int(...) local_unnamed_addr #1
...
14:                                               ; preds = %9
  %15 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !11
...
aws_register_error_info.exit:                     ; preds = %9
  ...
  store volatile %struct.aws_error_info_list* @s_list, %struct.aws_error_info_list** %17, align 4, !tbaa !11
  ...
  store i8* %18, i8** @g_libnuma_handle, align 4, !tbaa !11
...
20:                                               ; preds = %aws_register_error_info.exit
  ...
  store i8* %21, i8** @g_libnuma_handle, align 4, !tbaa !11
...
25:                                               ; preds = %20
  ...
  store i8* %26, i8** @g_libnuma_handle, align 4, !tbaa !11
...
44:                                               ; preds = %.thread1, %39, %31, %30
  %45 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !11
  %46 = tail call i8* @dlsym(i8* %45, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4.12, i32 0, i32 0)) #10
  store i8* %46, i8** bitcast (i32 (i32, i32*, i32)** @g_set_mempolicy_ptr to i8**), align 4, !tbaa !11
...
76:                                               ; preds = %71, %64, %63, %58, %51, %50
  %77 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !11
  %78 = tail call i8* @dlsym(i8* %77, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.7.15, i32 0, i32 0)) #10
  store i8* %78, i8** bitcast (i32 ()** @g_numa_available_ptr to i8**), align 4, !tbaa !11
...
108:                                              ; preds = %103, %96, %95, %90, %83, %82
  %109 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !11
  %110 = tail call i8* @dlsym(i8* %109, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.10, i32 0, i32 0)) #10
  store i8* %110, i8** bitcast (i32 ()** @g_numa_num_configured_nodes_ptr to i8**), align 4, !tbaa !11
...
140:                                              ; preds = %135, %128, %127, %122, %115, %114
  %141 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !11
  %142 = tail call i8* @dlsym(i8* %141, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.13, i32 0, i32 0)) #10
  store i8* %142, i8** bitcast (i32 ()** @g_numa_num_possible_cpus_ptr to i8**), align 4, !tbaa !11
...
172:                                              ; preds = %167, %160, %159, %154, %147, %146
  %173 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !11
  %174 = tail call i8* @dlsym(i8* %173, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.16, i32 0, i32 0)) #10
  store i8* %174, i8** bitcast (i32 (i32)** @g_numa_node_of_cpu_ptr to i8**), align 4, !tbaa !11
...
15:                                               ; preds = %10
  %16 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !11
...
aws_unregister_error_info.exit:                   ; preds = %10
  ...
  store volatile %struct.aws_error_info_list* null, %struct.aws_error_info_list** %18, align 4, !tbaa !11
  ...
  %19 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !11
...
1:                                                ; preds = %0
  %2 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !11
...
!13 = !{!14, !15, i64 4}
!14 = !{!"aws_error_info_list", !12, i64 0, !15, i64 4}
!15 = !{!"short", !7, i64 0}
!16 = !{!14, !12, i64 0}
!17 = !{!18, !10, i64 0}
!18 = !{!"aws_error_info", !10, i64 0, !12, i64 4, !12, i64 8, !12, i64 12, !12, i64 16}
!19 = !{i32 1682}
!20 = !{!21, !12, i64 0}
!21 = !{!"aws_logger", !12, i64 0, !12, i64 4, !12, i64 8}
!22 = !{!23, !12, i64 4}
!23 = !{!"aws_logger_vtable", !12, i64 0, !12, i64 4, !12, i64 8, !12, i64 12}
!24 = !{!23, !12, i64 0}
