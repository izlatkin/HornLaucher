; ModuleID = '../out2/s_sift_either_override.c/s_sift_either_override5f456.bc.txt'
...
define internal fastcc void @__CPROVER_file_local_priority_queue_c_s_sift_either(%struct.aws_priority_queue* %0) unnamed_addr #0 {
  %2 = tail call i8 @verifier.nondet.3() #5
  tail call void @seahorn.fn.enter() #5
  %3 = tail call zeroext i1 @aws_priority_queue_is_valid(%struct.aws_priority_queue* %0) #5
  ret void
}
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @__CPROVER_file_local_priority_queue_c_s_sift_either(%struct.aws_priority_queue* %1)
  ret i32 42
}
