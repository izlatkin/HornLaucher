; ModuleID = '../out2/aws_array_list_capacity_harness.c/aws_array_list_capacity_harness26cf4.bc.txt'
...
@.str.1 = private unnamed_addr constant [16 x i8] c"list->item_size\00", align 1
...
define internal fastcc void @aws_array_list_capacity_harness() unnamed_addr #1 {
...
aws_array_list_is_valid.exit:                     ; preds = %17, %.thread.i
  ...
  %25 = bitcast %struct.aws_array_list* %2 to i8*
  ...
  %26 = bitcast %struct.store_byte_from_buffer* %3 to i8*
  ...
  %28 = icmp eq i32 %27, 0
  br i1 %28, label %29, label %aws_array_list_capacity.exit

29:                                               ; preds = %aws_array_list_is_valid.exit
  call void @aws_fatal_assert(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.32, i32 0, i32 0), i32 299) #14, !noalias !17
  unreachable

aws_array_list_capacity.exit:                     ; preds = %aws_array_list_is_valid.exit
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_array_list_capacity(%struct.aws_array_list* noalias nocapture readonly %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #13
  %2 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 3
  %3 = load i32, i32* %2, align 4, !tbaa !14
  %4 = icmp eq i32 %3, 0
  br i1 %4, label %5, label %6

5:                                                ; preds = %1
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.32, i32 0, i32 0), i32 299) #14
  unreachable
...
17:                                               ; preds = %13
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.31, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.32, i32 0, i32 0), i32 312) #14, !noalias !55
  unreachable
...
11:                                               ; preds = %7
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.31, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.32, i32 0, i32 0), i32 312) #14, !noalias !64
  unreachable
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_array_list_capacity_harness()
  ...
  tail call fastcc void @aws_array_list_capacity(%struct.aws_array_list* %3)
  ...
  %118 = tail call fastcc i32 @aws_array_list_length(%struct.aws_array_list* %117)
...
!16 = !{!9, !10, i64 16}
!17 = !{!18}
!18 = distinct !{!18, !19, !"aws_array_list_capacity: argument 0"}
!19 = distinct !{!19, !"aws_array_list_capacity"}
!20 = !{!21}
...
!55 = !{!56, !53}
!56 = distinct !{!56, !57, !"aws_array_list_length: argument 0"}
!57 = distinct !{!57, !"aws_array_list_length"}
!58 = !{!59}
