; ModuleID = '../out2/aws_linked_list_end_harness.c/aws_linked_list_end_harness3f736.bc.txt'
...
define internal fastcc void @aws_linked_list_end_harness() unnamed_addr #1 {
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_end(%struct.aws_linked_list* nocapture readnone %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  ret void
}
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_end_harness()
  ...
  tail call fastcc void @aws_linked_list_end(%struct.aws_linked_list* %3)
