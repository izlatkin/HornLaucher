; ModuleID = '../out2/aws_linked_list_push_front_harness.c/aws_linked_list_push_front_harness8eaf3.bc.txt'
...
define internal fastcc void @aws_linked_list_push_front_harness() unnamed_addr #1 {
  ...
  %4 = bitcast %struct.aws_linked_list_node* %2 to i8*
  ...
  %6 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %5, align 4, !tbaa !5
  call void @seahorn.fn.enter() #12
  %7 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %2, i32 0, i32 0
  store %struct.aws_linked_list_node* %6, %struct.aws_linked_list_node** %7, align 4, !tbaa !11
  %8 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %6, i32 0, i32 1
  %9 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %8, align 4, !tbaa !12
  %10 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %2, i32 0, i32 1
  store %struct.aws_linked_list_node* %9, %struct.aws_linked_list_node** %10, align 4, !tbaa !12
  %11 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %8, align 4, !tbaa !12
  %12 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %11, i32 0, i32 0
  store %struct.aws_linked_list_node* %2, %struct.aws_linked_list_node** %12, align 4, !tbaa !11
  store %struct.aws_linked_list_node* %2, %struct.aws_linked_list_node** %8, align 4, !tbaa !12
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
  call void @seahorn.fn.enter() #12
...
define internal fastcc void @aws_linked_list_push_front(%struct.aws_linked_list* nocapture readonly %0, %struct.aws_linked_list_node* %1) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  ...
  tail call void @seahorn.fn.enter() #12
  %5 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %1, i32 0, i32 0
  store %struct.aws_linked_list_node* %4, %struct.aws_linked_list_node** %5, align 4, !tbaa !11
  %6 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %4, i32 0, i32 1
  ...
  store %struct.aws_linked_list_node* %7, %struct.aws_linked_list_node** %8, align 4, !tbaa !12
  %9 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %6, align 4, !tbaa !12
  %10 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %9, i32 0, i32 0
  store %struct.aws_linked_list_node* %1, %struct.aws_linked_list_node** %10, align 4, !tbaa !11
  store %struct.aws_linked_list_node* %1, %struct.aws_linked_list_node** %6, align 4, !tbaa !12
  ret void
}
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_node_prev_is_valid(%struct.aws_linked_list_node* nocapture readnone %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  ret void
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* nocapture readnone %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  ret void
}
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_linked_list_insert_before(%struct.aws_linked_list_node* %0, %struct.aws_linked_list_node* %1) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #12
  %3 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %1, i32 0, i32 0
  store %struct.aws_linked_list_node* %0, %struct.aws_linked_list_node** %3, align 4, !tbaa !11
  ...
  %7 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %4, align 4, !tbaa !12
  %8 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %7, i32 0, i32 0
  store %struct.aws_linked_list_node* %1, %struct.aws_linked_list_node** %8, align 4, !tbaa !11
  store %struct.aws_linked_list_node* %1, %struct.aws_linked_list_node** %4, align 4, !tbaa !12
  ret void
}
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_linked_list_push_front_harness()
  %1 = tail call %struct.aws_linked_list* @verifier.nondet.1()
  %2 = tail call %struct.aws_linked_list_node* @verifier.nondet.2()
  tail call fastcc void @aws_linked_list_push_front(%struct.aws_linked_list* %1, %struct.aws_linked_list_node* %2)
  ...
  %4 = tail call %struct.aws_linked_list_node* @verifier.nondet.2()
  tail call fastcc void @aws_linked_list_node_prev_is_valid(%struct.aws_linked_list_node* %4)
  %5 = tail call %struct.aws_linked_list_node* @verifier.nondet.2()
  tail call fastcc void @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* %5)
  %6 = tail call %struct.aws_linked_list_node* @verifier.nondet.2()
  %7 = tail call %struct.aws_linked_list_node* @verifier.nondet.2()
  tail call fastcc void @aws_linked_list_insert_before(%struct.aws_linked_list_node* %6, %struct.aws_linked_list_node* %7)
  %8 = tail call %struct.aws_allocator* @verifier.nondet.3()
  tail call fastcc void @aws_allocator_is_valid(%struct.aws_allocator* %8)
  ...
  %11 = tail call i8* @s_default_malloc(%struct.aws_allocator* %9, i32 %10)
  %12 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %13 = tail call i8* @verifier.nondet.5()
  tail call void @s_default_free(%struct.aws_allocator* %12, i8* %13)
  %14 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %15 = tail call i8* @verifier.nondet.5()
  %16 = tail call i32 @verifier.nondet.4()
  %17 = tail call i32 @verifier.nondet.4()
  %18 = tail call i8* @s_default_realloc(%struct.aws_allocator* %14, i8* %15, i32 %16, i32 %17)
  %19 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %20 = tail call i32 @verifier.nondet.4()
  %21 = tail call i32 @verifier.nondet.4()
  %22 = tail call i8* @s_default_calloc(%struct.aws_allocator* %19, i32 %20, i32 %21)
  %23 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %24 = tail call i32 @verifier.nondet.4()
  %25 = tail call fastcc i8* @aws_mem_acquire(%struct.aws_allocator* %23, i32 %24)
  %26 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_raise_error(i32 %26)
  %27 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %28 = tail call i32 @verifier.nondet.4()
  %29 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_mem_calloc(%struct.aws_allocator* %27, i32 %28, i32 %29)
  %30 = tail call i32 @verifier.nondet.4()
  %31 = tail call i32 @verifier.nondet.4()
  %32 = tail call i32* @verifier.nondet.6()
  tail call fastcc void @aws_mul_size_checked(i32 %30, i32 %31, i32* %32)
  %33 = tail call i32 @verifier.nondet.4()
  %34 = tail call i32 @verifier.nondet.4()
  %35 = tail call i32* @verifier.nondet.6()
  tail call fastcc void @aws_mul_u32_checked(i32 %33, i32 %34, i32* %35)
  %36 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %37 = tail call i32 @verifier.nondet.4()
  %38 = tail call i8* (%struct.aws_allocator*, i32, ...) @aws_mem_acquire_many(%struct.aws_allocator* %36, i32 %37)
  %39 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %40 = tail call i8* @verifier.nondet.5()
  tail call fastcc void @aws_mem_release(%struct.aws_allocator* %39, i8* %40)
  %41 = tail call %struct.aws_allocator* @verifier.nondet.3()
  %42 = tail call i8** @verifier.nondet.7()
  %43 = tail call i32 @verifier.nondet.4()
  %44 = tail call i32 @verifier.nondet.4()
  %45 = tail call fastcc i32 @aws_mem_realloc(%struct.aws_allocator* %41, i8** %42, i32 %43, i32 %44)
  %46 = tail call %struct.aws_allocator* @verifier.nondet.3()
  tail call fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %46)
  %47 = tail call i8* @verifier.nondet.5()
  %48 = tail call i32 @verifier.nondet.4()
  %49 = tail call i32 @verifier.nondet.4()
  %50 = tail call i8* @verifier.nondet.5()
  %51 = tail call i8* @s_cf_allocator_reallocate(i8* %47, i32 %48, i32 %49, i8* %50)
  %52 = tail call i8* @verifier.nondet.5()
  %53 = tail call %struct.__CFString* @s_cf_allocator_copy_description(i8* %52)
  %54 = tail call i32 @verifier.nondet.4()
  %55 = tail call i32 @verifier.nondet.4()
  %56 = tail call i8* @verifier.nondet.5()
  %57 = tail call i8* @s_cf_allocator_allocate(i32 %54, i32 %55, i8* %56)
  %58 = tail call i8* @verifier.nondet.5()
  %59 = tail call i8* @verifier.nondet.5()
  tail call void @s_cf_allocator_deallocate(i8* %58, i8* %59)
  %60 = tail call i32 @verifier.nondet.4()
  %61 = tail call i32 @verifier.nondet.4()
  %62 = tail call i8* @verifier.nondet.5()
  %63 = tail call i32 @s_cf_allocator_preferred_size(i32 %60, i32 %61, i8* %62)
  %64 = tail call %struct.__CFAllocator* @verifier.nondet.8()
  tail call fastcc void @aws_wrapped_cf_allocator_destroy(%struct.__CFAllocator* %64)
  tail call fastcc void @aws_last_error()
  %65 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_error_str(i32 %65)
  %66 = tail call i32 @verifier.nondet.4()
  %67 = tail call fastcc %struct.aws_error_info* @get_error_by_code(i32 %66)
  %68 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_error_name(i32 %68)
  %69 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_error_lib_name(i32 %69)
  %70 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_error_debug_str(i32 %70)
  %71 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_raise_error_private(i32 %71)
  tail call fastcc void @aws_reset_error()
  %72 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_restore_error(i32 %72)
  %73 = tail call void (i32, i8*)* @verifier.nondet.9()
  %74 = tail call i8* @verifier.nondet.5()
  tail call fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %73, i8* %74)
  %75 = tail call void (i32, i8*)* @verifier.nondet.9()
  %76 = tail call i8* @verifier.nondet.5()
  tail call fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %75, i8* %76)
  %77 = tail call %struct.aws_error_info_list* @verifier.nondet.10()
  tail call fastcc void @aws_register_error_info(%struct.aws_error_info_list* %77)
  %78 = tail call %struct.aws_error_info_list* @verifier.nondet.10()
  tail call fastcc void @aws_unregister_error_info(%struct.aws_error_info_list* %78)
  %79 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_translate_and_raise_io_error(i32 %79)
  %80 = tail call i32 @verifier.nondet.4()
  tail call fastcc void @aws_raise_error.20(i32 %80)
  ret i32 42
}
