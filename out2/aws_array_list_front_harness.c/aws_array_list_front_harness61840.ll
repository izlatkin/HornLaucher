; ModuleID = '../out2/aws_array_list_front_harness.c/aws_array_list_front_harness61840.bc.txt'
...
define internal fastcc void @aws_array_list_front_harness() unnamed_addr #1 {
  ...
  %5 = call zeroext i1 @aws_array_list_is_bounded(%struct.aws_array_list* nonnull %1, i32 0, i32 2) #13
...
aws_array_list_is_valid.exit:                     ; preds = %17, %.thread.i
  ...
  %24 = bitcast %struct.aws_array_list* %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %24) #13
  ...
  %25 = bitcast %struct.store_byte_from_buffer* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %25) #13
  call void @save_byte_from_array(i8* %16, i32 %12, %struct.store_byte_from_buffer* nonnull %3) #13
  call void @seahorn.fn.enter() #13, !noalias !17
  %26 = load i32, i32* %6, align 8, !tbaa !8, !alias.scope !17
  %27 = load i32, i32* %8, align 4, !tbaa !14, !alias.scope !17
  call void @seahorn.fn.enter() #13
  call void @seahorn.fn.enter() #13
  %28 = mul i32 %27, %26
  %29 = load i32, i32* %11, align 4, !tbaa !15, !alias.scope !17
  %30 = icmp uge i32 %29, %28
  %31 = icmp eq i32 %29, 0
  %32 = load i8*, i8** %15, align 8, !tbaa !16, !alias.scope !17
  br i1 %31, label %33, label %35

33:                                               ; preds = %aws_array_list_is_valid.exit
  %34 = icmp eq i8* %32, null
  br i1 %34, label %.thread.i3, label %aws_array_list_is_valid.exit5

35:                                               ; preds = %aws_array_list_is_valid.exit
  %36 = icmp ne i8* %32, null
  br label %.thread.i3

.thread.i3:                                       ; preds = %35, %33
  %37 = phi i1 [ %36, %35 ], [ true, %33 ]
  %or.cond3.i1 = and i1 %30, %37
  %38 = icmp ne i32 %27, 0
  %spec.select.i2 = and i1 %38, %or.cond3.i1
  br label %aws_array_list_is_valid.exit5

aws_array_list_is_valid.exit5:                    ; preds = %33, %.thread.i3
  %39 = phi i1 [ %spec.select.i2, %.thread.i3 ], [ false, %33 ]
  call void @verifier.assume(i1 %39)
...
41:                                               ; preds = %aws_array_list_is_valid.exit5
  %42 = icmp eq i8* %32, null
  br i1 %42, label %43, label %aws_array_list_front.exit
...
44:                                               ; preds = %aws_array_list_is_valid.exit5
  call void @seahorn.fn.enter() #13, !noalias !20
  call void @seahorn.fn.enter() #13, !noalias !20
  %45 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26, !noalias !20
  %46 = icmp eq void (i32, i8*)* %45, null
  br i1 %46, label %49, label %47

47:                                               ; preds = %44
  %48 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26, !noalias !20
  call void %45(i32 25, i8* %48) #13, !noalias !20
  br label %aws_array_list_front.exit

49:                                               ; preds = %44
  %50 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26, !noalias !20
  %51 = icmp eq void (i32, i8*)* %50, null
  br i1 %51, label %aws_array_list_front.exit, label %52

52:                                               ; preds = %49
  %53 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26, !noalias !20
  call void %50(i32 25, i8* %53) #13, !noalias !20
  br label %aws_array_list_front.exit

aws_array_list_front.exit:                        ; preds = %41, %47, %49, %52
  call void @seahorn.fn.enter() #13, !noalias !27
  call void @seahorn.fn.enter() #13
  call void @seahorn.fn.enter() #13
  call void @assert_array_list_equivalence(%struct.aws_array_list* nonnull %1, %struct.aws_array_list* nonnull %2, %struct.store_byte_from_buffer* nonnull %3) #13
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %25) #13
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %24) #13
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_array_list_front(%struct.aws_array_list* noalias nocapture readonly %0, i8* %1) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #13
  ...
  %4 = load i32, i32* %3, align 4, !tbaa !8, !alias.scope !30
  %5 = icmp eq i32 %4, 0
  br i1 %5, label %13, label %6

6:                                                ; preds = %2
  %7 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 4
  %8 = load i8*, i8** %7, align 4, !tbaa !16, !alias.scope !30
  %9 = icmp eq i8* %8, null
...
aws_array_list_length.exit:                       ; preds = %6
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* align 1 %1, i8* nonnull align 1 %8, i32 %12, i1 false) #13
  br label %aws_raise_error.exit

13:                                               ; preds = %2
  tail call void @seahorn.fn.enter() #13
  tail call void @seahorn.fn.enter() #13
  %14 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !26
  %15 = icmp eq void (i32, i8*)* %14, null
  br i1 %15, label %18, label %16

16:                                               ; preds = %13
  %17 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !26
  tail call void %14(i32 25, i8* %17) #13
  br label %aws_raise_error.exit

18:                                               ; preds = %13
  %19 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !26
  %20 = icmp eq void (i32, i8*)* %19, null
  br i1 %20, label %aws_raise_error.exit, label %21

21:                                               ; preds = %18
  %22 = load i8*, i8** @s_global_error_context, align 4, !tbaa !26
  tail call void %19(i32 25, i8* %22) #13
  br label %aws_raise_error.exit

aws_raise_error.exit:                             ; preds = %21, %18, %16, %aws_array_list_length.exit
  ret void
}
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_array_list_front_harness()
  ...
  tail call fastcc void @aws_array_list_front(%struct.aws_array_list* %3, i8* %4)
  %5 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %6 = tail call fastcc i32 @aws_array_list_length(%struct.aws_array_list* %5)
  %7 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error(i32 %7)
  %8 = tail call i32 @verifier.nondet.3()
  %9 = tail call i32 @verifier.nondet.3()
  %10 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked(i32 %8, i32 %9, i32* %10)
  %11 = tail call i32 @verifier.nondet.3()
  %12 = tail call i32 @verifier.nondet.3()
  %13 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked(i32 %11, i32 %12, i32* %13)
  %14 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_allocator_is_valid(%struct.aws_allocator* %14)
  ...
  %17 = tail call i8* @s_default_malloc(%struct.aws_allocator* %15, i32 %16)
  %18 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %19 = tail call i8* @verifier.nondet.2()
  tail call void @s_default_free(%struct.aws_allocator* %18, i8* %19)
  %20 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %21 = tail call i8* @verifier.nondet.2()
  %22 = tail call i32 @verifier.nondet.3()
  %23 = tail call i32 @verifier.nondet.3()
  %24 = tail call i8* @s_default_realloc(%struct.aws_allocator* %20, i8* %21, i32 %22, i32 %23)
  %25 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %26 = tail call i32 @verifier.nondet.3()
  %27 = tail call i32 @verifier.nondet.3()
  %28 = tail call i8* @s_default_calloc(%struct.aws_allocator* %25, i32 %26, i32 %27)
  %29 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %30 = tail call i32 @verifier.nondet.3()
  %31 = tail call fastcc i8* @aws_mem_acquire(%struct.aws_allocator* %29, i32 %30)
  %32 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.7(i32 %32)
  %33 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %34 = tail call i32 @verifier.nondet.3()
  %35 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_mem_calloc(%struct.aws_allocator* %33, i32 %34, i32 %35)
  %36 = tail call i32 @verifier.nondet.3()
  %37 = tail call i32 @verifier.nondet.3()
  %38 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked.8(i32 %36, i32 %37, i32* %38)
  %39 = tail call i32 @verifier.nondet.3()
  %40 = tail call i32 @verifier.nondet.3()
  %41 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked.9(i32 %39, i32 %40, i32* %41)
  %42 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %43 = tail call i32 @verifier.nondet.3()
  %44 = tail call i8* (%struct.aws_allocator*, i32, ...) @aws_mem_acquire_many(%struct.aws_allocator* %42, i32 %43)
  %45 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %46 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_mem_release(%struct.aws_allocator* %45, i8* %46)
  %47 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %48 = tail call i8** @verifier.nondet.6()
  %49 = tail call i32 @verifier.nondet.3()
  %50 = tail call i32 @verifier.nondet.3()
  %51 = tail call fastcc i32 @aws_mem_realloc(%struct.aws_allocator* %47, i8** %48, i32 %49, i32 %50)
  %52 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %52)
  %53 = tail call i8* @verifier.nondet.2()
  %54 = tail call i32 @verifier.nondet.3()
  %55 = tail call i32 @verifier.nondet.3()
  %56 = tail call i8* @verifier.nondet.2()
  %57 = tail call i8* @s_cf_allocator_reallocate(i8* %53, i32 %54, i32 %55, i8* %56)
  %58 = tail call i8* @verifier.nondet.2()
  %59 = tail call %struct.__CFString* @s_cf_allocator_copy_description(i8* %58)
  %60 = tail call i32 @verifier.nondet.3()
  %61 = tail call i32 @verifier.nondet.3()
  %62 = tail call i8* @verifier.nondet.2()
  %63 = tail call i8* @s_cf_allocator_allocate(i32 %60, i32 %61, i8* %62)
  %64 = tail call i8* @verifier.nondet.2()
  %65 = tail call i8* @verifier.nondet.2()
  tail call void @s_cf_allocator_deallocate(i8* %64, i8* %65)
  %66 = tail call i32 @verifier.nondet.3()
  %67 = tail call i32 @verifier.nondet.3()
  %68 = tail call i8* @verifier.nondet.2()
  %69 = tail call i32 @s_cf_allocator_preferred_size(i32 %66, i32 %67, i8* %68)
  %70 = tail call %struct.__CFAllocator* @verifier.nondet.7()
  tail call fastcc void @aws_wrapped_cf_allocator_destroy(%struct.__CFAllocator* %70)
  ...
  %80 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %79, i8* %80)
  %81 = tail call void (i32, i8*)* @verifier.nondet.8()
  %82 = tail call i8* @verifier.nondet.2()
  ...
  %87 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %88 = tail call i32 @verifier.nondet.3()
  %89 = tail call i32* @verifier.nondet.4()
  %90 = tail call fastcc i32 @aws_array_list_calc_necessary_size(%struct.aws_array_list* %87, i32 %88, i32* %89)
  %91 = tail call i32 @verifier.nondet.3()
  %92 = tail call i32 @verifier.nondet.3()
  %93 = tail call i32* @verifier.nondet.4()
  %94 = tail call fastcc i32 @aws_add_size_checked(i32 %91, i32 %92, i32* %93)
  %95 = tail call i32 @verifier.nondet.3()
  %96 = tail call i32 @verifier.nondet.3()
  %97 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked.21(i32 %95, i32 %96, i32* %97)
  %98 = tail call i32 @verifier.nondet.3()
  %99 = tail call i32 @verifier.nondet.3()
  %100 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked.22(i32 %98, i32 %99, i32* %100)
  %101 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.23(i32 %101)
  ...
  tail call fastcc void @aws_array_list_shrink_to_fit(%struct.aws_array_list* %106)
  %107 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %108 = tail call %struct.aws_array_list* @verifier.nondet.1()
  tail call fastcc void @aws_array_list_copy(%struct.aws_array_list* %107, %struct.aws_array_list* %108)
  %109 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %110 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_ensure_capacity(%struct.aws_array_list* %109, i32 %110)
  %111 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %112 = tail call i32 @verifier.nondet.3()
  %113 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_swap(%struct.aws_array_list* %111, i32 %112, i32 %113)
  %114 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %115 = tail call i8** @verifier.nondet.6()
  %116 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_get_at_ptr(%struct.aws_array_list* %114, i8** %115, i32 %116)
  %117 = tail call i8* @verifier.nondet.2()
  %118 = tail call i8* @verifier.nondet.2()
  %119 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_mem_swap(i8* %117, i8* %118, i32 %119)
  %120 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %121 = tail call fastcc i32 @aws_array_list_length.31(%struct.aws_array_list* %120)
  %122 = tail call i8* @verifier.nondet.2()
  %123 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_secure_zero(i8* %122, i32 %123)
  %124 = tail call %struct.aws_allocator* @verifier.nondet.5()
...
!20 = !{!21}
!21 = distinct !{!21, !22, !"aws_array_list_front: argument 0"}
!22 = distinct !{!22, !"aws_array_list_front"}
!23 = !{!24, !21}
