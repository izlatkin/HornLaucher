; ModuleID = '../out2/aws_array_list_clear_harness.c/aws_array_list_clear_harness24ed1.bc.txt'
...
define internal fastcc void @aws_array_list_clear_harness() unnamed_addr #1 {
  ...
  %5 = load i32, i32* %4, align 8, !tbaa !8, !alias.scope !5
  ...
  %14 = load i8*, i8** %13, align 8, !tbaa !16, !alias.scope !5
...
aws_array_list_is_valid.exit:                     ; preds = %15, %.thread.i
  ...
  %22 = icmp eq i8* %14, null
  br i1 %22, label %aws_array_list_clear.exit, label %23

23:                                               ; preds = %aws_array_list_is_valid.exit
  store i32 0, i32* %4, align 8, !tbaa !8, !alias.scope !17
  br label %aws_array_list_clear.exit

aws_array_list_clear.exit:                        ; preds = %aws_array_list_is_valid.exit, %23
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_array_list_clear(%struct.aws_array_list* noalias nocapture %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #13
  %2 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 4
  %3 = load i8*, i8** %2, align 4, !tbaa !16
  %4 = icmp eq i8* %3, null
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_array_list_clear_harness()
  ...
  tail call fastcc void @aws_array_list_clear(%struct.aws_array_list* %3)
  ...
  tail call fastcc void @aws_raise_error.3(i32 %29)
  ...
  tail call fastcc void @aws_mul_size_checked.4(i32 %33, i32 %34, i32* %35)
  %36 = tail call i32 @verifier.nondet.2()
  %37 = tail call i32 @verifier.nondet.2()
  %38 = tail call i32* @verifier.nondet.3()
  tail call fastcc void @aws_mul_u32_checked.5(i32 %36, i32 %37, i32* %38)
...
!16 = !{!9, !10, i64 16}
!17 = !{!18}
!18 = distinct !{!18, !19, !"aws_array_list_clear: argument 0"}
!19 = distinct !{!19, !"aws_array_list_clear"}
!20 = !{!21}
