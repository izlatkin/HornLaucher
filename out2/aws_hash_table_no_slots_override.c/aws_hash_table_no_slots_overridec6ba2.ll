; ModuleID = '../out2/aws_hash_table_no_slots_override.c/aws_hash_table_no_slots_overridec6ba2.bc.txt'
...
define internal fastcc void @aws_hash_iter_next(%struct.aws_hash_iter* nocapture %0) unnamed_addr #0 {
  %2 = tail call i8* @verifier.nondet.9() #6
  %3 = tail call i8* @verifier.nondet.9() #6
  %4 = tail call i32 @verifier.nondet.10() #6
  %5 = tail call i8* @verifier.nondet.9() #6
  %6 = tail call i8* @verifier.nondet.9() #6
  tail call void @seahorn.fn.enter() #6
  %7 = getelementptr inbounds %struct.aws_hash_iter, %struct.aws_hash_iter* %0, i32 0, i32 2
...
16:                                               ; preds = %1, %12
  %.sink = phi i32 [ %15, %12 ], [ 0, %1 ]
  %17 = getelementptr inbounds %struct.aws_hash_iter, %struct.aws_hash_iter* %0, i32 0, i32 4
  store i32 %.sink, i32* %17, align 4
  ret void
}
...
define internal fastcc void @aws_hash_iter_delete(%struct.aws_hash_iter* nocapture %0) unnamed_addr #0 {
  ...
  %8 = load %struct.aws_hash_table*, %struct.aws_hash_table** %7, align 4, !tbaa !10
  %9 = getelementptr inbounds %struct.aws_hash_table, %struct.aws_hash_table* %8, i32 0, i32 0
  %10 = load %struct.hash_table_state*, %struct.hash_table_state** %9, align 4, !tbaa !5
  %11 = getelementptr inbounds %struct.hash_table_state, %struct.hash_table_state* %10, i32 0, i32 6
  %12 = load i32, i32* %11, align 4, !tbaa !15
  %13 = add i32 %12, -1
  store i32 %13, i32* %11, align 4, !tbaa !15
  %14 = getelementptr inbounds %struct.aws_hash_iter, %struct.aws_hash_iter* %0, i32 0, i32 3
...
define i32 @main() local_unnamed_addr {
  ...
  %2 = tail call fastcc i1 @aws_hash_table_is_valid(%struct.aws_hash_table* %1)
  %3 = tail call %struct.aws_hash_iter* @verifier.nondet.2()
  tail call fastcc void @aws_hash_iter_is_valid(%struct.aws_hash_iter* %3)
  %4 = tail call %struct.aws_hash_table* @verifier.nondet.1()
  %5 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @make_hash_table_with_no_backing_store(%struct.aws_hash_table* %4, i32 %5)
  %6 = tail call %struct.aws_hash_table* @verifier.nondet.1()
  tail call fastcc void @aws_hash_table_clear(%struct.aws_hash_table* %6)
  %7 = tail call %struct.aws_hash_table* @verifier.nondet.1()
  %8 = tail call i8* @verifier.nondet.4()
  %9 = tail call i8* @verifier.nondet.4()
  %10 = tail call i32* @verifier.nondet.5()
  tail call fastcc void @aws_hash_table_put(%struct.aws_hash_table* %7, i32* %10)
  %11 = tail call %struct.aws_hash_table* @verifier.nondet.1()
  %12 = tail call i8* @verifier.nondet.4()
  %13 = tail call %struct.aws_hash_element** @verifier.nondet.6()
  tail call fastcc void @aws_hash_table_find(%struct.aws_hash_element** %13)
  %14 = tail call %struct.aws_hash_iter* @verifier.nondet.2()
  %15 = tail call %struct.aws_hash_table* @verifier.nondet.1()
  tail call fastcc void @aws_hash_iter_begin(%struct.aws_hash_iter* noalias %14, %struct.aws_hash_table* %15)
  %16 = tail call %struct.aws_hash_iter* @verifier.nondet.2()
  tail call fastcc void @aws_hash_iter_done(%struct.aws_hash_iter* %16)
  %17 = tail call %struct.aws_hash_iter* @verifier.nondet.2()
  tail call fastcc void @aws_hash_iter_next(%struct.aws_hash_iter* %17)
  %18 = tail call %struct.aws_hash_iter* @verifier.nondet.2()
  %19 = tail call i1 @verifier.nondet.7()
  tail call fastcc void @aws_hash_iter_delete(%struct.aws_hash_iter* %18)
  ret i32 42
}
...
declare i1 @verifier.nondet.7() local_unnamed_addr
