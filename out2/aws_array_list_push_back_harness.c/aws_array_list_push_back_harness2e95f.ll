; ModuleID = '../out2/aws_array_list_push_back_harness.c/aws_array_list_push_back_harness2e95f.bc.txt'
...
@.str.1.17 = private unnamed_addr constant [11 x i8] c"error_info\00", align 1
@.str.2.18 = private unnamed_addr constant [33 x i8] c"/tmp/aws-c-common/source/error.c\00", align 1
@.str.3.19 = private unnamed_addr constant [23 x i8] c"error_info->error_list\00", align 1
@.str.4.20 = private unnamed_addr constant [18 x i8] c"error_info->count\00", align 1
@__stderrp = external local_unnamed_addr global %struct.__sFILE*, align 4
@.str.5.21 = private unnamed_addr constant [25 x i8] c"Bad error slot index %d\0A\00", align 1
@.str.6.22 = private unnamed_addr constant [6 x i8] c"false\00", align 1
@.str.7.23 = private unnamed_addr constant [2 x i8] c"0\00", align 1
...
@.str.5.40 = private unnamed_addr constant [28 x i8] c"!list->length || list->data\00", align 1
@.str.6.41 = private unnamed_addr constant [52 x i8] c"/tmp/aws-c-common/include/aws/common/array_list.inl\00", align 1
...
@.str.42 = private unnamed_addr constant [11 x i8] c"libnuma.so\00", align 1
@.str.1.43 = private unnamed_addr constant [13 x i8] c"libnuma.so.1\00", align 1
@.str.2.44 = private unnamed_addr constant [13 x i8] c"libnuma.so.2\00", align 1
@.str.3.45 = private unnamed_addr constant [26 x i8] c"static: libnuma.so loaded\00", align 1
@.str.4.46 = private unnamed_addr constant [14 x i8] c"set_mempolicy\00", align 1
@.str.5.47 = private unnamed_addr constant [31 x i8] c"static: set_mempolicy() loaded\00", align 1
@.str.6.48 = private unnamed_addr constant [39 x i8] c"static: set_mempolicy() failed to load\00", align 1
@.str.7.49 = private unnamed_addr constant [15 x i8] c"numa_available\00", align 1
@.str.8.50 = private unnamed_addr constant [32 x i8] c"static: numa_available() loaded\00", align 1
@.str.9.51 = private unnamed_addr constant [40 x i8] c"static: numa_available() failed to load\00", align 1
...
@.str.14.52 = private unnamed_addr constant [40 x i8] c"static: numa_num_possible_cpus() loaded\00", align 1
...
@.str.30.53 = private unnamed_addr constant [44 x i8] c"aws-c-common: AWS_ERROR_OOM, Out of memory.\00", align 1
...
@.str.42.54 = private unnamed_addr constant [83 x i8] c"aws-c-common: AWS_ERROR_OVERFLOW_DETECTED, Fixed size value overflow was detected.\00", align 1
...
define internal fastcc void @aws_array_list_push_back_harness() unnamed_addr #1 {
  ...
  %4 = bitcast %struct.aws_array_list* %1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %4) #14
  %5 = call zeroext i1 @aws_array_list_is_bounded(%struct.aws_array_list* nonnull %1, i32 0, i32 2) #14
  call void @verifier.assume(i1 %5)
  call void @ensure_array_list_has_allocated_data_member(%struct.aws_array_list* nonnull %1) #14
  call void @seahorn.fn.enter() #14, !noalias !5
  %6 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %1, i32 0, i32 2
  %7 = load i32, i32* %6, align 8, !tbaa !8, !alias.scope !5
  %8 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %1, i32 0, i32 3
  %9 = load i32, i32* %8, align 4, !tbaa !14, !alias.scope !5
  call void @seahorn.fn.enter() #14
  call void @seahorn.fn.enter() #14
  %10 = mul i32 %9, %7
  %11 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %1, i32 0, i32 1
  %12 = load i32, i32* %11, align 4, !tbaa !15, !alias.scope !5
  %13 = icmp uge i32 %12, %10
  %14 = icmp eq i32 %12, 0
  %15 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %1, i32 0, i32 4
  %16 = load i8*, i8** %15, align 8, !tbaa !16, !alias.scope !5
  br i1 %14, label %17, label %19

17:                                               ; preds = %0
  %18 = icmp eq i8* %16, null
  br i1 %18, label %.thread.i, label %aws_array_list_is_valid.exit

19:                                               ; preds = %0
  %20 = icmp ne i8* %16, null
  br label %.thread.i

.thread.i:                                        ; preds = %19, %17
  %21 = phi i1 [ %20, %19 ], [ true, %17 ]
  %or.cond3.i = and i1 %13, %21
  %22 = icmp ne i32 %9, 0
  %spec.select.i = and i1 %22, %or.cond3.i
  br label %aws_array_list_is_valid.exit

aws_array_list_is_valid.exit:                     ; preds = %17, %.thread.i
  %23 = phi i1 [ %spec.select.i, %.thread.i ], [ false, %17 ]
  call void @verifier.assume(i1 %23)
  %24 = icmp ne i8* %16, null
  call void @verifier.assume(i1 %24)
  %25 = call i8* @malloc(i32 %9) #15
  %26 = bitcast %struct.aws_array_list* %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %26) #14
  %.pmcpy.elt = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %1, i32 0, i32 0
  %.pmcpy.unpack = load %struct.aws_allocator*, %struct.aws_allocator** %.pmcpy.elt, align 8
  %.repack = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %2, i32 0, i32 0
  store %struct.aws_allocator* %.pmcpy.unpack, %struct.aws_allocator** %.repack, align 8
  %.repack10 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %2, i32 0, i32 1
  store i32 %12, i32* %.repack10, align 4
  %.repack12 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %2, i32 0, i32 2
  store i32 %7, i32* %.repack12, align 8
  %.repack14 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %2, i32 0, i32 3
  store i32 %9, i32* %.repack14, align 4
  %.repack16 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %2, i32 0, i32 4
  store i8* %16, i8** %.repack16, align 8
  %27 = bitcast %struct.store_byte_from_buffer* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %27) #14
  call void @save_byte_from_array(i8* %16, i32 %12, %struct.store_byte_from_buffer* nonnull %3) #14
  call void @seahorn.fn.enter() #14, !noalias !17
  %28 = load i32, i32* %6, align 8, !tbaa !8, !alias.scope !17
  %29 = load i32, i32* %8, align 4, !tbaa !14, !alias.scope !17
  call void @seahorn.fn.enter() #14
  call void @seahorn.fn.enter() #14
  %30 = mul i32 %29, %28
  %31 = load i32, i32* %11, align 4, !tbaa !15, !alias.scope !17
  %32 = icmp uge i32 %31, %30
  %33 = icmp eq i32 %31, 0
  %34 = load i8*, i8** %15, align 8, !tbaa !16, !alias.scope !17
  br i1 %33, label %35, label %37

35:                                               ; preds = %aws_array_list_is_valid.exit
  %36 = icmp eq i8* %34, null
  br i1 %36, label %.thread.i3, label %aws_array_list_is_valid.exit5

37:                                               ; preds = %aws_array_list_is_valid.exit
  %38 = icmp ne i8* %34, null
  br label %.thread.i3

.thread.i3:                                       ; preds = %37, %35
  %39 = phi i1 [ %38, %37 ], [ true, %35 ]
  %or.cond3.i1 = and i1 %32, %39
  %40 = icmp ne i32 %29, 0
  %spec.select.i2 = and i1 %40, %or.cond3.i1
  br label %aws_array_list_is_valid.exit5

aws_array_list_is_valid.exit5:                    ; preds = %35, %.thread.i3
  %41 = phi i1 [ %spec.select.i2, %.thread.i3 ], [ false, %35 ]
  call void @verifier.assume(i1 %41)
  %42 = icmp ne i8* %25, null
  call void @verifier.assume(i1 %42)
  %43 = call fastcc i32 @aws_array_list_push_back(%struct.aws_array_list* nonnull %1, i8* %25)
  %44 = icmp eq i32 %43, 0
  br i1 %44, label %aws_array_list_is_valid.exit10, label %45

45:                                               ; preds = %aws_array_list_is_valid.exit5
  call void @assert_array_list_equivalence(%struct.aws_array_list* nonnull %1, %struct.aws_array_list* nonnull %2, %struct.store_byte_from_buffer* nonnull %3) #14
  br label %aws_array_list_is_valid.exit10

aws_array_list_is_valid.exit10:                   ; preds = %45, %aws_array_list_is_valid.exit5
  call void @seahorn.fn.enter() #14, !noalias !20
  call void @seahorn.fn.enter() #14
  call void @seahorn.fn.enter() #14
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %27) #14
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %26) #14
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_array_list_push_back(%struct.aws_array_list* noalias nocapture %0, i8* %1) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  ...
  %4 = load i32, i32* %3, align 4, !tbaa !8, !alias.scope !23
  %5 = icmp eq i32 %4, 0
...
6:                                                ; preds = %2
  ...
  %8 = load i8*, i8** %7, align 4, !tbaa !16, !alias.scope !23
  %9 = icmp eq i8* %8, null
  br i1 %9, label %10, label %aws_array_list_length.exit

10:                                               ; preds = %6
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.40, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.41, i32 0, i32 0), i32 312) #16, !noalias !23
  unreachable
...
aws_array_list_length.exit:                       ; preds = %2, %6
  ...
  %12 = icmp eq i32 %11, 0
  br i1 %12, label %aws_raise_error.exit, label %13

13:                                               ; preds = %aws_array_list_length.exit
  tail call void @seahorn.fn.enter() #14
  %14 = load i32, i32* @tl_last_error, align 4, !tbaa !26
...
16:                                               ; preds = %13
  ...
  %18 = load %struct.aws_allocator*, %struct.aws_allocator** %17, align 4, !tbaa !28
  %19 = icmp eq %struct.aws_allocator* %18, null
  br i1 %19, label %20, label %aws_raise_error.exit

20:                                               ; preds = %16
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 27, i32* @tl_last_error, align 4, !tbaa !26
...
23:                                               ; preds = %20
  ...
  tail call void %21(i32 27, i8* %24) #14
...
25:                                               ; preds = %20
  ...
  br i1 %27, label %aws_raise_error.exit, label %28

28:                                               ; preds = %25
  %29 = load i8*, i8** @s_global_error_context, align 4, !tbaa !29
  tail call void %26(i32 27, i8* %29) #14
  br label %aws_raise_error.exit

aws_raise_error.exit:                             ; preds = %28, %25, %23, %16, %13, %aws_array_list_length.exit
...
9:                                                ; preds = %5
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.40, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.41, i32 0, i32 0), i32 312) #16
  unreachable
...
10:                                               ; preds = %6
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.41, i32 0, i32 0), i32 359) #16
  unreachable
...
aws_array_list_length.exit:                       ; preds = %6
  ...
  tail call void @seahorn.fn.enter() #14, !noalias !30
  %15 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 2
  %16 = load i32, i32* %15, align 4, !tbaa !8, !alias.scope !30
...
20:                                               ; preds = %18
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 5, i32* @tl_last_error, align 4, !tbaa !26
  %21 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !29
  %22 = icmp eq void (i32, i8*)* %21, null
  br i1 %22, label %25, label %23
...
aws_add_size_checked.exit:                        ; preds = %18
  %30 = add nuw i32 %2, 1
  store i32 %30, i32* %15, align 4, !tbaa !26
  br label %aws_add_size_checked.exit.thread
...
define internal fastcc void @aws_raise_error(i32 %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 %0, i32* @tl_last_error, align 4, !tbaa !26
...
17:                                               ; preds = %3
  %18 = add i32 %1, %0
  store i32 %18, i32* %2, align 4, !tbaa !26
  br label %aws_add_u32_checked.exit
...
5:                                                ; preds = %2
  ...
  %7 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %6, align 4, !tbaa !33
...
16:                                               ; preds = %13
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 1, i32* @tl_last_error, align 4, !tbaa !26
...
6:                                                ; preds = %3
  ...
  %8 = load i8* (%struct.aws_allocator*, i32, i32)*, i8* (%struct.aws_allocator*, i32, i32)** %7, align 4, !tbaa !35
...
10:                                               ; preds = %6
  ...
  %12 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %11, align 4, !tbaa !33
...
34:                                               ; preds = %19
  ...
  %36 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %35, align 4, !tbaa !33
...
5:                                                ; preds = %2
  ...
  %7 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %6, align 4, !tbaa !36
...
7:                                                ; preds = %4
  ...
  %9 = load i8* (%struct.aws_allocator*, i8*, i32, i32)*, i8* (%struct.aws_allocator*, i8*, i32, i32)** %8, align 4, !tbaa !37
...
11:                                               ; preds = %7
  ...
  %13 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %12, align 4, !tbaa !33
...
16:                                               ; preds = %11, %7
  ...
  %18 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !36
...
45:                                               ; preds = %43
  ...
  %47 = load i8* (%struct.aws_allocator*, i32)*, i8* (%struct.aws_allocator*, i32)** %46, align 4, !tbaa !33
...
60:                                               ; preds = %45
  ...
  tail call void @seahorn.fn.enter() #14
  %65 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %17, align 4, !tbaa !36
...
define internal fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %0) unnamed_addr #1 {
  ...
  %4 = load i8* (%struct.aws_allocator*, i8*, i32, i32)*, i8* (%struct.aws_allocator*, i8*, i32, i32)** %3, align 4, !tbaa !37
  ...
  store i32 0, i32* %7, align 4, !tbaa !38
...
7:                                                ; preds = %2
  ...
  %10 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %9, align 4, !tbaa !36
...
define internal fastcc i32 @aws_last_error() unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #14
  %1 = load i32, i32* @tl_last_error, align 4, !tbaa !26
  ret i32 %1
}
...
9:                                                ; preds = %3
  ...
  %11 = load i16, i16* %10, align 4, !tbaa !48
...
14:                                               ; preds = %9
  ...
  %16 = load %struct.aws_error_info*, %struct.aws_error_info** %15, align 4, !tbaa !51
...
3:                                                ; preds = %1
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1.17, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.18, i32 0, i32 0), i32 133) #16
  unreachable

4:                                                ; preds = %1
  %5 = getelementptr inbounds %struct.aws_error_info_list, %struct.aws_error_info_list* %0, i32 0, i32 0
  %6 = load %struct.aws_error_info*, %struct.aws_error_info** %5, align 4, !tbaa !51
  %7 = icmp eq %struct.aws_error_info* %6, null
  br i1 %7, label %8, label %9

8:                                                ; preds = %4
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3.19, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.18, i32 0, i32 0), i32 134) #16
  unreachable
...
13:                                               ; preds = %9
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4.20, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.18, i32 0, i32 0), i32 135) #16
  unreachable
...
19:                                               ; preds = %14
  ...
  %21 = tail call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %20, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5.21, i32 0, i32 0), i32 %17) #14
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6.22, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.18, i32 0, i32 0), i32 144) #16
  unreachable
...
3:                                                ; preds = %1
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1.17, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.18, i32 0, i32 0), i32 167) #16
  unreachable
...
8:                                                ; preds = %4
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3.19, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.18, i32 0, i32 0), i32 168) #16
  unreachable
...
13:                                               ; preds = %9
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4.20, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.18, i32 0, i32 0), i32 169) #16
  unreachable
...
19:                                               ; preds = %14
  %20 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 4, !tbaa !29
  %21 = tail call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %20, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5.21, i32 0, i32 0), i32 %17) #14
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7.23, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.18, i32 0, i32 0), i32 178) #16
  unreachable
...
1:                                                ; preds = %NodeBlock13
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 34, i32* @tl_last_error, align 4, !tbaa !26
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !29
  %3 = icmp eq void (i32, i8*)* %2, null
  br i1 %3, label %6, label %4
...
4:                                                ; preds = %1
  ...
  br label %aws_raise_error.24.exit

6:                                                ; preds = %1
  %7 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !29
  %8 = icmp eq void (i32, i8*)* %7, null
  br i1 %8, label %aws_raise_error.24.exit, label %9
...
11:                                               ; preds = %LeafBlock15
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 42, i32* @tl_last_error, align 4, !tbaa !26
...
16:                                               ; preds = %11
  ...
  %18 = icmp eq void (i32, i8*)* %17, null
  br i1 %18, label %aws_raise_error.24.exit, label %19
...
21:                                               ; preds = %LeafBlock, %LeafBlock3
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 43, i32* @tl_last_error, align 4, !tbaa !26
...
26:                                               ; preds = %21
  ...
  br i1 %28, label %aws_raise_error.24.exit, label %29
...
31:                                               ; preds = %LeafBlock1, %NodeBlock5, %LeafBlock17
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 44, i32* @tl_last_error, align 4, !tbaa !26
...
36:                                               ; preds = %31
  ...
  br i1 %38, label %aws_raise_error.24.exit, label %39
...
41:                                               ; preds = %LeafBlock11
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 45, i32* @tl_last_error, align 4, !tbaa !26
...
46:                                               ; preds = %41
  ...
  br i1 %48, label %aws_raise_error.24.exit, label %49
...
56:                                               ; preds = %51
  ...
  br i1 %58, label %aws_raise_error.24.exit, label %59
...
61:                                               ; preds = %NodeBlock21
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 2, i32* @tl_last_error, align 4, !tbaa !26
...
66:                                               ; preds = %61
  ...
  br i1 %68, label %aws_raise_error.24.exit, label %69
...
NewDefault:                                       ; preds = %LeafBlock, %LeafBlock1, %LeafBlock3, %LeafBlock11, %LeafBlock15, %LeafBlock17
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 46, i32* @tl_last_error, align 4, !tbaa !26
...
75:                                               ; preds = %NewDefault
  ...
  br i1 %77, label %aws_raise_error.24.exit, label %78
...
aws_raise_error.24.exit:                          ; preds = %78, %75, %73, %69, %66, %64, %59, %56, %54, %49, %46, %44, %39, %36, %34, %29, %26, %24, %19, %16, %14, %9, %6, %4
  ret void
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_raise_error.24(i32 %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 %0, i32* @tl_last_error, align 4, !tbaa !26
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !29
...
define internal fastcc i32 @aws_array_list_calc_necessary_size(%struct.aws_array_list* noalias nocapture readonly %0, i32 %1, i32* nocapture %2) unnamed_addr #1 {
  ...
  %6 = call fastcc i32 @aws_add_size_checked.25(i32 %1, i32 1, i32* nonnull %4)
  %7 = icmp eq i32 %6, 0
  br i1 %7, label %8, label %13

8:                                                ; preds = %3
  %9 = load i32, i32* %4, align 4, !tbaa !54
  %10 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 3
  %11 = load i32, i32* %10, align 4, !tbaa !14
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %12 = mul i32 %11, %9
  store i32 %12, i32* %2, align 4, !tbaa !26
  br label %13
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_add_size_checked.25(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %4 = icmp ne i32 %1, 0
  %5 = sub nuw nsw i32 -1, %1
...
10:                                               ; preds = %7
  %11 = load i8*, i8** @tl_thread_handler_context, align 4, !tbaa !29
  tail call void %8(i32 5, i8* %11) #14
  br label %aws_add_u32_checked.29.exit

12:                                               ; preds = %7
  %13 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !29
  %14 = icmp eq void (i32, i8*)* %13, null
  br i1 %14, label %aws_add_u32_checked.29.exit, label %15
...
aws_add_u32_checked.29.exit:                      ; preds = %10, %12, %15, %17
  %.0.i = phi i32 [ 0, %17 ], [ -1, %10 ], [ -1, %12 ], [ -1, %15 ]
  ret i32 %.0.i
}

; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_size_checked.26(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !26
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_mul_u32_checked.27(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  %4 = mul i32 %1, %0
  store i32 %4, i32* %2, align 4, !tbaa !26
  ret void
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc void @aws_raise_error.28(i32 %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 %0, i32* @tl_last_error, align 4, !tbaa !26
  %2 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !29
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_add_u32_checked.29(i32 %0, i32 %1, i32* nocapture %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  %4 = icmp ne i32 %1, 0
  %5 = sub nuw nsw i32 -1, %1
  %6 = icmp ult i32 %5, %0
...
12:                                               ; preds = %7
  %13 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !29
  %14 = icmp eq void (i32, i8*)* %13, null
  br i1 %14, label %aws_raise_error.28.exit, label %15
...
aws_raise_error.28.exit:                          ; preds = %15, %12, %10, %17
  %.0 = phi i32 [ 0, %17 ], [ -1, %10 ], [ -1, %12 ], [ -1, %15 ]
  ret i32 %.0
}
...
define internal fastcc void @aws_array_list_shrink_to_fit(%struct.aws_array_list* noalias nocapture %0) unnamed_addr #1 {
  ...
  %3 = load %struct.aws_allocator*, %struct.aws_allocator** %2, align 4, !tbaa !28
...
5:                                                ; preds = %1
  ...
  br i1 %13, label %14, label %aws_raise_error.28.exit
...
19:                                               ; preds = %16
  ...
  %23 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %22, align 4, !tbaa !36
...
30:                                               ; preds = %1
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 28, i32* @tl_last_error, align 4, !tbaa !26
...
35:                                               ; preds = %30
  ...
  br i1 %37, label %aws_raise_error.28.exit, label %38
...
aws_raise_error.28.exit:                          ; preds = %38, %35, %33, %5, %16, %.critedge
  ret void
}
...
8:                                                ; preds = %2
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.30, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.31, i32 0, i32 0), i32 61) #16
  unreachable
...
13:                                               ; preds = %9
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2.32, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.31, i32 0, i32 0), i32 62) #16
  unreachable
...
28:                                               ; preds = %14
  ...
  %30 = load %struct.aws_allocator*, %struct.aws_allocator** %29, align 4, !tbaa !28
...
32:                                               ; preds = %28
  ...
  br i1 %34, label %aws_raise_error.28.exit, label %35
...
39:                                               ; preds = %35
  ...
  %41 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %40, align 4, !tbaa !36
...
46:                                               ; preds = %28
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 26, i32* @tl_last_error, align 4, !tbaa !26
...
51:                                               ; preds = %46
  ...
  %53 = icmp eq void (i32, i8*)* %52, null
  br i1 %53, label %aws_raise_error.28.exit, label %54
...
aws_raise_error.28.exit:                          ; preds = %54, %51, %49, %44, %32, %26
  ret void
}
...
14:                                               ; preds = %2
  ...
  %17 = load i32, i32* %16, align 4, !tbaa !14, !alias.scope !55
  tail call void @seahorn.fn.enter() #14, !noalias !55
  tail call void @seahorn.fn.enter() #14, !noalias !55
  %18 = mul i32 %17, %15
...
22:                                               ; preds = %14
  ...
  %24 = load %struct.aws_allocator*, %struct.aws_allocator** %23, align 4, !tbaa !28
...
26:                                               ; preds = %22
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 10, i32* @tl_last_error, align 4, !tbaa !26
...
57:                                               ; preds = %53
  ...
  %59 = load void (%struct.aws_allocator*, i8*)*, void (%struct.aws_allocator*, i8*)** %58, align 4, !tbaa !36
...
7:                                                ; preds = %3
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3.35, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.31, i32 0, i32 0), i32 193) #16
  unreachable
...
10:                                               ; preds = %8
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4.36, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.31, i32 0, i32 0), i32 194) #16
  unreachable
...
13:                                               ; preds = %11
  ...
  %15 = load i8*, i8** %14, align 4, !tbaa !16, !alias.scope !61
  %16 = icmp eq i8* %15, null
  br i1 %16, label %17, label %aws_array_list_get_at_ptr.exit4

17:                                               ; preds = %13
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.40, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.41, i32 0, i32 0), i32 312) #16, !noalias !61
  unreachable
...
aws_array_list_get_at_ptr.exit4:                  ; preds = %13
  ...
  %19 = load i32, i32* %18, align 4, !tbaa !14, !alias.scope !58
...
define internal fastcc void @aws_array_list_get_at_ptr(%struct.aws_array_list* noalias nocapture readonly %0, i8** nocapture %1, i32 %2) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14, !noalias !70
  %4 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 2
  %5 = load i32, i32* %4, align 4, !tbaa !8, !alias.scope !70
  %6 = icmp eq i32 %5, 0
  br i1 %6, label %aws_array_list_length.39.exit, label %7

7:                                                ; preds = %3
  %8 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 4
  %9 = load i8*, i8** %8, align 4, !tbaa !16, !alias.scope !70
  %10 = icmp eq i8* %9, null
  br i1 %10, label %11, label %aws_array_list_length.39.exit

11:                                               ; preds = %7
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.5.40, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.6.41, i32 0, i32 0), i32 312) #16, !noalias !70
  unreachable

aws_array_list_length.39.exit:                    ; preds = %3, %7
  %12 = icmp ugt i32 %5, %2
  br i1 %12, label %13, label %20

13:                                               ; preds = %aws_array_list_length.39.exit
  %14 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 4
...
20:                                               ; preds = %aws_array_list_length.39.exit
  tail call void @seahorn.fn.enter() #14
  tail call void @seahorn.fn.enter() #14
  store i32 10, i32* @tl_last_error, align 4, !tbaa !26
  %21 = load void (i32, i8*)*, void (i32, i8*)** @tl_thread_handler, align 4, !tbaa !29
...
25:                                               ; preds = %20
  %26 = load void (i32, i8*)*, void (i32, i8*)** @s_global_handler, align 4, !tbaa !29
  %27 = icmp eq void (i32, i8*)* %26, null
  br i1 %27, label %aws_raise_error.28.exit, label %28
...
aws_raise_error.28.exit:                          ; preds = %28, %25, %23, %13
  ret void
}
...
6:                                                ; preds = %3
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7.37, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.31, i32 0, i32 0), i32 172) #16
  unreachable
...
9:                                                ; preds = %7
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.8.38, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.1.31, i32 0, i32 0), i32 173) #16
  unreachable
...
; Function Attrs: inlinehint nounwind ssp uwtable
define internal fastcc i32 @aws_array_list_length.39(%struct.aws_array_list* noalias nocapture readonly %0) unnamed_addr #4 {
  tail call void @seahorn.fn.enter() #14
  %2 = getelementptr inbounds %struct.aws_array_list, %struct.aws_array_list* %0, i32 0, i32 2
  %3 = load i32, i32* %2, align 4, !tbaa !8
  %4 = icmp eq i32 %3, 0
...
define internal fastcc void @aws_secure_zero(i8* %0, i32 %1) unnamed_addr #1 {
  ...
  tail call void asm sideeffect "", "r,~{memory},~{dirflag},~{fpsr},~{flags}"(i8* %0) #14, !srcloc !75
  ret void
}
...
1:                                                ; preds = %0
  ...
  tail call void @seahorn.fn.enter() #14
  %2 = load %struct.aws_error_info*, %struct.aws_error_info** getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 0), align 8, !tbaa !51
...
5:                                                ; preds = %1
  %6 = load i16, i16* getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 1), align 4, !tbaa !48
  %7 = icmp eq i16 %6, 0
  br i1 %7, label %8, label %9
...
14:                                               ; preds = %9
  ...
  %16 = tail call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %15, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5.21, i32 0, i32 0), i32 %12) #14
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6.22, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.18, i32 0, i32 0), i32 144) #16
  unreachable
...
aws_register_error_info.exit:                     ; preds = %9
  ...
  %18 = tail call i8* @dlopen(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.42, i32 0, i32 0), i32 4) #14
  store i8* %18, i8** @g_libnuma_handle, align 4, !tbaa !29
  %19 = icmp eq i8* %18, null
  br i1 %19, label %20, label %.thread1

20:                                               ; preds = %aws_register_error_info.exit
  %21 = tail call i8* @dlopen(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1.43, i32 0, i32 0), i32 4) #14
...
25:                                               ; preds = %20
  %26 = tail call i8* @dlopen(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2.44, i32 0, i32 0), i32 4) #14
...
31:                                               ; preds = %.thread1, %30
  ...
  %34 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %33, align 4, !tbaa !76
  %35 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %34, i32 0, i32 1
  %36 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %35, align 4, !tbaa !78
  %37 = tail call i32 %36(%struct.aws_logger* nonnull %32, i32 0) #14
  %38 = icmp ugt i32 %37, 3
  br i1 %38, label %39, label %44

39:                                               ; preds = %31
  %40 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %33, align 4, !tbaa !76
  %41 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %40, i32 0, i32 0
  %42 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %41, align 4, !tbaa !80
  %43 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %42(%struct.aws_logger* nonnull %32, i32 4, i32 0, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3.45, i32 0, i32 0)) #14
  br label %44

44:                                               ; preds = %.thread1, %39, %31, %30
  %45 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !29
  %46 = tail call i8* @dlsym(i8* %45, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4.46, i32 0, i32 0)) #14
...
51:                                               ; preds = %50
  ...
  %53 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %52, align 4, !tbaa !76
  %54 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %53, i32 0, i32 1
  %55 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %54, align 4, !tbaa !78
  %56 = tail call i32 %55(%struct.aws_logger* nonnull %48, i32 0) #14
  %57 = icmp ugt i32 %56, 3
  br i1 %57, label %58, label %76

58:                                               ; preds = %51
  %59 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %52, align 4, !tbaa !76
  %60 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %59, i32 0, i32 0
  %61 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %60, align 4, !tbaa !80
  %62 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %61(%struct.aws_logger* nonnull %48, i32 4, i32 0, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.5.47, i32 0, i32 0)) #14
  br label %76
...
64:                                               ; preds = %63
  ...
  %66 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %65, align 4, !tbaa !76
  %67 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %66, i32 0, i32 1
  %68 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %67, align 4, !tbaa !78
  %69 = tail call i32 %68(%struct.aws_logger* nonnull %48, i32 0) #14
  %70 = icmp ugt i32 %69, 3
  br i1 %70, label %71, label %76

71:                                               ; preds = %64
  %72 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %65, align 4, !tbaa !76
  %73 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %72, i32 0, i32 0
  %74 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %73, align 4, !tbaa !80
  %75 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %74(%struct.aws_logger* nonnull %48, i32 4, i32 0, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.6.48, i32 0, i32 0)) #14
  br label %76

76:                                               ; preds = %71, %64, %63, %58, %51, %50
  %77 = load i8*, i8** @g_libnuma_handle, align 4, !tbaa !29
  %78 = tail call i8* @dlsym(i8* %77, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.7.49, i32 0, i32 0)) #14
...
83:                                               ; preds = %82
  ...
  %85 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %84, align 4, !tbaa !76
  %86 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %85, i32 0, i32 1
  %87 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %86, align 4, !tbaa !78
  %88 = tail call i32 %87(%struct.aws_logger* nonnull %80, i32 0) #14
  %89 = icmp ugt i32 %88, 3
  br i1 %89, label %90, label %108

90:                                               ; preds = %83
  %91 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %84, align 4, !tbaa !76
  %92 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %91, i32 0, i32 0
  %93 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %92, align 4, !tbaa !80
  %94 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %93(%struct.aws_logger* nonnull %80, i32 4, i32 0, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.8.50, i32 0, i32 0)) #14
  br label %108
...
96:                                               ; preds = %95
  ...
  %98 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %97, align 4, !tbaa !76
  %99 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %98, i32 0, i32 1
  %100 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %99, align 4, !tbaa !78
  %101 = tail call i32 %100(%struct.aws_logger* nonnull %80, i32 0) #14
  %102 = icmp ugt i32 %101, 3
  br i1 %102, label %103, label %108

103:                                              ; preds = %96
  %104 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %97, align 4, !tbaa !76
  %105 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %104, i32 0, i32 0
  %106 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %105, align 4, !tbaa !80
  %107 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %106(%struct.aws_logger* nonnull %80, i32 4, i32 0, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.9.51, i32 0, i32 0)) #14
  br label %108
...
115:                                              ; preds = %114
  ...
  %117 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %116, align 4, !tbaa !76
  %118 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %117, i32 0, i32 1
  %119 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %118, align 4, !tbaa !78
  %120 = tail call i32 %119(%struct.aws_logger* nonnull %112, i32 0) #14
  %121 = icmp ugt i32 %120, 3
  br i1 %121, label %122, label %140

122:                                              ; preds = %115
  %123 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %116, align 4, !tbaa !76
  %124 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %123, i32 0, i32 0
  %125 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %124, align 4, !tbaa !80
...
128:                                              ; preds = %127
  ...
  %130 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %129, align 4, !tbaa !76
  %131 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %130, i32 0, i32 1
  %132 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %131, align 4, !tbaa !78
  %133 = tail call i32 %132(%struct.aws_logger* nonnull %112, i32 0) #14
  %134 = icmp ugt i32 %133, 3
  br i1 %134, label %135, label %140

135:                                              ; preds = %128
  %136 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %129, align 4, !tbaa !76
  %137 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %136, i32 0, i32 0
  %138 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %137, align 4, !tbaa !80
  %139 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %138(%struct.aws_logger* nonnull %112, i32 4, i32 0, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.12, i32 0, i32 0)) #14
  br label %140
...
147:                                              ; preds = %146
  ...
  %149 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %148, align 4, !tbaa !76
  %150 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %149, i32 0, i32 1
  %151 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %150, align 4, !tbaa !78
  %152 = tail call i32 %151(%struct.aws_logger* nonnull %144, i32 0) #14
  %153 = icmp ugt i32 %152, 3
  br i1 %153, label %154, label %172

154:                                              ; preds = %147
  %155 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %148, align 4, !tbaa !76
  %156 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %155, i32 0, i32 0
  %157 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %156, align 4, !tbaa !80
  %158 = tail call i32 (%struct.aws_logger*, i32, i32, i8*, ...) %157(%struct.aws_logger* nonnull %144, i32 4, i32 0, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.14.52, i32 0, i32 0)) #14
  br label %172
...
160:                                              ; preds = %159
  ...
  %162 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %161, align 4, !tbaa !76
  %163 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %162, i32 0, i32 1
  %164 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %163, align 4, !tbaa !78
  %165 = tail call i32 %164(%struct.aws_logger* nonnull %144, i32 0) #14
  %166 = icmp ugt i32 %165, 3
  br i1 %166, label %167, label %172

167:                                              ; preds = %160
  %168 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %161, align 4, !tbaa !76
  %169 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %168, i32 0, i32 0
  %170 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %169, align 4, !tbaa !80
...
179:                                              ; preds = %178
  ...
  %181 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %180, align 4, !tbaa !76
  %182 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %181, i32 0, i32 1
  %183 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %182, align 4, !tbaa !78
  %184 = tail call i32 %183(%struct.aws_logger* nonnull %176, i32 0) #14
  %185 = icmp ugt i32 %184, 3
  br i1 %185, label %186, label %217

186:                                              ; preds = %179
  %187 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %180, align 4, !tbaa !76
  %188 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %187, i32 0, i32 0
  %189 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %188, align 4, !tbaa !80
...
192:                                              ; preds = %191
  ...
  %194 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %193, align 4, !tbaa !76
  %195 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %194, i32 0, i32 1
  %196 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %195, align 4, !tbaa !78
  %197 = tail call i32 %196(%struct.aws_logger* nonnull %176, i32 0) #14
  %198 = icmp ugt i32 %197, 3
  br i1 %198, label %199, label %217

199:                                              ; preds = %192
  %200 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %193, align 4, !tbaa !76
  %201 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %200, i32 0, i32 0
  %202 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %201, align 4, !tbaa !80
...
205:                                              ; preds = %204
  ...
  %207 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %206, align 4, !tbaa !76
  %208 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %207, i32 0, i32 1
  %209 = load i32 (%struct.aws_logger*, i32)*, i32 (%struct.aws_logger*, i32)** %208, align 4, !tbaa !78
  %210 = tail call i32 %209(%struct.aws_logger* nonnull %28, i32 0) #14
  %211 = icmp ugt i32 %210, 3
  br i1 %211, label %212, label %217

212:                                              ; preds = %205
  %213 = load %struct.aws_logger_vtable*, %struct.aws_logger_vtable** %206, align 4, !tbaa !76
  %214 = getelementptr inbounds %struct.aws_logger_vtable, %struct.aws_logger_vtable* %213, i32 0, i32 0
  %215 = load i32 (%struct.aws_logger*, i32, i32, i8*, ...)*, i32 (%struct.aws_logger*, i32, i32, i8*, ...)** %214, align 4, !tbaa !80
...
1:                                                ; preds = %0
  ...
  tail call void @seahorn.fn.enter() #14
  %3 = load %struct.aws_error_info*, %struct.aws_error_info** getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 0), align 8, !tbaa !51
...
6:                                                ; preds = %1
  %7 = load i16, i16* getelementptr inbounds (%struct.aws_error_info_list, %struct.aws_error_info_list* @s_list, i32 0, i32 1), align 4, !tbaa !48
  %8 = icmp eq i16 %7, 0
  br i1 %8, label %9, label %10
...
15:                                               ; preds = %10
  ...
  %17 = tail call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %16, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5.21, i32 0, i32 0), i32 %13) #14
  tail call void @aws_fatal_assert(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7.23, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.2.18, i32 0, i32 0), i32 178) #16
  unreachable
...
define i32 @main() local_unnamed_addr {
  ...
  tail call fastcc void @aws_array_list_push_back_harness()
  ...
  %5 = tail call fastcc i32 @aws_array_list_push_back(%struct.aws_array_list* %3, i8* %4)
  %6 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %7 = tail call fastcc i32 @aws_array_list_length(%struct.aws_array_list* %6)
  %8 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %9 = tail call i8* @verifier.nondet.2()
  %10 = tail call i32 @verifier.nondet.3()
  %11 = tail call fastcc i32 @aws_array_list_set_at(%struct.aws_array_list* %8, i8* %9, i32 %10)
  ...
  %16 = tail call fastcc i32 @aws_add_size_checked(i32 %13, i32 %14, i32* %15)
  %17 = tail call i32 @verifier.nondet.3()
  %18 = tail call i32 @verifier.nondet.3()
  %19 = tail call i32* @verifier.nondet.4()
  %20 = tail call fastcc i32 @aws_add_u32_checked(i32 %17, i32 %18, i32* %19)
  %21 = tail call i32 @verifier.nondet.3()
  %22 = tail call i32 @verifier.nondet.3()
  %23 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked(i32 %21, i32 %22, i32* %23)
  %24 = tail call i32 @verifier.nondet.3()
  %25 = tail call i32 @verifier.nondet.3()
  %26 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked(i32 %24, i32 %25, i32* %26)
  %27 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_allocator_is_valid(%struct.aws_allocator* %27)
  ...
  %30 = tail call i8* @s_default_malloc(%struct.aws_allocator* %28, i32 %29)
  %31 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %32 = tail call i8* @verifier.nondet.2()
  tail call void @s_default_free(%struct.aws_allocator* %31, i8* %32)
  %33 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %34 = tail call i8* @verifier.nondet.2()
  %35 = tail call i32 @verifier.nondet.3()
  %36 = tail call i32 @verifier.nondet.3()
  %37 = tail call i8* @s_default_realloc(%struct.aws_allocator* %33, i8* %34, i32 %35, i32 %36)
  %38 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %39 = tail call i32 @verifier.nondet.3()
  %40 = tail call i32 @verifier.nondet.3()
  %41 = tail call i8* @s_default_calloc(%struct.aws_allocator* %38, i32 %39, i32 %40)
  %42 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %43 = tail call i32 @verifier.nondet.3()
  %44 = tail call fastcc i8* @aws_mem_acquire(%struct.aws_allocator* %42, i32 %43)
  %45 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.8(i32 %45)
  %46 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %47 = tail call i32 @verifier.nondet.3()
  %48 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_mem_calloc(%struct.aws_allocator* %46, i32 %47, i32 %48)
  %49 = tail call i32 @verifier.nondet.3()
  %50 = tail call i32 @verifier.nondet.3()
  %51 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked.10(i32 %49, i32 %50, i32* %51)
  %52 = tail call i32 @verifier.nondet.3()
  %53 = tail call i32 @verifier.nondet.3()
  %54 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked.11(i32 %52, i32 %53, i32* %54)
  %55 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %56 = tail call i32 @verifier.nondet.3()
  %57 = tail call i8* (%struct.aws_allocator*, i32, ...) @aws_mem_acquire_many(%struct.aws_allocator* %55, i32 %56)
  %58 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %59 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_mem_release(%struct.aws_allocator* %58, i8* %59)
  %60 = tail call %struct.aws_allocator* @verifier.nondet.5()
  %61 = tail call i8** @verifier.nondet.6()
  %62 = tail call i32 @verifier.nondet.3()
  %63 = tail call i32 @verifier.nondet.3()
  %64 = tail call fastcc i32 @aws_mem_realloc(%struct.aws_allocator* %60, i8** %61, i32 %62, i32 %63)
  %65 = tail call %struct.aws_allocator* @verifier.nondet.5()
  tail call fastcc void @aws_wrapped_cf_allocator_new(%struct.aws_allocator* %65)
  %66 = tail call i8* @verifier.nondet.2()
  %67 = tail call i32 @verifier.nondet.3()
  %68 = tail call i32 @verifier.nondet.3()
  %69 = tail call i8* @verifier.nondet.2()
  %70 = tail call i8* @s_cf_allocator_reallocate(i8* %66, i32 %67, i32 %68, i8* %69)
  %71 = tail call i8* @verifier.nondet.2()
  %72 = tail call %struct.__CFString* @s_cf_allocator_copy_description(i8* %71)
  %73 = tail call i32 @verifier.nondet.3()
  %74 = tail call i32 @verifier.nondet.3()
  %75 = tail call i8* @verifier.nondet.2()
  %76 = tail call i8* @s_cf_allocator_allocate(i32 %73, i32 %74, i8* %75)
  %77 = tail call i8* @verifier.nondet.2()
  %78 = tail call i8* @verifier.nondet.2()
  tail call void @s_cf_allocator_deallocate(i8* %77, i8* %78)
  %79 = tail call i32 @verifier.nondet.3()
  %80 = tail call i32 @verifier.nondet.3()
  %81 = tail call i8* @verifier.nondet.2()
  %82 = tail call i32 @s_cf_allocator_preferred_size(i32 %79, i32 %80, i8* %81)
  %83 = tail call %struct.__CFAllocator* @verifier.nondet.7()
  tail call fastcc void @aws_wrapped_cf_allocator_destroy(%struct.__CFAllocator* %83)
  %84 = tail call fastcc i32 @aws_last_error()
  %85 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_str(i32 %85)
  %86 = tail call i32 @verifier.nondet.3()
  %87 = tail call fastcc %struct.aws_error_info* @get_error_by_code(i32 %86)
  %88 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_name(i32 %88)
  %89 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_lib_name(i32 %89)
  %90 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_error_debug_str(i32 %90)
  %91 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error_private(i32 %91)
  tail call fastcc void @aws_reset_error()
  %92 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_restore_error(i32 %92)
  %93 = tail call void (i32, i8*)* @verifier.nondet.8()
  %94 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_set_global_error_handler_fn(void (i32, i8*)* %93, i8* %94)
  %95 = tail call void (i32, i8*)* @verifier.nondet.8()
  %96 = tail call i8* @verifier.nondet.2()
  tail call fastcc void @aws_set_thread_local_error_handler_fn(void (i32, i8*)* %95, i8* %96)
  %97 = tail call %struct.aws_error_info_list* @verifier.nondet.9()
  tail call fastcc void @aws_register_error_info(%struct.aws_error_info_list* %97)
  %98 = tail call %struct.aws_error_info_list* @verifier.nondet.9()
  tail call fastcc void @aws_unregister_error_info(%struct.aws_error_info_list* %98)
  %99 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_translate_and_raise_io_error(i32 %99)
  %100 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.24(i32 %100)
  %101 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %102 = tail call i32 @verifier.nondet.3()
  %103 = tail call i32* @verifier.nondet.4()
  %104 = tail call fastcc i32 @aws_array_list_calc_necessary_size(%struct.aws_array_list* %101, i32 %102, i32* %103)
  %105 = tail call i32 @verifier.nondet.3()
  %106 = tail call i32 @verifier.nondet.3()
  %107 = tail call i32* @verifier.nondet.4()
  %108 = tail call fastcc i32 @aws_add_size_checked.25(i32 %105, i32 %106, i32* %107)
  %109 = tail call i32 @verifier.nondet.3()
  %110 = tail call i32 @verifier.nondet.3()
  %111 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_size_checked.26(i32 %109, i32 %110, i32* %111)
  %112 = tail call i32 @verifier.nondet.3()
  %113 = tail call i32 @verifier.nondet.3()
  %114 = tail call i32* @verifier.nondet.4()
  tail call fastcc void @aws_mul_u32_checked.27(i32 %112, i32 %113, i32* %114)
  %115 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_raise_error.28(i32 %115)
  %116 = tail call i32 @verifier.nondet.3()
  %117 = tail call i32 @verifier.nondet.3()
  %118 = tail call i32* @verifier.nondet.4()
  %119 = tail call fastcc i32 @aws_add_u32_checked.29(i32 %116, i32 %117, i32* %118)
  %120 = tail call %struct.aws_array_list* @verifier.nondet.1()
  tail call fastcc void @aws_array_list_shrink_to_fit(%struct.aws_array_list* %120)
  %121 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %122 = tail call %struct.aws_array_list* @verifier.nondet.1()
  tail call fastcc void @aws_array_list_copy(%struct.aws_array_list* %121, %struct.aws_array_list* %122)
  %123 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %124 = tail call i32 @verifier.nondet.3()
  %125 = tail call fastcc i32 @aws_array_list_ensure_capacity(%struct.aws_array_list* %123, i32 %124)
  %126 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %127 = tail call i32 @verifier.nondet.3()
  %128 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_swap(%struct.aws_array_list* %126, i32 %127, i32 %128)
  %129 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %130 = tail call i8** @verifier.nondet.6()
  %131 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_get_at_ptr(%struct.aws_array_list* %129, i8** %130, i32 %131)
  %132 = tail call i8* @verifier.nondet.2()
  %133 = tail call i8* @verifier.nondet.2()
  %134 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_array_list_mem_swap(i8* %132, i8* %133, i32 %134)
  %135 = tail call %struct.aws_array_list* @verifier.nondet.1()
  %136 = tail call fastcc i32 @aws_array_list_length.39(%struct.aws_array_list* %135)
  %137 = tail call i8* @verifier.nondet.2()
  %138 = tail call i32 @verifier.nondet.3()
  tail call fastcc void @aws_secure_zero(i8* %137, i32 %138)
  %139 = tail call %struct.aws_allocator* @verifier.nondet.5()
...
!29 = !{!10, !10, i64 0}
!30 = !{!31}
!31 = distinct !{!31, !32, !"aws_array_list_length: argument 0"}
!32 = distinct !{!32, !"aws_array_list_length"}
!33 = !{!34, !10, i64 0}
!34 = !{!"aws_allocator", !10, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16}
!35 = !{!34, !10, i64 12}
!36 = !{!34, !10, i64 4}
!37 = !{!34, !10, i64 8}
!38 = !{!39, !13, i64 0}
!39 = !{!"", !13, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16, !10, i64 20, !10, i64 24, !10, i64 28, !10, i64 32}
!40 = !{!39, !10, i64 4}
!41 = !{!39, !10, i64 8}
!42 = !{!39, !10, i64 12}
!43 = !{!39, !10, i64 16}
...
!47 = !{!39, !10, i64 32}
!48 = !{!49, !50, i64 4}
!49 = !{!"aws_error_info_list", !10, i64 0, !50, i64 4}
!50 = !{!"short", !11, i64 0}
!51 = !{!49, !10, i64 0}
!52 = !{!53, !27, i64 0}
!53 = !{!"aws_error_info", !27, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16}
!54 = !{!13, !13, i64 0}
!55 = !{!56}
!56 = distinct !{!56, !57, !"aws_array_list_calc_necessary_size: argument 0"}
!57 = distinct !{!57, !"aws_array_list_calc_necessary_size"}
!58 = !{!59}
!59 = distinct !{!59, !60, !"aws_array_list_get_at_ptr: argument 0"}
!60 = distinct !{!60, !"aws_array_list_get_at_ptr"}
!61 = !{!62, !59}
!62 = distinct !{!62, !63, !"aws_array_list_length.39: argument 0"}
!63 = distinct !{!63, !"aws_array_list_length.39"}
!64 = !{!65}
!65 = distinct !{!65, !66, !"aws_array_list_get_at_ptr: argument 0"}
!66 = distinct !{!66, !"aws_array_list_get_at_ptr"}
!67 = !{!68, !65}
!68 = distinct !{!68, !69, !"aws_array_list_length.39: argument 0"}
!69 = distinct !{!69, !"aws_array_list_length.39"}
!70 = !{!71}
!71 = distinct !{!71, !72, !"aws_array_list_length.39: argument 0"}
!72 = distinct !{!72, !"aws_array_list_length.39"}
!73 = distinct !{!73, !74}
!74 = !{!"llvm.loop.unroll.disable"}
!75 = !{i32 1682}
!76 = !{!77, !10, i64 0}
!77 = !{!"aws_logger", !10, i64 0, !10, i64 4, !10, i64 8}
!78 = !{!79, !10, i64 4}
!79 = !{!"aws_logger_vtable", !10, i64 0, !10, i64 4, !10, i64 8, !10, i64 12}
!80 = !{!79, !10, i64 0}
