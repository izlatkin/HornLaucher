...
(declare-rel main@_18 (Int Int Int Int ))
...
(rule (=> (and main@_loop.bound
         ...
         main@%_call_0
         (= main@%_call1_0 (+ main@%_3_0 4976))
         (= main@%_call2_0 (+ main@%_5_0 5512))
         (= main@%_br_0 (+ main@%_7_0 5533)))
...
(rule (=> (and (main@_.03 main@%loop.bound_0 main@%.03_0 main@%.01_0 main@%.0_0)
         true
         (= main@%_10_0 (+ main@%.01_0 main@%.03_0))
         (= main@%_11_0 (> main@%_10_0 4))
         (= main@%_.14_0 (ite main@%_11_0 1 0))
         (= main@%.14_0 (+ main@%.03_0 main@%_.14_0))
         (= main@%not._0 (xor main@%_11_0 true))
         (= main@%_.12_0 (ite main@%not._0 1 0))
         (= main@%.12_0 (+ main@%.01_0 main@%_.12_0))
         (= main@%_br3_0 (< main@%.14_0 6))
         main@%_br3_0)
    (main@_15 main@%loop.bound_0 main@%.0_0 main@%.14_0 main@%.12_0)))
(rule (=> (and (main@_.03 main@%loop.bound_0 main@%.03_0 main@%.01_0 main@%.0_0)
         true
         (= main@%_10_0 (+ main@%.01_0 main@%.03_0))
         (= main@%_11_0 (> main@%_10_0 4))
         ...
         (= main@%_br3_0 (< main@%.14_0 6))
         (not main@%_br3_0))
    (main@_18 main@%loop.bound_0 main@%.0_0 main@%.14_0 main@%.12_0)))
(rule (=> (and (main@_15 main@%loop.bound_0 main@%.0_0 main@%.14_0 main@%.12_0)
         true
         (= main@%_16_0 (+ main@%.0_0 1))
         (= main@%_br4_0 (+ main@%.14_0 (- 1)))
         (= main@%.25_0 main@%_br4_0)
         (= main@%.2_0 main@%.12_0)
         (= main@%.1_0 main@%_16_0))
    (main@_.25 main@%.1_0 main@%loop.bound_0 main@%.25_0 main@%.2_0)))
(rule (=> (and (main@_18 main@%loop.bound_0 main@%.0_0 main@%.14_0 main@%.12_0)
         true
         (= main@%_19_0 (> main@%.12_0 main@%.14_0))
         (= main@%_spec.select_0 (ite main@%_19_0 1 0))
         (= main@%spec.select_0 (+ main@%.14_0 main@%_spec.select_0))
         (= main@%spec.select6_0 (ite main@%_19_0 main@%.12_0 0))
