...
; Function Attrs: nounwind ssp uwtable
define internal fastcc i64 @aws_byte_cursor_from_array(i8* %0, i32 %1) unnamed_addr #1 {
  tail call void @seahorn.fn.enter() #7
  %3 = ptrtoint i8* %0 to i32
...
entry:
  ...
  %6 = call fastcc i64 @aws_byte_cursor_from_array(i8* nonnull %malloc, i32 %3) #7
  %7 = bitcast %struct.aws_byte_cursor* %0 to i64*
  store i64 %6, i64* %7, align 8
  %8 = call fastcc zeroext i1 @aws_byte_cursor_is_valid(%struct.aws_byte_cursor* nonnull %0) #7
