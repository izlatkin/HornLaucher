...
entry:
  ...
  %7 = call fastcc %struct.aws_linked_list_node* @aws_linked_list_prev(%struct.aws_linked_list_node* nonnull %0) #8
  %8 = call fastcc zeroext i1 @aws_linked_list_node_prev_is_valid(%struct.aws_linked_list_node* nonnull %0) #8
  br i1 %8, label %9, label %verifier.error

9:                                                ; preds = %entry
  %10 = call fastcc zeroext i1 @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* %7) #8
