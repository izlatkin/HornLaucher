...
define internal fastcc zeroext i1 @aws_ptr_eq(i8* readnone %0, i8* readnone %1) unnamed_addr #0 {
...
entry:
  ...
  %1 = tail call i8* @verifier.nondet.19() #4
  %2 = tail call i8* @verifier.nondet.19() #4
  %3 = tail call i8* @verifier.nondet.19() #4
  %4 = tail call i8* @verifier.nondet.19() #4
  tail call void @seahorn.fn.enter() #4
  %5 = tail call fastcc zeroext i1 @aws_ptr_eq(i8* %4, i8* %3) #4
  %6 = icmp eq i8* %2, %1
  %7 = icmp eq i1 %5, %6
