...
define internal fastcc void @aws_ring_buffer_release(%struct.aws_ring_buffer* %0, %struct.aws_byte_buf* %1) unnamed_addr #0 {
  ...
  call void @llvm.memset.p0i8.i32(i8* nonnull align 1 dereferenceable(16) %11, i8 0, i32 16, i1 false) #9
  ret void
}
...
entry:
  ...
  %19 = tail call i32 @verifier.nondet.25() #9
  tail call void @seahorn.fn.enter() #9
  ...
  call fastcc void @aws_ring_buffer_release(%struct.aws_ring_buffer* nonnull %1, %struct.aws_byte_buf* nonnull %0) #9
