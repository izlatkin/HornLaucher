...
entry:
  ...
  call fastcc void @aws_linked_list_init(%struct.aws_linked_list* nonnull %0) #8
  %3 = call fastcc zeroext i1 @aws_linked_list_is_valid(%struct.aws_linked_list* nonnull %0) #8
