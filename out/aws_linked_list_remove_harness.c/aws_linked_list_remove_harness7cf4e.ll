...
entry:
  ...
  call fastcc void @aws_linked_list_remove(%struct.aws_linked_list_node* nonnull %2) #8
  %11 = call fastcc zeroext i1 @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* nonnull %0) #8
  br i1 %11, label %12, label %verifier.error

12:                                               ; preds = %entry
  %13 = call fastcc zeroext i1 @aws_linked_list_node_prev_is_valid(%struct.aws_linked_list_node* nonnull %1) #8
