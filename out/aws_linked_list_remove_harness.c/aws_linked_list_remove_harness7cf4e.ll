; ModuleID = '../out/aws_linked_list_remove_harness.c/aws_linked_list_remove_harness7cf4e.bc.txt'
source_filename = "/tmp/aws-c-common/verification/cbmc/proofs/aws_linked_list_remove/aws_linked_list_remove_harness.c"
...
define internal fastcc void @aws_linked_list_remove(%struct.aws_linked_list_node* %0) unnamed_addr #1 {
  ...
  store %struct.aws_linked_list_node* %3, %struct.aws_linked_list_node** %6, align 4, !tbaa !5
  %7 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %2, align 4, !tbaa !5
  %8 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %7, i32 0, i32 1
  store %struct.aws_linked_list_node* %5, %struct.aws_linked_list_node** %8, align 4, !tbaa !10
  tail call void @seahorn.fn.enter() #5
...
entry:
  ...
  store %struct.aws_linked_list_node* %2, %struct.aws_linked_list_node** %7, align 4, !tbaa !5
  %8 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %2, i32 0, i32 1
  store %struct.aws_linked_list_node* %0, %struct.aws_linked_list_node** %8, align 4, !tbaa !10
  %9 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %1, i32 0, i32 1
  store %struct.aws_linked_list_node* %2, %struct.aws_linked_list_node** %9, align 4, !tbaa !10
  %10 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %2, i32 0, i32 0
  store %struct.aws_linked_list_node* %1, %struct.aws_linked_list_node** %10, align 4, !tbaa !5
  call fastcc void @aws_linked_list_remove(%struct.aws_linked_list_node* nonnull %2) #5
  %11 = call fastcc zeroext i1 @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* nonnull %0) #5
  br i1 %11, label %12, label %verifier.error

12:                                               ; preds = %entry
  %13 = call fastcc zeroext i1 @aws_linked_list_node_prev_is_valid(%struct.aws_linked_list_node* nonnull %1) #5
  %14 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %7, align 4
  %15 = icmp eq %struct.aws_linked_list_node* %14, %1
  %or.cond = and i1 %13, %15
  %16 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %10, align 4
  %17 = icmp eq %struct.aws_linked_list_node* %16, null
  %or.cond3 = and i1 %or.cond, %17
  br i1 %or.cond3, label %18, label %verifier.error

18:                                               ; preds = %12
  %19 = load %struct.aws_linked_list_node*, %struct.aws_linked_list_node** %8, align 4, !tbaa !10
  %20 = icmp eq %struct.aws_linked_list_node* %19, null
  call void @verifier.assume.not(i1 %20)
  br label %verifier.error

verifier.error:                                   ; preds = %12, %entry, %18
