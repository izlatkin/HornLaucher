...
@s_null_terminator_cursor = internal unnamed_addr global %struct.aws_byte_cursor { i32 1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4.28, i32 0, i32 0) }, align 8
...
entry:
  ...
  %1 = tail call i32 @verifier.nondet.23() #7
  %2 = tail call i32 @verifier.nondet.23() #7
  %3 = tail call i32 @verifier.nondet.23() #7
  %4 = tail call i32 @verifier.nondet.23() #7
  %5 = tail call i32 @verifier.nondet.23() #7
  %6 = tail call i32 @verifier.nondet.23() #7
  %7 = tail call i32 @verifier.nondet.23() #7
  %8 = tail call i32 @verifier.nondet.23() #7
  %9 = tail call i32 @verifier.nondet.23() #7
  %10 = tail call i32 @verifier.nondet.23() #7
  tail call void @seahorn.fn.enter() #7
