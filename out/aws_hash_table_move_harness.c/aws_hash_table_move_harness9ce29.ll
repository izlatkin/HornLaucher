...
; Function Attrs: nounwind ssp uwtable
define internal fastcc void @aws_hash_table_move(%struct.aws_hash_table* noalias nocapture %0, %struct.aws_hash_table* noalias %1) unnamed_addr #2 {
  tail call void @seahorn.fn.enter() #9
...
entry:
  ...
  %6 = call fastcc zeroext i1 @aws_hash_table_is_valid(%struct.aws_hash_table* nonnull %1) #9
  call void @verifier.assume(i1 %6) #9
  %7 = bitcast %struct.store_byte_from_buffer* %2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %7) #9
  call void @save_byte_from_hash_table(%struct.aws_hash_table* nonnull %1, %struct.store_byte_from_buffer* nonnull %2) #9
  call fastcc void @aws_hash_table_move(%struct.aws_hash_table* nonnull %0, %struct.aws_hash_table* nonnull %1) #9
  %8 = call fastcc zeroext i1 @aws_hash_table_is_valid(%struct.aws_hash_table* nonnull %0) #9
