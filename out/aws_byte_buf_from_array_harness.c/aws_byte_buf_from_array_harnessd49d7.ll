; ModuleID = '../out/aws_byte_buf_from_array_harness.c/aws_byte_buf_from_array_harnessd49d7.bc.txt'
...
define internal fastcc void @aws_byte_buf_from_array(%struct.aws_byte_buf* noalias nocapture align 4 %0, i8* %1, i32 %2) unnamed_addr #1 {
  ...
  store %struct.aws_allocator* null, %struct.aws_allocator** %9, align 4, !tbaa !14
  ret void
}
...
entry:
  ...
  call fastcc void @aws_byte_buf_from_array(%struct.aws_byte_buf* noalias nonnull align 4 %0, i8* nonnull %malloc, i32 %4) #7
...
16:                                               ; preds = %12
  ...
  %18 = load %struct.aws_allocator*, %struct.aws_allocator** %17, align 4, !tbaa !14
