...
define internal i8* @s_default_malloc(%struct.aws_allocator* nocapture readnone %0, i32 %1) #2 {
  ...
  store i8* null, i8** %3, align 4, !tbaa !9
...
define internal i8* @s_default_calloc(%struct.aws_allocator* nocapture readnone %0, i32 %1, i32 %2) #2 {
  ...
  store i8* null, i8** %4, align 4, !tbaa !9
...
entry:
  ...
  call fastcc void @aws_linked_list_node_reset(%struct.aws_linked_list_node* nonnull %0) #8
  %3 = call fastcc zeroext i1 @aws_is_mem_zeroed(i8* nonnull %2) #8
