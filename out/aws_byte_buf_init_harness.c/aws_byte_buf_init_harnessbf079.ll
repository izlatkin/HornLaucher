...
declare void @aws_raise_error_private(i32) local_unnamed_addr #4
...
4:                                                ; preds = %2
  tail call void @seahorn.fn.enter() #8
  tail call void @verifier.assume.not(i1 false) #8
  ...
  tail call void @verifier.assume.not(i1 %6) #8
  tail call void @verifier.assume.not(i1 false) #8
  %7 = tail call i8* %5(%struct.aws_allocator* nonnull @default_allocator, i32 %1) #8
  %8 = icmp eq i8* %7, null
  br i1 %8, label %9, label %12

9:                                                ; preds = %4
  tail call void @seahorn.fn.enter() #8
  tail call void @aws_raise_error_private(i32 1) #8
  ...
  call void @llvm.memset.p0i8.i32(i8* nonnull align 1 dereferenceable(16) %11, i8 0, i32 16, i1 false) #8
  br label %17
...
entry:
  ...
  %2 = tail call i32 @verifier.nondet.21() #8
  ...
  tail call fastcc void @aws_default_allocator() #8
  %5 = call fastcc i32 @aws_byte_buf_init(%struct.aws_byte_buf* nonnull %0, i32 %3) #8
  %6 = icmp eq i32 %5, 0
  call void @verifier.assume(i1 %6)
  %7 = call fastcc zeroext i1 @aws_byte_buf_is_valid(%struct.aws_byte_buf* nonnull %0) #8
