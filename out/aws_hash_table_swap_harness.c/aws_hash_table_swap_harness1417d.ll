...
; Function Attrs: nounwind ssp uwtable
define internal fastcc void @aws_hash_table_swap(%struct.aws_hash_table* noalias nocapture %0, %struct.aws_hash_table* noalias nocapture %1) unnamed_addr #2 {
  tail call void @seahorn.fn.enter() #9
...
14:                                               ; preds = %entry
  ...
  %15 = call fastcc zeroext i1 @aws_hash_table_is_valid(%struct.aws_hash_table* nonnull %0) #9
  call void @verifier.assume(i1 %15) #9
  call void @save_byte_from_hash_table(%struct.aws_hash_table* nonnull %0, %struct.store_byte_from_buffer* nonnull %2) #9
  br label %16
...
18:                                               ; preds = %16
  call void @ensure_allocated_hash_table(%struct.aws_hash_table* nonnull %1, i32 -1) #9
  %19 = call fastcc zeroext i1 @aws_hash_table_is_valid(%struct.aws_hash_table* nonnull %1) #9
  call void @verifier.assume(i1 %19) #9
  call void @save_byte_from_hash_table(%struct.aws_hash_table* nonnull %1, %struct.store_byte_from_buffer* nonnull %3) #9
  br label %20

20:                                               ; preds = %18, %16
  call fastcc void @aws_hash_table_swap(%struct.aws_hash_table* nonnull %0, %struct.aws_hash_table* nonnull %1) #9
  %21 = icmp sgt i8 %6, 0
  br i1 %21, label %22, label %25

22:                                               ; preds = %20
  %23 = call fastcc zeroext i1 @aws_hash_table_is_valid(%struct.aws_hash_table* nonnull %1) #9
  br i1 %23, label %24, label %verifier.error

24:                                               ; preds = %22
  call void @check_hash_table_unchanged(%struct.aws_hash_table* nonnull %1, %struct.store_byte_from_buffer* nonnull %2) #9
  br label %25

25:                                               ; preds = %24, %20
  %26 = icmp sgt i8 %5, 0
  call void @verifier.assume(i1 %26)
  %27 = call fastcc zeroext i1 @aws_hash_table_is_valid(%struct.aws_hash_table* nonnull %0) #9
