...
source_filename = "/tmp/aws-c-common/verification/cbmc/proofs/aws_linked_list_insert_before/aws_linked_list_insert_before_harness.c"
...
entry:
  ...
  call fastcc void @aws_linked_list_insert_before(%struct.aws_linked_list_node* nonnull %0, %struct.aws_linked_list_node* nonnull %2) #5
  %9 = call fastcc zeroext i1 @aws_linked_list_node_prev_is_valid(%struct.aws_linked_list_node* nonnull %0) #5
...
14:                                               ; preds = %12
  %15 = call fastcc zeroext i1 @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* nonnull %1) #5
