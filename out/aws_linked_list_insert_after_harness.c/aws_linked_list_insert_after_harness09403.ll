...
entry:
  ...
  call fastcc void @aws_linked_list_insert_after(%struct.aws_linked_list_node* nonnull %0, %struct.aws_linked_list_node* nonnull %2) #8
  %9 = call fastcc zeroext i1 @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* nonnull %0) #8
...
14:                                               ; preds = %12
  %15 = call fastcc zeroext i1 @aws_linked_list_node_prev_is_valid(%struct.aws_linked_list_node* nonnull %1) #8
