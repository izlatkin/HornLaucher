; ModuleID = '../out/aws_linked_list_next_harness.c/aws_linked_list_next_harness73ec7.bc.txt'
source_filename = "/tmp/aws-c-common/verification/cbmc/proofs/aws_linked_list_next/aws_linked_list_next_harness.c"
...
define internal fastcc %struct.aws_linked_list_node* @aws_linked_list_next(%struct.aws_linked_list_node* nocapture readonly %0) unnamed_addr #1 {
...
entry:
  ...
  %5 = getelementptr inbounds %struct.aws_linked_list_node, %struct.aws_linked_list_node* %0, i32 0, i32 0
  ...
  %7 = call fastcc %struct.aws_linked_list_node* @aws_linked_list_next(%struct.aws_linked_list_node* nonnull %0) #5
  %8 = call fastcc zeroext i1 @aws_linked_list_node_next_is_valid(%struct.aws_linked_list_node* nonnull %0) #5
  br i1 %8, label %9, label %verifier.error

9:                                                ; preds = %entry
  %10 = call fastcc zeroext i1 @aws_linked_list_node_prev_is_valid(%struct.aws_linked_list_node* %7) #5
